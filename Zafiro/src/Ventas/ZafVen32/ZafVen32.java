 ...
 * ZafVen32.java
 * 
 * Created on 27 de mayo de 2013, 12:35 PM
 */
package Ventas.ZafVen32;
 ...
 */
public class ZafVen32 extends javax.swing.JInternalFrame 
{
    //Constantes:
    //Columnas del JTable: TblDat
    static final int INT_TBL_DAT_LIN = 0;                 //Línea.
    static final int INT_TBL_DAT_NOM_DOC = 1;             //Código del vendedor.
    static final int INT_TBL_DAT_COD_VEN = 2;             //Código del vendedor.
    static final int INT_TBL_DAT_NOM_VEN = 3;             //Nombre del vendedor.
    ...
    private int intFechasFac = 0;                         //Para saber cuantas fechas son
    ...
    private int intNumDec = 2, columnaPorcentual = 0;
    private int intColTot[];
    private ZafTblCelRenLbl objTblCelRenLblColGre, objTblCelRenLblColOcp;
    private final Color colFonCol =new Color(255,221,187);
    ...
    private void initComponents() {
        ...
        panFil2.add(lblEmp);
        lblEmp.setBounds(40, 120, 100, 20);
        ...
        txtCodEmp.setBounds(140, 120, 56, 20);
        ...
        txtNomEmp.setBounds(197, 120, 460, 20);
        ...
        panFil2.add(butEmp);
        butEmp.setBounds(657, 120, 20, 20);

        lblLoc.setText("Local");
        lblLoc.setToolTipText("Vendedor/Comprador");
        panFil2.add(lblLoc);
        lblLoc.setBounds(40, 140, 100, 20);
        ...
        txtCodLoc.setBounds(140, 140, 56, 20);
        ...
        txtNomLoc.setBounds(197, 140, 460, 20);
        ...
        txtCodVen.setBounds(140, 160, 56, 20);
        ...
        txtNomVen.setBounds(197, 160, 460, 20);
        ...
        panFil2.add(butVen);
        butVen.setBounds(657, 160, 20, 20);
...
private void butVenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butVenActionPerformed
    ...
    private boolean configurarTblDat() 
    {
        ...
        try
        {
            ...
            tcmAux.getColumn(INT_TBL_DAT_LIN).setPreferredWidth(130); //jota
    ...
    private boolean configurarTblDatMos()
    {
        ...
        try
        {
            ...
            vecCab.add(INT_TBL_DAT_NOM_DOC, "Nom.Doc.");//0
            vecCab.add(INT_TBL_DAT_COD_VEN, "Cód.Ven.");//1
            vecCab.add(INT_TBL_DAT_NOM_VEN, "Vendedor");//2
            
            for (i = 4; i <= intFechasCot + 3; i++) 
            {
                fecha = Integer.parseInt(vecFechasCot.get(k).toString());
                switch (fecha) 
                {
                    case 1:
                        vecCab.add(i, "ENERO");
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        vecCab.add(i, "SEPTIEMBRE");
                        break;
                    case 10:
                        vecCab.add(i, "OCTUBRE");
                        break;
                    case 11:
                        vecCab.add(i, "NOVIEMBRE");
                        break;
                    case 12:
                        vecCab.add(i, "DICIEMBRE");
                        break;
                }
                k++;
            }
            ...
            tblDat.setRowSelectionAllowed(true);
            tblDat.setSelectionMode(javax.swing.ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
            //Establece el color a toda la tabla
            //tblDat.setBackground(Color.red);
            //Configurar JTable: Establecer el menú de contexto.
            objTblPopMnu = new ZafTblPopMnu(tblDat);
            //Configurar JTable: Establecer el tipo de redimensionamiento de las columnas.
            tblDat.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
            ...
            // columnaPorcentual=i+1;
            objTblFilCab = new ZafTblFilCab(tblDat);
            tcmAux.getColumn(INT_TBL_DAT_LIN).setCellRenderer(objTblFilCab);
            tcmAux.getColumn(INT_TBL_DAT_NOM_DOC).setCellRenderer(objTblCelRenLblColGre);
            //tcmAux.getColumn(INT_TBL_DAT_COD_VEN).setCellRenderer(objTblCelRenLblColOcp);
...
{ 
            ...
            tcmAux=null;   //Libero los objetos auxiliares.
        }
        catch(Exception e)
        {
            blnRes=false;
    ...
    {
        int i, pos = 4, temp = 0, b = 0, j = 0, acum = 0;
        double acumD = 0;
        double valCotizacion = 0, valFacturas = 0, valDevolucion = 0, valor = 0;
        String strConSQLFec = "", strSQLFecFac = "", strSQL2 = "";
        ...
        try 
        {
            ...
            if (con != null) 
            {
                ...
                strSQL = "";
                strSQL += " ";
                strSQL += " select a.fe_cot, a.co_usr ,a.tx_nom, b.conteo, b.suma AS suma, c.conteoFac, c.sumaFac as sumaFac, d.conteoDev as conteoDev, d.devFac as sumaDev from (";
                strSQL += " select co_usr, fe_cot, tx_nom from (";
                strSQL += " select distinct extract(month from c.fe_doc) as fe_cot";
                strSQL += " from tbm_cabmovinv as c INNER JOIN tbm_cli as a7 ON (c.co_emp=a7.co_emp) where 1=1";
                ...
                strSQL += " and c.co_cli=a7.co_cli and";
                strSQL += " a7.co_empGrp IS NULL AND c.st_reg IN ('A','R','C','F') ";
                strSQL += strSQL2;
                strSQL += " union";
                strSQL += " select distinct extract(month from c.fe_cot) as fe_cot";
                ...
                strSQL += " INNER JOIN tbm_usr as u ON (u.co_usr = c.co_ven) where 1=1 ";
                strSQL += strConSQL;
                strSQL += " union";
                strSQL += " select distinct u.co_usr , u.tx_nom";
                strSQL += " from tbm_cabcotven as c";
                strSQL += " INNER JOIN tbm_usr as u ON (u.co_usr = c.co_ven)";
                strSQL += " INNER JOIN tbr_usremp as a3 ON (c.co_emp=a3.co_emp)";
                strSQL += " INNER JOIN tbr_locusr as a4 ON (u.co_usr=a3.co_usr and c.co_loc=a4.co_loc and c.co_emp=a4.co_emp)";
                ...
                strSQL += " select u.co_usr, extract(month from c.fe_cot) as fe_cot, count(c.co_cot) as conteo, sum(c.nd_sub) as suma";
                strSQL += " from tbm_cabcotven as c INNER JOIN tbm_usr as u ON (c.co_ven = u.co_usr) ";
                strSQL += " where 1=1 ";
                strSQL += strConSQL;
                strSQL += " group by u.co_usr,extract(month from c.fe_cot) ";
                strSQL += " ) AS b ";
                strSQL += " on (a.co_usr = b.co_usr and a.fe_cot = b.fe_cot) ";
                strSQL += " FULL outer join ( ";
                strSQL += " SELECT c.co_com as co_usr ,extract(month from c.fe_doc) as fe_cot, count(c.co_doc) as conteoFac, -sum(c.nd_sub) as sumaFac ";
                ...
                strSQL += " INNER JOIN tbm_cli as a7 ON (a7.co_emp = c.co_emp and a7.co_cli=c.co_cli)";
                ...
                strSQL += strSQL2;
                strSQL += " GROUP BY c.co_com,extract(month from c.fe_doc) ";
                strSQL += " ORDER BY 1,2";
                strSQL += " )as c ";
                strSQL += " on (a.co_usr = c.co_usr and a.fe_cot = c.fe_cot) ";
                strSQL += " left outer join ( ";
                strSQL += " SELECT c.co_com as co_usr,extract(month from c.fe_doc) as fe_cot ,count(c.co_doc) as conteoDev ,-sum(c.nd_sub) as devFac ";
                strSQL += " FROM tbm_cabmovinv as c";
                strSQL += " INNER JOIN tbm_cabTipDoc as a4 ON (c.co_emp=a4.co_emp AND c.co_loc=a4.co_loc AND c.co_tipDoc=a4.co_tipDoc)";
                ...
                strSQL += " and a7.co_empGrp IS NULL ";
                strSQL += strSQL2;
                strSQL += " group by c.co_com, extract(month from c.fe_doc))as d ";
                strSQL += " on (a.co_usr = d.co_usr and a.fe_cot = d.fe_cot) ";
                strSQL += " order by  a.co_usr ,a.fe_cot";
                //System.out.println("ZafVen32.cargarDetReg: " + strSQL);
                ...
                int cont = 0, dato = 0;
                //Cada vector tendra su contador para no perder donde se quedo 
                int d = 0, contCotCount = 0, contFacCount = 0, contCotSum = 0, contFacSum = 0;
                j = 0;
                i = 1;
                b = 0;
                int ban = 0;
    ...
    private class ZafThreadGUI extends Thread
    {
        public void run()
        {
            //configurarTblDatMos();   //Aparece nueva tabla lista para ser llenada.
            if (!cargarDetReg())
            {
