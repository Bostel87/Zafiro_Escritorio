 ...
 * @author  jayapata
 */
public class ZafVen02_02 extends javax.swing.JDialog {
    
       //Constantes: Columnas del JTable:
    final int INT_TBL_LIN=0;                        //Línea
    final int INT_TBL_COD_BOD=1;                    //Código del documento.
    final int INT_TBL_DES_BOD=2;                    //Descripcion de retiro.
    final int INT_TBL_BOD_STK=3;
    ...
    public ZafVen02_02(java.awt.Frame parent, boolean modal, ZafParSis obj, String strSql) {
        super(parent, modal);
        initComponents();
          //Inicializar objetos.
        objParSis=obj;
                        ...
                        public void mouseClicked(java.awt.event.MouseEvent evt) {
                            if(! ((tblDat.getSelectedColumn()==-1) || (tblDat.getSelectedRow() ==-1)) )
                                if(evt.getClickCount()==2){
                                    ...
                                    Str_RegSel[0] = tblDat.getValueAt(tblDat.getSelectedRow(), INT_TBL_COD_BOD ).toString();
                                    Str_RegSel[1] = tblDat.getValueAt(tblDat.getSelectedRow(), INT_TBL_DES_BOD ).toString();
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-440)/2, (screenSize.height-300)/2, 440, 300);
            ...
            if (con!=null)
            {
              ...
              if(!strSQL.equals("")){
                ...
                while (rst.next())
                {
                        ...
                        vecReg.add(INT_TBL_COD_BOD,rst.getString("co_bod"));
                        vecReg.add(INT_TBL_DES_BOD,rst.getString("tx_nom"));
                        vecReg.add(INT_TBL_BOD_STK,rst.getString("nd_stkact"));
                        vecDat.add(vecReg);
                }
                rst.close();
                rst=null;
    ...
    private boolean configurarFrm()
    {
        ...
        try
        {
            ...
            vecCab.add(INT_TBL_COD_BOD,"Cód.Bod.");
            vecCab.add(INT_TBL_DES_BOD,"Nombre.Bodega.");
            vecCab.add(INT_TBL_BOD_STK,"Stock.");
            ...
            tcmAux.getColumn(INT_TBL_COD_BOD).setPreferredWidth(70);
            tcmAux.getColumn(INT_TBL_DES_BOD).setPreferredWidth(220);
            tcmAux.getColumn(INT_TBL_BOD_STK).setPreferredWidth(80);
            
            objTblMod.setColumnDataType(INT_TBL_BOD_STK, objTblMod.INT_COL_DBL, new Integer(0), null);
            ...
            tcmAux.getColumn(INT_TBL_BOD_STK).setCellRenderer(objTblCelRenLbl);
        ...
        public void mouseMoved(java.awt.event.MouseEvent evt)
        {
            ...
            switch (intCol)
            {
                case INT_TBL_LIN:
                 ...
                 case INT_TBL_COD_BOD:
                    strMsg="Cóidigo de Bodega";
                    break;
                
                case INT_TBL_DES_BOD:
