 ...
 * @author JoseMario
 */
public class ZafVen39_01 extends javax.swing.JInternalFrame {
    ...
    private int intCodTipDoc, intCodVen, intCodCli=-1;
    ...
    // 
    public ZafVen39_01(Librerias.ZafParSis.ZafParSis obj,  javax.swing.JInternalFrame JIntFraPri,int CodTipDoc,String CodEmpLoc, boolean IsPorVendedor, boolean MostrarClientes, int CodVen,int CodCli, String FecDoc) 
    {
        try
        {
   ...
   private boolean Configurartabla() 
   {
	    ...
	    //Configurar JTable: Establecer el tipo de redimensionamiento de las columnas.
	     ...
	     //Tamaño de las celdas
            ...
            tcmAux.getColumn(INT_TBL_COD_DOC).setPreferredWidth(30);
	    ...
	    tcmAux=null;
            ...
            objTblTot=new ZafTblTot(panDat, spnTot, tblDat, tblTot, intCol);
    ...
    private boolean consultar(java.sql.Connection conn)
    {
        ...
        try{
            if(conn!=null){
                ...
                strSql="";
                strSql+=" SELECT a1.co_emp, a1.co_loc, a1.co_tipDoc, a3.tx_desCor ,a1.fe_doc, a1.co_doc,a1.ne_numDoc, a1.co_cli, a1.tx_nomCli, a1.co_forPag, a2.tx_des as tx_nomForPag,  \n";
                strSql+="         ROUND((a1.nd_sub*-1),2) as nd_sub,  ROUND((a1.nd_valIva*-1),2) as nd_valIva,  ROUND((a1.nd_tot*-1),2) as nd_tot \n";
                ...
                strSql+=" WHERE a1.co_tipDoc="+intCodTipDoc+" ";
                strSql+=strCodEmpLoc;
                strSql+=strFecDoc;
                if(blnIsPorVendedor){
                    strSql+=" AND a1.co_com="+intCodVen;
                }
                else{
                ...
                System.out.println("ZafVen39_01: " + strSql);
                ...
                while(rst.next()){
                    ...
                    vecReg.add(INT_TBL_COD_TIP_DOC, rst.getString("tx_desCor") );
                    vecReg.add(INT_TBL_COD_DOC, rst.getString("co_doc") );                 
                    vecReg.add(INT_TBL_NUM_DOC, rst.getString("ne_numdoc") );
                    vecReg.add(INT_TBL_FEC_DOC, rst.getString("fe_doc")  );
    ...
    private void initComponents() {
        ...
        panTabGenCen.add(spnTot, java.awt.BorderLayout.SOUTH);
