...
public class ZafVen01_TRA extends javax.swing.JDialog 
{
    ...
    Librerias.ZafUtil.UltDocPrint objUltDocPrint;  // Para trabajar con la informacion de tipo de documento 
     ...
     int intCodDocFac=0;
     int intCodLocGrp=1;
     int intCodTipDocFacEle_ZafVen01_TRA;
    
    /** Crea una nueva instancia de la clase ZafCon06. */    
public ZafVen01_TRA(java.awt.Frame parent, boolean modal, Librerias.ZafParSis.ZafParSis obj, int intCodCot2, int intCodMnu,  java.sql.Connection con_remoto ,  java.sql.Connection con_local, int  intTipDoc , int intCodDoc, int intCodTipDocFacEle) {
 super(parent, modal);
 try{
   initComponents();  
   //Inicializar objetos.
    ...
    intCodTipDocFacEle_ZafVen01_TRA = intCodTipDocFacEle;
...
public void  refrescaDatos(){
 ...
 try{
    if(CONN_GLO_LOC!=null){  
       ...
       " AND co_tipdoc="+intCodTipDocFacEle_ZafVen01_TRA+" AND co_usr="+objParSis.getCodigoUsuario()+" AND st_reg='A' AND st_tipmov='I' " +
