 ...
 * @author  Jota
 */
public class ZafVen42_08 extends javax.swing.JDialog {
    ...
    final int INT_TBL_IS_BOD_PRE=28; // IS BODEGA PREDETERMINADA
   ...
   private java.awt.Frame Frame;
    ...
    public ZafVen42_08(Frame parent,  ZafParSis ZafParSis,java.sql.Connection conExt, int intCodEmp, int intCodLoc, int intCodCot) {
        super(parent, true);
        try{ 
          Frame=parent;
    ...
    private boolean cargarDat(java.sql.Connection conExt, int CodEmp, int CodLoc, int CodCot){
         ...
         try{    
            ...
            if(conExt!=null){
                ...
                strSql="";
                strSql+=" SELECT DISTINCT a1.co_emp,a1.co_loc,a1.co_cot,a2.co_bod as co_bodPre,a2.co_reg,a2.co_itm, \n";
                strSql+="        a2.tx_codALt,a6.tx_nomItm,a2.nd_can, a4.co_bodGrp, a5.tx_nom as tx_nomBod, \n";
                ...
                strSql+="        a3.co_empRel,a3.co_bodRel,a3.co_itmRel,a7.st_reg as IsBodPre ";
                ...
                strSql+=" INNER JOIN tbr_bodloc as a7 ON (a2.co_emp=a7.co_emp AND a2.co_bod=a7.co_bod) \n";
                strSql+=" WHERE a1.co_emp="+CodEmp+" AND a1.co_loc="+CodLoc+" AND a1.co_cot="+CodCot+" \n";
                strSql+=" ORDER BY a2.co_reg, a5.tx_nom  \n";
                strSql+=" \n";
                System.out.println("ZafVen42_08.cargarDat: "+strSql );
                ...
                while(rstLoc.next()){ 
                    ...
                    vecReg.add( INT_TBL_IS_BOD_PRE,  rstLoc.getString("isBodPre") );
    ...
    private boolean configuraTbl(){
           ...
           try{
                ...
                vecCab.add( INT_TBL_IS_BOD_PRE ,"J:IsBodPre" );
                ...
                tcmAux.getColumn(INT_TBL_IS_BOD_PRE).setPreferredWidth(10);
...
//            arlColHid.add(""+INT_TBL_CAN_PED_OTR_BOD);
            ...
            arlColHid.add(""+INT_TBL_IS_BOD_PRE);
...
//            vecAux.add("" + INT_TBL_CHK_SOL_ENV_PED);     /*Pendiente JM */  
...
//            tcmAux.getColumn(INT_TBL_CHK_SOL_ENV_PED).setCellRenderer(objTblCelRenLblColChk);
        ...
        objTblCelRenChk.addTblCelRenListener(new ZafTblCelRenAdapter() {
            ...
            tcmAux.getColumn(INT_TBL_CHK_SOL_ENV_PED).setCellEditor(objTblCelEdiChkPre);
            objTblCelEdiChkPre.addTableEditorListener(new Librerias.ZafTblUti.ZafTblEvt.ZafTableAdapter() {
                String strFecSolRes="";
                String strMensaje="<html>Esta solicitando el envio de la mercaderia a la bodega predeterminada donde esta reservando. <BR> ¿Está seguro que desea realizar esta operación?<html>";
                public void afterEdit(Librerias.ZafTblUti.ZafTblEvt.ZafTableEvent evt) {
                    int intNumFil = tblDat.getSelectedRow();
                    
                    if(objTblMod.getValueAt(intNumFil, INT_TBL_IS_BOD_PRE).toString().equals("A")){
                        if (mostrarMsgCon(strMensaje)==0){
                             objTblMod.setValueAt(true, intNumFil, INT_TBL_CHK_SOL_ENV_PED); 
                        }
                        else{
                            System.out.println("NOoo....");
                            objTblMod.setValueAt(false, intNumFil, INT_TBL_CHK_SOL_ENV_PED); 
                        }
                    }
                    else{
                        mostrarMsgInf("Bodega predeterminada por Local, no necesita ser enviado el pedido.");
                        objTblMod.setValueAt(false, intNumFil, INT_TBL_CHK_SOL_ENV_PED); 
                    }
                }
            });
