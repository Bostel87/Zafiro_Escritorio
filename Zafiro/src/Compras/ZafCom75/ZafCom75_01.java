 ...
 * @author  Ingrid Lino
 */
public class ZafCom75_01 extends javax.swing.JPanel
{
    ...
    private ZafTblModLisCom75_01 objTblModLis;                     //Detectar cambios de valores en las celdas.
    ...
    /** Crea una nueva instancia de la clase ZafCom75_01. */
    public ZafCom75_01(ZafParSis obj)
    {
        initComponents();
        //Inicializar objetos.
        objParSis=obj;
...
//            //Configurar JTable: Ocultar columnas del sistema.
            ...
            objTblModLis=new ZafTblModLisCom75_01();
...
//            objTblTot.setValueAt("Total Gastos:",    2, INT_TBL_DAT_NOM_CAR_PAG_IMP);
     ...
     */
    private class ZafTblModLisCom75_01 implements javax.swing.event.TableModelListener
    {
   ...
   private boolean calculaTotalGastos(){
    ...
    public void setObjectoCom75_02(ZafCom75_02 objCom75_02){
        this.objCom75_02=objCom75_02;
    }

    public ZafTblMod getTblModCom75_01() {
        return objTblMod;
    }

    public void setTblModCom75_01(ZafTblMod objTblMod) {
    ...
    public boolean limpiarTablaCom75_01(){
        boolean blnRes=true;
        try{
            objTblMod.removeAllRows();
            inicializarTablaTotales();
    ...
    public boolean isBlnHayCamCom75_01() {
        return blnHayCam;
    }

    public void setBlnHayCamCamCom75_01(boolean blnHayCam) {
