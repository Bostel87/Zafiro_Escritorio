/*
 *  zafCotVen.java    
 *  Created on 08 de Junio de 2006   tbm_polret
 */  
...
public class ZafVen01_His extends javax.swing.JInternalFrame{
    ...
    private Librerias.ZafTblUti.ZafTblMod.ZafTblMod objTblMod,objTblModHis;
    ...
    javax.swing.JTable tblDatHis = new javax.swing.JTable();
     ...
     private class colorTexto extends javax.swing.JLabel implements javax.swing.table.TableCellRenderer {
        ...
        public java.awt.Component getTableCellRendererComponent(javax.swing.JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            try{
                    ...
                    this.setOpaque(true);
                     setBackground(new java.awt.Color(201,223,245));
                 //   if(tblDat.getValueAt(row, intColTblDat)!=null){ CodAlt
            ...
            public boolean comparaReg(int row, int col, String strText){
                 boolean blnRes=false;
                 int intNum = tblDatHis.getRowCount();

                 for(int i=0; i<tblDatHis.getRowCount();i++){
                    if(tblDatHis.getValueAt(i, INT_TBL_CODITM)!=null){
                         System.out.println( tblDatHis.getValueAt(i, col).toString() +" -- "+  strText );
                         if(!(tblDatHis.getValueAt(i, col).toString().equals(strText))){       
                         blnRes=true;  
                        // break;
                    }}}
                return blnRes;         
    ...
    private boolean Configurartabla() {
        ...
        try{
            ...
            objTblModHis=new Librerias.ZafTblUti.ZafTblMod.ZafTblMod();
            objTblModHis.setHeader(vecCab);
            ...
            tcmAux.getColumn(INT_TBL_CODBOD).setWidth(0);
            tcmAux.getColumn(INT_TBL_CODBOD).setMaxWidth(0);
            tcmAux.getColumn(INT_TBL_CODBOD).setMinWidth(0);
            tcmAux.getColumn(INT_TBL_CODBOD).setPreferredWidth(0);
            ...
            tcmAux.getColumn(INT_TBL_IVATXT).setResizable(false);
            
            tcmAux.getColumn(INT_TBL_COD_PRO).setWidth(0);
            tcmAux.getColumn(INT_TBL_COD_PRO).setMaxWidth(0);
            tcmAux.getColumn(INT_TBL_COD_PRO).setMinWidth(0);
            tcmAux.getColumn(INT_TBL_COD_PRO).setPreferredWidth(0);
            tcmAux.getColumn(INT_TBL_COD_PRO).setResizable(false);
            
            tcmAux.getColumn(INT_TBL_BLNPRE).setWidth(0);
            tcmAux.getColumn(INT_TBL_BLNPRE).setMaxWidth(0);
            tcmAux.getColumn(INT_TBL_BLNPRE).setMinWidth(0);
            tcmAux.getColumn(INT_TBL_BLNPRE).setPreferredWidth(0);
            tcmAux.getColumn(INT_TBL_BLNPRE).setResizable(false);
            ...
            tcmAux.getColumn(INT_TBL_ITMSER).setResizable(false);
            
            tcmAux.getColumn(INT_TBL_ITMTER).setWidth(0);
            tcmAux.getColumn(INT_TBL_ITMTER).setMaxWidth(0);
            tcmAux.getColumn(INT_TBL_ITMTER).setMinWidth(0);
            tcmAux.getColumn(INT_TBL_ITMTER).setPreferredWidth(0);
            tcmAux.getColumn(INT_TBL_ITMTER).setResizable(false);
              
//            tcmAux.getColumn(INT_TBL_MARUTI).setWidth(0);
//            tcmAux.getColumn(INT_TBL_MARUTI).setMaxWidth(0);
//            tcmAux.getColumn(INT_TBL_MARUTI).setMinWidth(0);
//            tcmAux.getColumn(INT_TBL_MARUTI).setPreferredWidth(0);
//            tcmAux.getColumn(INT_TBL_MARUTI).setResizable(false);
           ...
           */
            ...
            //*******************************************************************************
              ...
              tcmAux.getColumn(INT_TBL_ITMALT).setCellRenderer(new colorTexto(INT_TBL_ITMALT));
              tcmAux.getColumn(INT_TBL_DESITM).setCellRenderer(new colorTexto(INT_TBL_DESITM));
              tcmAux.getColumn(INT_TBL_CANMOV).setCellRenderer(new colorTexto(INT_TBL_CANMOV));
              tcmAux.getColumn(INT_TBL_PREUNI).setCellRenderer(new colorTexto(INT_TBL_PREUNI));
              tcmAux.getColumn(INT_TBL_PORDES).setCellRenderer(new colorTexto(INT_TBL_PORDES));
              tcmAux.getColumn(INT_TBL_TOTAL).setCellRenderer(new colorTexto(INT_TBL_TOTAL));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        ...
        if(intValBus==1){
            ...
            objTooBar.setEstado('w');
             ...
             Compras.ZafCom40.ZafVen01 obj;
             if(intCodHis==0){
                 obj = new Compras.ZafCom40.ZafVen01(objZafParSis, new Integer(intCodEmp), new Integer(intCodLoc), new  Integer(intCodCot) , 1 );
                 this.getParent().add(obj,javax.swing.JLayeredPane.DEFAULT_LAYER);
                // obj.setLocation(500, 500);
                 obj.show(); 
                 this.dispose();
             }else{    
                 obj = new Compras.ZafCom40.ZafVen01(objZafParSis, new Integer(intCodEmp), new Integer(intCodLoc), new  Integer(intCodCot) , 2 );
                 this.getParent().add(obj,javax.swing.JLayeredPane.DEFAULT_LAYER);
                 obj.setLocation(500, 500);
                 obj.show(); 
             } 
    ...
    public void  refrescaDatos2(Integer CodEmp,Integer CodLoc){
        try{
            ...
            if (CONN_GLO!=null){
               ...
               // " select * from ( " +
                "" +
                " SELECT  detcot.co_emp, detcot.co_reg,  detcot.tx_nomitm as tx_nomitmh, detcot.co_bod as co_bodh  ,detcot.nd_can as nd_canh ,detcot.nd_preuni as nd_preunih " +
                 " ,detcot.nd_pordes as nd_pordesh ,detcot.st_ivaven as st_ivavenh  ,detcot.co_itm as co_itmh  ,detcot.nd_precom as nd_precomh " +
                 " ,detcot.co_prv as co_prvh ,detcot.tx_codalt2 as tx_codalt2h ,detcot.tx_codalt as tx_codalth , detcot.nd_pordesprecom as nd_pordesprecomh, " +
                ...
                sSQL = "select *  from (  select *  from ( "+sSQL+" ) as  x1   LEFT JOIN ( "+sSQL1+" ) as  x ON ( x1.co_emp=x.co_emp and x1.co_itm=x.co_itmh and x1.co_reg=x.co_reg ) ) as y  ";
                    
               // System.out.println("Det==> "+sSQL );
               // System.out.println("Det==> "+sSQL1 );
                ...
                //********************Historico*****************************************************//
                    ...
                    strCodAlt = (rst.getString("tx_codalth")==null?"":rst.getString("tx_codalth"));
                    strUnidad = (rst.getString("tx_descorh")==null?"":rst.getString("tx_descorh"));
                    strSer = (rst.getString("st_serh")==null?"":rst.getString("st_serh"));
                    strTer = (rst.getString("isterl")==null?"":rst.getString("isterl"));
                      
                    vecRegHis.add(INT_TBL_LINEA, "");
                    vecRegHis.add(INT_TBL_ITMALT, strCodAlt);
                    vecRegHis.add(INT_TBL_BUTITM, "");
                    vecRegHis.add(INT_TBL_DESITM, rst.getString("tx_nomitmh") );
                    vecRegHis.add(INT_TBL_UNIDAD, strUnidad);
                    vecRegHis.add(INT_TBL_CODBOD, new Integer(rst.getInt("co_bodh")));
                    vecRegHis.add(INT_TBL_BUTBOD, "");
                    vecRegHis.add(INT_TBL_CANMOV, new Double(rst.getDouble("nd_canh")));
                    vecRegHis.add(INT_TBL_PREUNI, new Double(rst.getDouble("nd_preunih")));
                    vecRegHis.add(INT_TBL_PORDES, new Double(rst.getDouble("nd_pordesh")));
                    String strIvaHis = rst.getString("st_ivavenh");
                  //  Boolean blnIvaHis = new Boolean(strIvaHis.equals("S"));
                    vecRegHis.add(INT_TBL_BLNIVA, " ");
                    dblCan    = rst.getDouble("nd_canh");
                    dblPre    = rst.getDouble("nd_preunih");
                    dblPorDes = rst.getDouble("nd_pordesh");
                    ...
                    vecRegHis.add(INT_TBL_CODITM, rst.getString("co_itmh"));
                    vecRegHis.add(INT_TBL_ESTADO, "E");
                    vecRegHis.add(INT_TBL_IVATXT, strIvaHis );
                    vecRegHis.add(INT_TBL_PRE_COS, new Double(rst.getDouble("nd_precomh")) );            //Columna que contiene  precio de compra
                      
                    vecRegHis.add(INT_TBL_DESPRECOM, new Double(rst.getDouble("nd_pordesprecomh")) );
                    
                    vecRegHis.add(INT_TBL_COD_PRO, new Integer(rst.getInt("co_prvh")) );            //Columna que contiene el codigo del proveedor
                    
                    strCodAlt = (rst.getString("tx_nomh")==null?"":rst.getString("tx_nomh"));
...
//                    String strIvaHis = rst.getString("st_ivavenh");
//                    Boolean blnIvaHis = new Boolean(strIvaHis.equals("S"));
//                    vecRegHis.add(INT_TBL_BLNIVA, blnIvaHis);
//                    dblCan    = rst.getDouble("nd_canh");
//                    dblPre    = rst.getDouble("nd_preunih");
//                    dblPorDes = rst.getDouble("nd_pordesh");
//                    
...
//                    
                ...
                cambiaColText(txtSub,txtSub.getText().trim(),rstCab.getString("nd_subh").trim());
                cambiaColText(txtIva,txtIva.getText().trim(),rstCab.getString("nd_valivah").trim());
                
                System.out.println("Abc==>> "+ rstCab.getString("nd_tot") +" --  "+ rstCab.getString("nd_toth")  );
    ...
    private boolean _consultar2(String strFil,Integer CodEmp,Integer CodLoc){
        ...
        try{//odbc,usuario,password
            ...
            if(CONN_GLO!=null) {
                ...
                "  and CotCab.co_loc="+CodLoc+" and CotCab.co_his="+intCodHis+"  and CotCab.st_reg not in ('E')"+
                ...
                "  CotCab.co_cot, "+intCodHis+" as co_his ,  CotCab.fe_cot, CotCab.tx_ate,  "+  
                "  CotCab.co_forPag,"+
                " CotCab.tx_obs1, CotCab.tx_obs2, CotCab.nd_sub, CotCab.nd_valiva , round(CotCab.nd_tot,2) as nd_tot,  CotCab.nd_porIva, CotCab.nd_valDes, "+
