 ...
 * @author  jayapata 
 */
public class ZafCom53_01 extends javax.swing.JInternalFrame {
    ...
    final int INT_TBL_CANGUI  =5;
    final int INT_TBL_CANTOT  =6;
    final int INT_TBL_CANFAL  =7;
    ...
    public ZafCom53_01(Librerias.ZafParSis.ZafParSis obj, int intCodEmp, int intCodLoc, int intCodTipDoc, int intCodDoc) {
       try{
...
private boolean configuraTbl(){
       ...
       try{
	    ...
	    vecCab.add(INT_TBL_CANTOT,"Can.Tot.Gen.");
	    vecCab.add(INT_TBL_CANFAL,"Can.Fal.");
	    ...
	    //Tamaño de las celdas
            ...
            tcmAux.getColumn(INT_TBL_CANFAL).setPreferredWidth(60);
            ...
            objTblMod.setColumnDataType(INT_TBL_CANFAL, objTblMod.INT_COL_DBL, new Integer(0), null);
             ...
             tcmAux.getColumn(INT_TBL_CANFAL).setCellRenderer(objTblCelRenLbl);
    ...
    private void initComponents() {
        ...
        lblTit.setText("Items que faltan para generar guias secundarias");
        panTit.add(lblTit);
...
private boolean consultarDat(){
 ...
 try{
   ...
   if(conn!=null){
      ...
      vecData = new Vector();
      strSql="select co_itm, tx_codalt, tx_nomitm, tx_unimed,  nd_can, nd_cantotguisec , (nd_can - nd_cantotguisec) as canfal  "
      + "  from tbm_detguirem  "
      + " where co_emp="+CodEmp+" and co_loc="+CodLoc+" and co_tipdoc="+CodTipDoc+" and co_doc="+CodDoc+" "
      + " and (nd_can - nd_cantotguisec)  > 0 ";
	  ...
	  vecReg.add(INT_TBL_CANGUI, rstLoc.getString("nd_can") );
	  vecReg.add(INT_TBL_CANTOT, rstLoc.getString("nd_cantotguisec") );
	  vecReg.add(INT_TBL_CANFAL, rstLoc.getString("canfal") );
         vecData.add(vecReg);
       }
 ...
 public void mouseMoved(java.awt.event.MouseEvent evt){
    ...
    switch (intCol){
        ...
        case INT_TBL_UNIMED:
            ...
            break;
        case INT_TBL_CANGUI:
            strMsg="Cantidad de la guia.";
            break; 
        case INT_TBL_CANTOT:
            strMsg="Cantidad total generado guia secundaria.";
            break;
        case INT_TBL_CANFAL:
            strMsg="Cantidad faltante para guia secundaria .";
            break;
        default:
            strMsg="";
            break;
