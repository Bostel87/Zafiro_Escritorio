 ...
 * @author sistemas9
 */
public class ZafCom51_03 extends javax.swing.JDialog 
{
    //Constantes: Jtable
    ...
    private static final int INT_TBL_NOMLOC = 5;
    private static final int INT_TBL_CODTIPDOC = 6;
    private static final int INT_TBL_DES_COR = 7;
    private static final int INT_TBL_DESLAR = 8;
    private static final int INT_TBL_CODDOC = 9;
    private static final int INT_TBL_NUMDOC = 10;
    private static final int INT_TBL_CANRES = 11;
    private static final int INT_TBL_CODCLI = 12;
    private static final int INT_TBL_NOMCLI = 13;
    ...
    /**
     * Creates new form ZafCom51_03
     */
    public ZafCom51_03(java.awt.Frame parent, boolean modal, ZafParSis objParsis, String strSqlAux) 
    {
        super(parent, modal);
        try 
        {
            ...
            lblTit.setText("Listado de Reservas");
            objUti = new ZafUtil();
    ...
    private boolean configurarFrm() 
    {
        ...
        vecCab.add(INT_TBL_DES_COR, "Des.Cor");
        ...
        objTblMod.setColumnDataType(INT_TBL_CANRES, objTblMod.INT_COL_DBL, new Integer(0), null);
        ...
        tcmAux.getColumn(INT_TBL_DES_COR).setPreferredWidth(70);
        tcmAux.getColumn(INT_TBL_DESLAR).setPreferredWidth(60);
        ...
        tcmAux.getColumn(INT_TBL_CANRES).setPreferredWidth(80);
        ...
        try 
        {
            ...
            if (conn != null) 
            {
                ...
                while(rstLoc.next())
                {
                    ...
                    vecReg.add(INT_TBL_NOMLOC, rstLoc.getString("tx_nomLoc"));
                    vecReg.add(INT_TBL_CODTIPDOC, rstLoc.getString("co_tipdoc"));
                    vecReg.add(INT_TBL_DES_COR, rstLoc.getString("tx_descor"));
