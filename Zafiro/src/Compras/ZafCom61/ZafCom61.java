...
public class ZafCom61 extends javax.swing.JInternalFrame {
    ...
    private ZafVenCon vcoGrp, vcoParAra;

    /** Creates new form ZafMae03 */
    public ZafCom61(ZafParSis obj) {
        try{
//            initComponents();
//            //Inicializar objetos.
    ...
    private void initComponents() {
        ...
        txtDesLarGrpIng = new javax.swing.JTextField();
        ...
        panFil.add(lblObs1);
        lblObs1.setBounds(10, 144, 100, 14);

        txaObs1.setLineWrap(true);
        spnObs1.setViewportView(txaObs1);

        panFil.add(spnObs1);
        spnObs1.setBounds(160, 138, 400, 150);

        lblGrp.setText("Grupo padre:");
        lblGrp.setToolTipText("Tipo de documento");
        panFil.add(lblGrp);
        lblGrp.setBounds(10, 94, 100, 20);
        panFil.add(txtCodGrpPad);
        txtCodGrpPad.setBounds(126, 94, 32, 20);
        ...
        txtDesCorGrpPad.setBounds(160, 94, 60, 20);
        ...
        txtDesLarGrpPad.setBounds(220, 94, 340, 20);
        ...
        butGrpPad.setBounds(560, 94, 20, 20);
        panFil.add(txtNivGrpPad);
        txtNivGrpPad.setBounds(590, 94, 70, 20);

        jLabel5.setText("Descripción larga (inglés):");
        panFil.add(jLabel5);
        jLabel5.setBounds(10, 72, 150, 14);
        panFil.add(txtDesLarGrpIng);
        txtDesLarGrpIng.setBounds(160, 72, 400, 20);

        lblGrp1.setText("Partida arancelaria:");
        lblGrp1.setToolTipText("Tipo de documento");
        panFil.add(lblGrp1);
        lblGrp1.setBounds(10, 116, 130, 20);
        ...
        txtNomParAra.setBounds(160, 116, 60, 20);
        ...
        txtDesParAra.setBounds(220, 116, 340, 20);
        ...
        panFil.add(butParAra);
        butParAra.setBounds(560, 116, 20, 20);
        panFil.add(txtCodParAra);
        txtCodParAra.setBounds(126, 116, 32, 20);
...
private void txtDesParAraFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtDesParAraFocusLost
    ...
    private javax.swing.JTextField txtDesLarGrpIng;
...
//            }
    ...
    private boolean insertar(){
        ...
        try{
            if (con!=null){
                ...
                strSQL="";
                strSQL+="INSERT INTO tbm_grpInvImp (co_grp, tx_descor, tx_deslar, tx_desLarIng, co_grpPad";
                strSQL+=", ne_niv, co_parara, tx_obs1, st_reg,fe_ing, fe_ultmod, co_usring, co_usrmod)";
                strSQL+=" VALUES (";
                ...
                strSQL+=", " + objUti.codificar(txtDesLarGrpIng.getText()) + ""; //tx_desLarIng
                ...
                strSQL+=", " + objUti.codificar(txtCodParAra.getText()) + ""; //co_parara
    ...
    private boolean actualizarGrp(){
        ...
        try{
            if (con!=null){
                ...
                strSQL+=", co_parara=" + objUti.codificar(txtCodParAra.getText()) + "";
    ...
    private boolean cargarCabReg(){
        ...
        try{
            ...
            if (con!=null){
                stm=con.createStatement();
                strSQL="";
                strSQL+="SELECT x.co_grp, x.tx_desCorGrp, x.tx_desLarGrp, x.tx_desLarGrpIng, x.st_reg, x.tx_obs1, x.co_grpPad, x.co_parara, x.tx_par, x.tx_des";
                ...
                strSQL+="       , a1.tx_desLarIng AS tx_desLarGrpIng  , a1.st_reg, a1.tx_obs1, a1.co_grpPad, a1.ne_niv, a1.co_parara, a2.tx_par, a2.tx_des";
                strSQL+=" 	FROM tbm_grpInvImp AS a1 LEFT OUTER JOIN tbm_pararaimp AS a2 ON a1.co_parara=a2.co_parara";
                ...
                if (rst.next()){
                    ...
                    strAux=rst.getString("tx_desLarGrpIng");
                    txtDesLarGrpIng.setText((strAux==null)?"":strAux);
    ...
    private boolean configurarVenConGrpPad()
    {
        ...
        try
        {
            ...
            vcoGrp=new ZafVenCon(javax.swing.JOptionPane.getFrameForComponent(this), objParSis, "Listado de grupo padre", strSQL, arlCam, arlAli, arlAncCol, intColOcu);
            arlCam=null;
            arlAli=null;
            arlAncCol=null;
            intColOcu=null;
    ...
    private boolean configurarVenConParAra()
    {
        ...
        try
        {
            ...
            vcoParAra=new ZafVenCon(javax.swing.JOptionPane.getFrameForComponent(this), objParSis, "Listado de grupo padre", strSQL, arlCam, arlAli, arlAncCol, intColOcu);
            arlCam=null;
            arlAli=null;
            arlAncCol=null;
            intColOcu=null;
