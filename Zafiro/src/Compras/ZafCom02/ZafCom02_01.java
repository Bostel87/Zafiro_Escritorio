 ...
 * @author  jayapata
 */
public class ZafCom02_01 extends javax.swing.JDialog {
    ...
    public ZafCom02_01(java.awt.Frame parent, boolean modal, ZafParSis obj) {
        super(parent, modal);
        initComponents();
          //Inicializar objetos.
        objParSis=obj;
    ...
    private boolean cargarDetReg()
    {
        ...
        try
        {
            ...
            if (con!=null)
            {
                ...
                strSQL="select co_reg,tx_deslar from tbm_var where co_grp=11";
