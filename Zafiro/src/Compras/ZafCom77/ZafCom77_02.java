 ...
 * @author  Ingrid Lino
 */
public class ZafCom77_02 extends javax.swing.JPanel
{
    //Constantes:
    ...
    public static final int INT_TBL_DAT_CAN_PZA_ING_IMP=14;           //Cantidad Ingreso por Importación
    ...
    public static final int INT_TBL_DAT_COD_ITM_EMP=24;       //Codigo de item Empresa
    public static final int INT_TBL_DAT_COD_ITM_EMP_ACT=25;   //Codigo de item Empresa Actual
    public static final int INT_TBL_DAT_COD_ITM_EMP_AUX=26;   //Codigo de item Empresa Auxiliar
    public static final int INT_TBL_DAT_CAN_PED_EMB=27;       //Cantidad Pedido Embarcado
    public static final int INT_TBL_DAT_CAN_PEN_PED_EMB=28;   //Cantidad utilizada del pedido embarcado
    public static final int INT_TBL_DAT_CAN_UTI_ING_IMP=29;   //Cantidad utilizada del ingreso por importación
    public static final int INT_TBL_DAT_CAN_ING_IMP_AUX=30;   //Cantidad pedido embarcado auxiliar
    ...
    private BigDecimal bgdValTotCos, bgdValTotAra;//para campos de la la cabecera del formulario  txtValDoc
    ...
    private int intTipNotPed;//TipoNotaPedido , viene de ZafCom77
    ...
    /** Crea una nueva instancia de la clase ZafCom77_02. */
    public ZafCom77_02(ZafParSis obj, ZafCom77_01 objCom77_01Ref)
    {
        initComponents();
        //Inicializar objetos.
        objParSis=obj;
    ...
    private boolean configurarTblDat(){
        ...
        try{
            ...
            vecCab.add(INT_TBL_DAT_COD_LET_ITM,"Cód.Alt.Itm.");
            ...
            vecCab.add(INT_TBL_DAT_CAN_PZA_ING_IMP,"Can.Pza.");
            ...
            objTblMod.setColumnDataType(INT_TBL_DAT_CAN_PZA_ING_IMP, objTblMod.INT_COL_DBL, new Integer(0), null);
            ...
            arlAux.add("" + INT_TBL_DAT_CAN_PZA_ING_IMP);
            ...
            tcmAux.getColumn(INT_TBL_DAT_CAN_TON_MET).setPreferredWidth(65);
            tcmAux.getColumn(INT_TBL_DAT_CAN_PZA_ING_IMP).setPreferredWidth(65);
            tcmAux.getColumn(INT_TBL_DAT_PRE_UNI).setPreferredWidth(65);
            tcmAux.getColumn(INT_TBL_DAT_TOT_FOB_CFR).setPreferredWidth(80);
            tcmAux.getColumn(INT_TBL_DAT_VAL_FLE).setPreferredWidth(65);
            ...
            tcmAux.getColumn(INT_TBL_DAT_TOT_COS).setPreferredWidth(65);
            ...
            tcmAux.getColumn(INT_TBL_DAT_CAN_PED_EMB).setPreferredWidth(85);
...
//            tcmAux.getColumn(INT_TBL_DAT_COD_ITM_EMP_ACT).setResizable(false);
...
//            //Configurar JTable: Ocultar columnas del sistema.
            ...
            if(objParSis.getCodigoUsuario()==1){
                vecAux.add("" + INT_TBL_DAT_CAN_PZA_ING_IMP);
                ...
                //MODIFICACION
                if(objPerUsr.isOpcionEnabled(4366)){ //Ficha "General": Tabla de items->Modificar items
                    vecAux.add("" + INT_TBL_DAT_BUT_ITM);
                    vecAux.add("" + INT_TBL_DAT_COD_ALT_ITM);
                    vecAux.add("" + INT_TBL_DAT_CAN_PZA_ING_IMP);
                    vecAux.add("" + INT_TBL_DAT_CAN_TON_MET);
                ...
                //INSERCION
                if(objPerUsr.isOpcionEnabled(4365)){ //Ficha "General": Tabla de items->Insertar items
                ...
                //ELIMINACION
                if(objPerUsr.isOpcionEnabled(4367)){ //Ficha "General": Tabla de items->Eliminar items
            ...
            objTblPopMnu.addTblPopMnuListener(new Librerias.ZafTblUti.ZafTblEvt.ZafTblPopMnuAdapter() {
                ...
                public void beforeClick(Librerias.ZafTblUti.ZafTblEvt.ZafTblPopMnuEvent evt) {
                    if (objTblPopMnu.isClickEliminarFila()){
                        ...
                        for(int p=(intFilEli.length-1);p>=0; p--){
                            ...
                            arlRegFilEli.add(INT_CFE_CAN_ING_IMP,       "" + objTblMod.getValueAt(intFilEli[p], INT_TBL_DAT_CAN_PZA_ING_IMP));
                ...
                public void afterClick(Librerias.ZafTblUti.ZafTblEvt.ZafTblPopMnuEvent evt) {
                    if (objTblPopMnu.isClickEliminarFila()){
                        objCom77_01.colocaTotalGastosAdicionales(bgdValGasAdd, INT_COD_CAR_PAG_OTR_GAS);//
                        regenerarCalculos();
                    }
                }
            });
            ...
            tcmAux.getColumn(INT_TBL_DAT_CAN_PZA_ING_IMP).setCellRenderer(objTblCelRenLbl);
            ...
            tcmAux.getColumn(INT_TBL_DAT_CAN_PZA_ING_IMP).setCellEditor(objTblCelEdiTxtCan);
            objTblCelEdiTxtCan.addTableEditorListener(new Librerias.ZafTblUti.ZafTblEvt.ZafTableAdapter() {
                ...
                public void beforeEdit(Librerias.ZafTblUti.ZafTblEvt.ZafTableEvent evt) {
                    ...
                    bgdValCanPedEmbAnt=new BigDecimal(objTblMod.getValueAt(intFil, INT_TBL_DAT_CAN_PZA_ING_IMP)==null?"0":(objTblMod.getValueAt(intFil, INT_TBL_DAT_CAN_PZA_ING_IMP).toString().equals("")?"0":objTblMod.getValueAt(intFil, INT_TBL_DAT_CAN_PZA_ING_IMP).toString()));
                ...
                public void afterEdit(Librerias.ZafTblUti.ZafTblEvt.ZafTableEvent evt) {
                    bgdValCanPedEmb=new BigDecimal(objTblMod.getValueAt(intFil, INT_TBL_DAT_CAN_PZA_ING_IMP)==null?"0":(objTblMod.getValueAt(intFil, INT_TBL_DAT_CAN_PZA_ING_IMP).toString().equals("")?"0":objTblMod.getValueAt(intFil, INT_TBL_DAT_CAN_PZA_ING_IMP).toString()));
                    if( (chrOpcManDatTooBar=='x')  ||  (chrOpcManDatTooBar=='m')  ){//por modificacion
                        if(bgdValCanPedEmbAux.add(bgdValCanPndNotPed).compareTo(bgdValCanPedEmb)<0){
                            if(msgPermitirValorExcedidoEmbarque()){
                                objTblMod.setValueAt(bgdValCanPedEmb, intFil, INT_TBL_DAT_CAN_PZA_ING_IMP);//se coloca el valor ingresado
                            }
                            else{
                                objTblMod.setValueAt(bgdValCanPedEmbAnt, intFil, INT_TBL_DAT_CAN_PZA_ING_IMP);//se deja el valor que estaba antes de intentar cambiar
                            }
                        }
                    }
                    else{//insercion
                        if(bgdValCanPedEmb.compareTo(bgdValCanPndNotPed)>0){
                            if(msgPermitirValorExcedidoEmbarque()){
                                objTblMod.setValueAt(bgdValCanPedEmb, intFil, INT_TBL_DAT_CAN_PZA_ING_IMP);
                                objTblMod.setValueAt(bgdValCanPedEmb, intFil, INT_TBL_DAT_CAN_TON_MET);
                            }
                            else{
                                objTblMod.setValueAt(bgdValCanPedEmbAnt, intFil, INT_TBL_DAT_CAN_PZA_ING_IMP);
                    ...
                    fireCom77_02Listener(new ZafAsiDiaEvent(this), INT_AFT_EDI_CEL);
                }
            });
...
//                    }
            ...
            objTblCelEdiTxtVcoItm.addTableEditorListener(new Librerias.ZafTblUti.ZafTblEvt.ZafTableAdapter() {
                ...
                public void beforeEdit(Librerias.ZafTblUti.ZafTblEvt.ZafTableEvent evt) {
                    ...
                    //INSERCION
                    if( (objPerUsr.isOpcionEnabled(4365)) && (strLin.equals("I")) ){
                        objTblCelEdiTxtVcoItm.setCancelarEdicion(false);
                    }
                    else if(  (objPerUsr.isOpcionEnabled(4366)) && (strLin.equals("M")) ){//MODIFICACION
                        objTblCelEdiTxtVcoItm.setCancelarEdicion(false);
                    }
                    else{
            ...
            int intCol[]={INT_TBL_DAT_CAN_TON_MET, INT_TBL_DAT_CAN_PZA_ING_IMP, INT_TBL_DAT_TOT_FOB_CFR, INT_TBL_DAT_VAL_FLE, INT_TBL_DAT_VAL_CFR, INT_TBL_DAT_VAL_CFR_ARA, INT_TBL_DAT_TOT_ARA, INT_TBL_DAT_TOT_GAS, INT_TBL_DAT_TOT_COS};
        ...
        public void mouseMoved(java.awt.event.MouseEvent evt)
        {
            ...
            switch (intCol)
            {
                ...
                case INT_TBL_DAT_CAN_TON_MET:
                    strMsg="";
                    break;
                case INT_TBL_DAT_CAN_PZA_ING_IMP:
                    strMsg="";
                    break;
        ...
        public void tableChanged(javax.swing.event.TableModelEvent e)   {
            switch (e.getType())
            {
                ...
                case javax.swing.event.TableModelEvent.UPDATE:
                    ...
                    break;
                    if ( (tblDat.getEditingColumn()==INT_TBL_DAT_CAN_PZA_ING_IMP) )
                    break;
    ...
    private boolean configurarVenConItm()
    {
        ...
        try
        {
            ...
            strSQL+=" FROM( SELECT a3.co_itmMae, a3.co_itm, a1.tx_codAlt, a1.tx_codAlt2, a1.tx_nomItm";
 ...
 //               else
 //                   bgdCan=new BigDecimal(objTblMod.getValueAt(i, INT_TBL_DAT_CAN_PZA_ING_IMP)==null?"0":(objTblMod.getValueAt(i, INT_TBL_DAT_CAN_PZA_ING_IMP).toString().equals("")?"0":objTblMod.getValueAt(i, INT_TBL_DAT_CAN_PZA_ING_IMP).toString()));
   ...
   //factor del flete
    private boolean calcularV2_FleteItem(){//          V2=V1/S8
        ...
        try{
            bgdValFle=new BigDecimal(objCom77_01.getFleteItem()==null?"0":(objCom77_01.getFleteItem().toString().equals("")?"0":objCom77_01.getFleteItem().toString()));
    ...
    public boolean calcularV5_FactorArancel(){//          V5=   V4>0  ->   V3/V4
        ...
        try{
            ...
            if(bgdValV4ItmPagAra.compareTo(new BigDecimal("0"))>0){
                bgdValV5FacAra=objCom77_01.getDerechosArancelarios().divide(bgdValV4ItmPagAra, 20, BigDecimal.ROUND_HALF_UP);
            }
        }
        catch(Exception e){
            objUti.mostrarMsgErr_F1(this, e);
        ...
        try{
            for(int i=0; i<objTblMod.getRowCountTrue();i++){
                ...
                if(bgdValV5FacAra.compareTo(new BigDecimal("0"))>=0){
                    ...
                    if(objCom77_01.getDerechosArancelarios().compareTo(new BigDecimal("0"))>0)
    ...
    public boolean calcularV15_FactorGastos(){//          V5=   V4>0  ->   V3/V4
        boolean blnRes=true;
        BigDecimal bgdValTotGas=objCom77_01.getTotalGastos();
    ...
    public boolean calcularC18_CostoUnitario(){//          C11>0 (C17=C16/C11)   sino   (C17=C16/C8)   todo columna por columna
        ...
        try{
            for(int i=0; i<objTblMod.getRowCountTrue();i++){
                ...
                bgdValPza=new BigDecimal(objTblMod.getValueAt(i, INT_TBL_DAT_CAN_PZA_ING_IMP)==null?"0":(objTblMod.getValueAt(i, INT_TBL_DAT_CAN_PZA_ING_IMP).toString().equals("")?"0":objTblMod.getValueAt(i, INT_TBL_DAT_CAN_PZA_ING_IMP).toString()));
    ...
    public void regenerarCalculos(){
        ...
        bgdTotSumCan=new BigDecimal(objTblTot.getValueAt(0, INT_TBL_DAT_CAN_PZA_ING_IMP)==null?"0":(objTblTot.getValueAt(0, INT_TBL_DAT_CAN_PZA_ING_IMP).toString().equals("")?"0":objTblTot.getValueAt(0, INT_TBL_DAT_CAN_PZA_ING_IMP).toString()));
    ...
    public ZafTblMod getTblModCom77_02() {
        return objTblMod;
    }

    public void setTblModCom77_02(ZafTblMod objTblMod) {
    ...
    public boolean limpiarTablaCom77_02(){
        boolean blnRes=true;
        try{
            objTblMod.removeAllRows();
            objTblTot.calcularTotales();
    ...
    /**
     * Esta función adiciona el listener que controlará los eventos que se generen sobre la clase "ZafCom77_02".
     * @param listener El objeto que implementa los métodos de la interface "ZafAsiDiaListener".
     */
    public void addCom77_02Listener(ZafAsiDiaListener listener)
    {
        objEveLisLis.add(ZafAsiDiaListener.class, listener);
    }

    /**
     * Esta función remueve el listener que controlaré los eventos que se generen sobre la clase "ZafCom77_02".
     * @param listener El objeto que implementa los métodos de la interface "ZafAsiDiaListener".
     */
    public void removeCom77_02Listener(ZafAsiDiaListener listener)
    {
     ...
     * </CENTER>
     */
    private void fireCom77_02Listener(ZafAsiDiaEvent evt, int metodo)
    {
        int i;
    ...
    public boolean isBlnHayCamCom77_02() {
        return blnHayCam;
    }

    public void setBlnHayCamCamCom77_02(boolean blnHayCam) {
    ...
    public void addArregloFilasEliminadas(ArrayList arlRegFilEliCom77_03) {
        this.arlDatFilEli.add(arlRegFilEliCom77_03);
    }


    /**Función usada para la nota de embarque, cuando se seleccionan items, se debe colocar el valor de la suma del flete pero
     * de los items seleccionados, se lee este valor y se lo setea en en ZafCom77_01.
...
//        try{
//           for(int i=0; i<objTblMod.getRowCountTrue();i++){
//               objTblMod.setValueAt("0", i, INT_TBL_DAT_CAN_PZA_ING_IMP);
//            }
//        }
//        catch(Exception e){
//            objUti.mostrarMsgErr_F1(this, e);
