 ...
 * @author  Gigi
 */
public class ZafCom77 extends javax.swing.JInternalFrame
{   
    //ArrayList para consultar
    private ArrayList arlDatConIngImp, arlRegConIngImp;
    private static final int INT_ARL_CON_ING_IMP_COD_EMP=0;  
    private static final int INT_ARL_CON_ING_IMP_COD_LOC=1;   
    private static final int INT_ARL_CON_ING_IMP_COD_TIPDOC=2;  
    private static final int INT_ARL_CON_ING_IMP_COD_DOC=3;  
    private static final int INT_ARL_CON_ING_IMP_USR_ING=4; 
    private static final int INT_ARL_CON_ING_IMP_USR_MOD=5; 
    ...
    */
    ...
    private ArrayList arlDatFilEliCom77_03;   //ArrayList: para las filas que fueron eliminadas en el detalle
    ...
    private ZafTblMod objTblModCom77_01, objTblModCom77_02;
    private ZafCom77_01 objCom77_01;
    ...
    private boolean blnConVenEme=false; //true: Se llama desde otra ventana. false: Consulta directamente desde el programa.
    ...
    private String strVer=" v1.1 ";
    
    /** Creates new form ZafCom77 */
    public ZafCom77(ZafParSis obj) 
    {
        try{
     ...
     */
    public ZafCom77(ZafParSis obj, int codigoEmpresa, int codigoLocal, int codigoTipoDocumento, int codigoDocumento) {
        try{
            objParSis=(ZafParSis)obj.clone();
            ...
            objParSis.setCodigoMenu(objImp.INT_COD_MNU_PRG_COM_LOC);
            blnConVenEme=true;
            initComponents();
            configurarFrm();
            agregarDocLis();
    ...
    private boolean configurarFrm()
    {
        ...
        try
        {
            ...
            objCom77_01=new ZafCom77_01(objParSis);
            panCarPagImp.add(objCom77_01,java.awt.BorderLayout.CENTER);

            //tabla de items y sus valores
            objCom77_02=new ZafCom77_02(objParSis, objCom77_01);
            panDetPagImp.add(objCom77_02,java.awt.BorderLayout.CENTER);
            objCom77_01.setObjectoCom77_02(objCom77_02);
            
            dtpFecDoc.addFocusListener(new java.awt.event.FocusAdapter() {
                public void focusLost(java.awt.event.FocusEvent evt) {
                    //txtDesCorTipDocFocusLost(evt);
                    objCom77_02.setFechaDocumento(dtpFecDoc.getText());
                }
            });
            
            txtCodTipDoc.addFocusListener(new java.awt.event.FocusAdapter(){
                public void focusLost(java.awt.event.FocusEvent evt){
                    objCom77_02.setCodigoTipoDocumento(Integer.parseInt(txtCodTipDoc.getText()));
                }
            });
            ...
            objCom77_02.addCom77_02Listener(new Librerias.ZafEvt.ZafAsiDiaAdapter() {
                ...
                public void afterEditarCelda(Librerias.ZafEvt.ZafAsiDiaEvent evt) {
                    txtValDoc.setText("" + objCom77_02.getValorTotalCosto());
                    txtValDoc.setText( "" + (objUti.redondearBigDecimal(txtValDoc.getText(), objParSis.getDecimalesMostrar()))     );
                    txtPesTotKgr.setText("" + objCom77_02.getCalcularPesoTotal());
                    generarAsiDia();
    ...
    private boolean mostrarTipDocPre()
    {
        ...
        try
        {
            ...
            if (con!=null)
            {
                ...
                //Habilitar el botón de exportador
        ...
        try{            
            switch (intTipBus){
                ...
                case 2: //Búsqueda directa por "Descripcián larga".
                    ...
                    break;
                case 3: //Búsqueda directa por "Descripcián corta".
...
//            strSQL+=" WHERE a1.st_reg='A'";
    ...
    private boolean configurarVenConPedEmb()
    {
        ...
        try
        {
            ...
            strSQL+=" AND ( a7.tx_codAlt LIKE '%S' OR a1.co_exp IN (32) )"; /* Sólo Compras Locales */
            ...
            switch (intTipBus){
                case 0: //Mostrar la ventana de consulta.
                    ...
                    if (vcoPedEmb.getSelectedButton()==vcoPedEmb.INT_BUT_ACE){
                        ...
                        objCom77_01.colocaTotalGastosAdicionales(new BigDecimal(BigInteger.ZERO), INT_COD_CAR_PAG_OTR_GAS);
    ...
    private void initComponents() {
        ...
        txtNumCorEle.setBounds(460, 118, 30, 20);
        ...
        butNumCorEle.setBounds(510, 118, 70, 23);
...
private void optTmFobActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optTmFobActionPerformed
    if(optTmFob.isSelected()){
        ...
        optTmFob.setSelected(true);//siempre que se da click se selecciona.
    intTipNotPed=1;
    objCom77_01.setTipoNotaPedido(intTipNotPed);
    objCom77_02.setTipoNotaPedido(intTipNotPed);//se lo hace para cancelar la edicion de la columna de PIEZA, si esta en 0 ó 3 no se edita la columna
    
    //NUEVO
    objCom77_01.calculaTotalFletes();
...
private void optTmCfrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optTmCfrActionPerformed
    ...
    intTipNotPed=2;
    objCom77_01.setTipoNotaPedido(intTipNotPed);
    objCom77_01.setValorFleteInactivo();
    objCom77_02.setTipoNotaPedido(intTipNotPed);//se lo hace para cancelar la edicion de la columna de PIEZA, si esta en 0 ó 3 no se edita la columna
    
    //NUEVO
    objCom77_01.setFleteItem(new BigDecimal(BigInteger.ZERO));
    objCom77_01.calculaTotalFletes();
    objCom77_02.regenerarCalculos();    
...
private void optPzaFobActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optPzaFobActionPerformed
    ...
    //NUEVO
    objCom77_01.calculaTotalFletes();
    //objCom77_02.seteaColumnaPiezas();
    objCom77_02.regenerarCalculos();    
...
private void butConPedEmbLisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butConPedEmbLisActionPerformed
    if(txtCodBod.getText().length()>0){
        ...
        objCom77_01.setTipoNotaPedido(intTipNotPed);
        objCom77_02.setTipoNotaPedido(intTipNotPed);
        txtCodExp.setText("");
        txtNomExp.setText("");
        txtNomExp2.setText("");
    }
...
private void butBodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butBodActionPerformed
    ...
    private boolean limpiarFrm(){
        ...
        try{
            ...
            objCom77_01.limpiarTablaCom77_01();
            objCom77_02.limpiarTablaCom77_02();
            objCom77_01.setBlnHayCamCamCom77_01(false);
            objCom77_02.setBlnHayCamCamCom77_02(false);
    ...
    private boolean isCamVal(){
        ...
        if(objTooBar.getEstado()=='n'){
            if(!objTblModCom77_02.isDataModelChanged()){
                tabFrm.setSelectedIndex(0);
                mostrarMsgInf("<HTML>La tabla de Items y valores no ha tenido cambios.<BR>No hay datos nuevos por guardar.</HTML>");
                return false;
            }

            if(objTblModCom77_02.getRowCountTrue()<=0){
                objTblModCom77_02.setModoOperacion(objTblModCom77_02.INT_TBL_EDI);
                objTblModCom77_02.removeEmptyRows();
                tabFrm.setSelectedIndex(0);
                mostrarMsgInf("<HTML>La tabla de Items y valores no ha tenido cambios.<BR>No hay datos nuevos por guardar.</HTML>");
                return false;
            }
        ...
        if( (optTmFob.isSelected())  || (optTmCfr.isSelected())  ){
            for(int i=0; i<objTblModCom77_02.getRowCountTrue(); i++){
                bgdCanPza=new BigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP).toString()));
        ...
        if ((objUti.redondearBigDecimal(objCom77_02.getValorTotalArancel(), objParSis.getDecimalesMostrar())).compareTo((objUti.redondearBigDecimal(objCom77_01.getValorTotalArancel(), objParSis.getDecimalesMostrar())))!=0){
            tabFrm.setSelectedIndex(0);
    ...
    private boolean isExisteItemTerminalDiferente(){
        ...
        try{
            for(int i=0; i<objTblModCom77_02.getRowCountTrue(); i++){
                strCodAltItmTer=objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ALT_ITM)==null?"":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ALT_ITM).toString();
    ...
    private class MiToolBar extends ZafToolBar
    {
            ...
            try{
                if(arlDatConIngImp.size()>0){
                    if(intIndiceIngImp>0){
                        if ((blnHayCam) || (objCom77_01.isBlnHayCamCom77_01())  || (objCom77_02.isBlnHayCamCom77_02())   ){
                            if (isRegPro()) {
                                intIndiceIngImp=0;
                                cargarReg();
                            }
        ...
        public void clickInsertar() {
            try{
                ...
                txtDesCorTipDoc.selectAll();
                txtDesCorTipDoc.requestFocus();
                objCom77_01.inicializar();
                objCom77_01.generarDatosCargoPagar();
                objCom77_01.setEditable(true);
                objCom77_02.inicializar();
                strTipNotPed="";
                strCodExp="";

                objTblModCom77_01=objCom77_01.getTblModCom77_01();
                objTblModCom77_02=objCom77_02.getTblModCom77_02();

                objCom77_02.setModoOperacionTooBar(objTooBar.getEstado());
        ...
        public void clickModificar() {
            ...
            if(optTmFob.isSelected()){
                ...
                intTipNotPed=1;
                objCom77_01.setTipoNotaPedido(Integer.parseInt(strTipNotPed));
                objCom77_02.setTipoNotaPedido(Integer.parseInt(strTipNotPed));//se lo hace para cancelar la edicion de la columna de PIEZA, si esta en 0 ó 3 no se edita la columna
            } 
        ...
        public boolean beforeInsertar() {
            arlDatFilEliCom77_03=objCom77_02.getArregloFilasEliminadas();
...
//            objTblModCom77_02=objCom77_02.getTblModCom77_02();
    ...
    private boolean insertar_tbmCabMovInv(){
        ...
        intNumIngImpDia=-1;
        try{
            txtPesTotKgr.setText(""+objCom77_02.calcularV20PesoTotal());
            if (con!=null){
                stm=con.createStatement();
   ...
   private int getCodigoMaestroItemGrupo(int intCodEmp, int intCodItm)
   {
        ...
        try{
            if (con!=null){
                ...
                for(int i=0; i<objTblModCom77_02.getRowCountTrue(); i++)
                {
                    ...
                    strSQL+="        nd_ara,nd_preUniImp,nd_valTotFobCfr,nd_cantonmet,nd_valFle,nd_valCfr,nd_valTotAra,nd_valTotGas,st_regRep, co_exp)";
                    strSQL+=" VALUES (";
                    strSQL+=" " + txtCodImp.getText(); //co_emp
                    strSQL+=", " + strCodLocPre; //co_loc
                    strSQL+=", " + txtCodTipDoc.getText(); //co_tipdoc
                    ...
                    strSQL+=", " + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM_EMP);//co_itm
                    strSQL+=", " + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM_EMP);//co_itmAct
                    strSQL+=", '" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ALT_ITM) + "'";//tx_codAlt
                    strSQL+=", '" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_LET_ITM) + "'";//tx_codAlt2
                    strSQL+=", " + objUti.codificar(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_NOM_ITM)) + "";//tx_nomItm
                    strSQL+=", '" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_UNI_MED) + "'";//tx_uniMed
                    strSQL+=", " + intCodBodEmp + "";//co_bod
                    strSQL+=", '" + txtNomBod.getText() + "'";//tx_nomBodOrgDes
                    //strSQL+=", " + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP) + "";//nd_can
                    strSQL+=", " + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP) + "";//nd_can
                    strSQL+=", Null";//nd_canOrg
                    strSQL+=", 0";//nd_canDev
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI).toString()), /*objParSis.getDecimalesBaseDatos()*/ 4) + "";//nd_cosUni
                    strSQL+=", Null";//nd_preUniVenLis
                    strSQL+=", Null";//nd_porDesVenMax
                    strSQL+=", Null";//nd_preUni
                    strSQL+=", 0";//nd_porDes
                    strSQL+=", 'N'";//st_ivaCom
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString()), /*objParSis.getDecimalesBaseDatos()*/ 4) + "";//nd_tot 'precio al publico'
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString()), /*objParSis.getDecimalesBaseDatos()*/ 4) + "";//nd_cosTot 'precio de compra para vender'
                    strSQL+=", 0";//nd_exi
                    strSQL+=", 0";//nd_valExi
                    strSQL+=", 0";//nd_cosPro
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI).toString()), /*objParSis.getDecimalesBaseDatos()*/ 4) + "";//nd_cosUniGrp
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString()), /*objParSis.getDecimalesBaseDatos()*/ 4) + "";//nd_cosTotGrp
                    strSQL+=", 0";//nd_exiGrp
                    ...
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_POR_ARA)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_POR_ARA).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_POR_ARA).toString()), objParSis.getDecimalesBaseDatos()) + "";//nd_ara
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_PRE_UNI)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_PRE_UNI).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_PRE_UNI).toString()), objParSis.getDecimalesBaseDatos()) + "";//nd_preUniImp
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_FOB_CFR)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_FOB_CFR).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_FOB_CFR).toString()), objParSis.getDecimalesBaseDatos()) + "";//nd_valTotFobCfr
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_TON_MET)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_TON_MET).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_TON_MET).toString()), objParSis.getDecimalesBaseDatos()) + "";//nd_cantonmet
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_FLE)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_FLE).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_FLE).toString()), objParSis.getDecimalesBaseDatos()) + "";//nd_valFle
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_CFR)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_CFR).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_CFR).toString()), objParSis.getDecimalesBaseDatos()) + "";//nd_valCfr
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_ARA)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_ARA).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_ARA).toString()), objParSis.getDecimalesBaseDatos()) + "";//nd_valTotAra
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_GAS)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_GAS).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_GAS).toString()), objParSis.getDecimalesBaseDatos()) + "";//nd_valTotGas
                    strSQL+=", 'I'";//st_regRep
                    strSQL+=", Null";//co_exp
                    strSQL+=");";
                    strSQLIns+=strSQL;
                    j++;
                    if(objTooBar.getEstado()=='n'){
                        if(!generaNuevoContenedorItemsMovimientoStock(Integer.parseInt(txtCodImp.getText()),Integer.parseInt(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM_EMP).toString()),Double.parseDouble(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP).toString()),intCodBodEmp)){
                            blnRes=false;
                        }
                    }
                                        
                    arlRegCodItmMaeConInv=new ArrayList();
                    arlRegCodItmMaeConInv.add(INT_ARL_COD_ITM_MAE_CON_INV, objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM_MAE));
    ...
    private boolean insertar_tbmCarPagMovInv(){
        ...
        try{
            if (con!=null){
                stm=con.createStatement();
                for(int i=0; i<objTblModCom77_01.getRowCountTrue(); i++){
                    //Armar la sentencia SQL.
                    strSQL="";
                    ...
                    strSQL+=", " + txtCodDoc.getText(); //co_doc
                    strSQL+=", " + j; //co_reg
                    strSQL+=", " + objTblModCom77_01.getValueAt(i, objCom77_01.INT_TBL_DAT_COD_CAR_PAG_IMP); //co_carpag
                    bgdVarValTmp=objUti.redondearBigDecimal(objTblModCom77_01.getValueAt(i, objCom77_01.INT_TBL_DAT_VAL_CAR_PAG_IMP)==null?"0":(objTblModCom77_01.getValueAt(i, objCom77_01.INT_TBL_DAT_VAL_CAR_PAG_IMP).toString().equals("")?"0":objTblModCom77_01.getValueAt(i, objCom77_01.INT_TBL_DAT_VAL_CAR_PAG_IMP).toString()), objParSis.getDecimalesBaseDatos());
        ...
        try{
            ...
            if(con!=null){
                ...
                if(actualizar_tbmCabMovInv()){
                    if(eliminaRegistrosEliminados()){//hace el update a tbm_inv de los registros q han sido borrados
                        if(AnularRegDetalle()){//hace el update a tbm_inv de los registros que se encuentran en el modelo
...
//                                           if(actualizar_tbmDetOrdDis()){
                                                if(objAsiDia.actualizarDiario(con, Integer.parseInt(txtCodImp.getText()), Integer.parseInt(strCodLocPre), Integer.parseInt(txtCodTipDoc.getText()) ,Integer.parseInt(txtCodDoc.getText()),txtNumDoc.getText(), objUti.parseDate(dtpFecDoc.getText(),"dd/MM/yyyy"), "A")){
                                                    ...
                                                    objCom77_02.getArregloFilasEliminadas().clear();
                                                    objTblModCom77_02.initRowsState();                                                
                                                }
                                                else
                                                    con.rollback();
                                            //}
...
//                if(blnRes){
//                    for(int i=0; i<objTblModCom77_02.getRowCountTrue(); i++){
//                        if(objTblModCom77_02.getValueAt(i,objCom77_02.INT_TBL_DAT_COD_ITM_EMP) != null ){
//                            objTblModCom77_02.setValueAt("E", i, INT_TBL_ESTADO);
//                            objTblModCom77_02.setValueAt(objTblModCom77_02.getValueAt(i, INT_TBL_CODITM).toString() , i, INT_TBL_ITMORI);
//                            objTblModCom77_02.setValueAt(objTblModCom77_02.getValueAt(i, INT_TBL_CODBOD).toString() , i, INT_TBL_BODORI);
//                            objTblModCom77_02.setValueAt(objTblModCom77_02.getValueAt(i, INT_TBL_CANMOV).toString() , i, INT_TBL_CANORI);
//                        }
//                    }
//                }
    ...
    private boolean actualizar_tbmCabMovInv(){
        ...
        try{
            if (con!=null){
                ...
                strSQL+=" WHERE co_emp=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_EMP); //co_emp
                strSQL+=" AND co_loc= " + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_LOC); //co_loc
                strSQL+=" AND co_tipDoc= " + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_TIPDOC); //co_tipdoc
                strSQL+=" AND co_doc= " + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_DOC); //co_doc
                strSQL+="; ";
    ...
    private boolean eliminar_tbmCarPagMovInv(){
        ...
        try{
            if (con!=null){
                ...
                strSQL+=" WHERE co_emp=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_EMP) + "";
                strSQL+=" AND co_loc=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_LOC) + "";
                strSQL+=" AND co_tipDoc=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_TIPDOC) + "";
                strSQL+=" AND co_doc=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_DOC) + "";
                strSQL+=";";
                stm.executeUpdate(strSQL);
                stm.close();
                stm=null;
    ...
    private boolean consultarReg(){
        ...
        try{
            ...
            if (con!=null){
                ...
                strSQL+="      , a1.co_usrIng, a15.tx_usr AS tx_nomUsrIng, a1.co_usrMod, a16.tx_usr AS tx_nomUsrMod, a1.co_mnu, a6.co_bod";
                ...
                while(rst.next())
                {
                    ...
                    arlRegConIngImp.add(INT_ARL_CON_ING_IMP_COD_EMP,rst.getInt("co_emp"));
                    arlRegConIngImp.add(INT_ARL_CON_ING_IMP_COD_LOC,rst.getInt("co_loc"));
                    arlRegConIngImp.add(INT_ARL_CON_ING_IMP_COD_TIPDOC,rst.getInt("co_tipDoc"));
                    arlRegConIngImp.add(INT_ARL_CON_ING_IMP_COD_DOC,rst.getInt("co_doc"));
                    arlRegConIngImp.add(INT_ARL_CON_ING_IMP_USR_ING,rst.getString("tx_nomUsrIng"));
                    arlRegConIngImp.add(INT_ARL_CON_ING_IMP_USR_MOD,rst.getString("tx_nomUsrMod"));
            ...
            if (cargarCabReg()){
                if (cargarCarPagImp()){
                    if (cargarDetRegItmVal()){            
                        if(objAsiDia.consultarDiario( objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_EMP)
                                                    , objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_LOC)
                                                    , objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_TIPDOC)
                                                    , objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_DOC) )){
                            if(optTmFob.isSelected()){
                                strTipNotPed="1";
                                intTipNotPed=1;
                            } //ne_tipnotped
    ...
    private boolean cargarCabReg(){
		...
		strSQL+="	    )";
                ...
                strSQL+="  WHERE a1.co_emp=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_EMP);
                strSQL+="  AND a1.co_loc=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_LOC);
                strSQL+="  AND a1.co_tipDoc=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_TIPDOC);
                strSQL+="  AND a1.co_doc=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_DOC);
                ...
                if (rst.next()){
                    ...
                    objCom77_02.setStrCodImpPedEmbSel(strAux);
                    ...
                    objCom77_01.setTipoNotaPedido(rst.getInt("ne_tipnotped"));
                    objCom77_02.setTipoNotaPedido(rst.getInt("ne_tipnotped"));
    ...
    private boolean cargarDetRegItmVal(){//por consulta
        boolean blnRes=true;
        try{
            objTblModCom77_02.removeAllRows();
            if (!txtCodTipDoc.getText().equals("")){
                con=DriverManager.getConnection(objParSis.getStringConexion(), objParSis.getUsuarioBaseDatos(), objParSis.getClaveBaseDatos());
                if (con!=null){
                    stm=con.createStatement();
                    ...
                    strSQL+="       WHERE b1.co_emp=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_EMP) + "";
                    strSQL+="       AND b1.co_loc=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_LOC) + "";
                    strSQL+="       AND b1.co_tipDoc=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_TIPDOC) + "";
                    strSQL+="       AND b1.co_doc=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_DOC) + "";
                    ...
                    while (rst.next()){
                        vecReg=new Vector();
                        vecReg.add(objCom77_02.INT_TBL_DAT_LIN,"");
                        vecReg.add(objCom77_02.INT_TBL_DAT_COD_ITM_MAE,    rst.getString("co_itmMae"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_COD_ITM,        rst.getString("co_itmGrp"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_COD_ALT_ITM,    rst.getString("tx_codAlt"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_COD_LET_ITM,    rst.getString("tx_codAlt2"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_BUT_ITM,        null);
                        vecReg.add(objCom77_02.INT_TBL_DAT_NOM_ITM,        rst.getString("tx_nomItm"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_UNI_MED,        rst.getString("tx_desCorUniMed"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_PES,            rst.getString("nd_pesitmkgr"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_COD_ARA,        rst.getString("co_parara"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_NOM_ARA,        rst.getString("tx_par"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_DES_ARA,        rst.getString("tx_des"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_POR_ARA,        rst.getString("nd_ara"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_CAN_TON_MET,    rst.getString("nd_canTonMet"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP,        rst.getString("nd_can"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_PRE_UNI,        rst.getString("nd_preUniImp"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_TOT_FOB_CFR,    rst.getString("nd_valTotFobCfr"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_VAL_FLE,        rst.getString("nd_valFle"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_VAL_CFR,        rst.getString("nd_valCfr"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_VAL_CFR_ARA,    "0");
                        vecReg.add(objCom77_02.INT_TBL_DAT_TOT_ARA,        rst.getString("nd_valTotAra"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_TOT_GAS,        rst.getString("nd_valTotGas"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_TOT_COS,        rst.getString("nd_cosTot"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_COS_UNI,        rst.getString("nd_cosUni"));
                        ...
                        vecReg.add(objCom77_02.INT_TBL_DAT_COD_ITM_EMP,    rst.getString("co_itmEmp"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_COD_ITM_EMP_ACT,rst.getString("co_itmAct"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_COD_ITM_EMP_AUX,rst.getString("co_itmEmp"));
                        
                        vecReg.add(objCom77_02.INT_TBL_DAT_CAN_PED_EMB,    "0");
                        vecReg.add(objCom77_02.INT_TBL_DAT_CAN_PEN_PED_EMB,"0");
                        vecReg.add(objCom77_02.INT_TBL_DAT_CAN_UTI_ING_IMP,"0");    
                        vecReg.add(objCom77_02.INT_TBL_DAT_CAN_ING_IMP_AUX,rst.getString("nd_can"));
                    ...
                    stm=null;
                    con=null;
                    if(objCom77_02.asignarVectorModeloDatos(vecDat)){
                        vecDat.clear();
                    }
                    else{
                        mostrarMsgInf("Los datos del detalle no se pudieron cargar correctamente");
                    }
                    objCom77_02.regenerarCalculoCfrAra();
                }
            }
        }
        catch (java.sql.SQLException e)
    ...
    private boolean cargarCarPagImp(){
        ...
        String strTipCarPag="";
        try{
            objTblModCom77_01.removeAllRows();
            if (!txtCodTipDoc.getText().equals("")){
                con=DriverManager.getConnection(objParSis.getStringConexion(), objParSis.getUsuarioBaseDatos(), objParSis.getClaveBaseDatos());
                if (con!=null){
                    stm=con.createStatement();
                    ...
                    while (rst.next()){
                        vecReg=new Vector();
                        vecReg.add(objCom77_01.INT_TBL_DAT_LIN,"");
                        vecReg.add(objCom77_01.INT_TBL_DAT_TIP_CAR_PAG_IMP,    rst.getString("tx_tipcarpag"));
                        vecReg.add(objCom77_01.INT_TBL_DAT_COD_CAR_PAG_IMP,    rst.getString("co_carpag"));
                        vecReg.add(objCom77_01.INT_TBL_DAT_NOM_CAR_PAG_IMP,    rst.getString("tx_nomCarPag"));
                        vecReg.add(objCom77_01.INT_TBL_DAT_VAL_CAR_PAG_IMP,    rst.getString("nd_valcarpag"));
                        vecReg.add(objCom77_01.INT_TBL_DAT_VAL_CAR_PAG_IMP_AUX,rst.getString("nd_valcarpag"));
                        vecReg.add(objCom77_01.INT_TBL_DAT_TIP_NOT_PED,        "");

                        if(optTmFob.isSelected())
                            vecReg.setElementAt("1", objCom77_01.INT_TBL_DAT_TIP_NOT_PED);
                        else if(optTmCfr.isSelected())
                            vecReg.setElementAt("2", objCom77_01.INT_TBL_DAT_TIP_NOT_PED);
                        else if(optPzaFob.isSelected())
                            vecReg.setElementAt("3", objCom77_01.INT_TBL_DAT_TIP_NOT_PED);
                        else if(optPzaCfr.isSelected())
                            vecReg.setElementAt("4", objCom77_01.INT_TBL_DAT_TIP_NOT_PED);
                    ...
                    objCom77_01.setFleteItem(bgdValFleSav);
                    objCom77_01.setDerechosArancelarios(bgdValAraSav);
                    objCom77_01.setTotalGastos(bgdValGasSav);
                    ...
                    stm=null;
                    con=null;
                    if(objCom77_01.asignarVectorModeloDatos(vecDat)){
                        vecDat.clear();
                    }
                    else{
                        mostrarMsgInf("Los datos del detalle no se pudieron cargar correctamente");
...
//                                    con.rollback();
            ...
            if (cargarCabPedEmb(codigoEmpresa, codigoLocal, codigoTipoDocumento, codigoDocumento)){
                if (cargarCarPagImpPedEmb(codigoEmpresa, codigoLocal, codigoTipoDocumento, codigoDocumento)){
                    if (cargarDetRegItmValPedEmb(codigoEmpresa, codigoLocal, codigoTipoDocumento, codigoDocumento)){
                        ...
                        strCodExp=txtCodExp.getText();
                        objCom77_02.setBlnHayCamCamCom77_02(true);
                        objCom77_01.setBlnHayCamCamCom77_01(true);
                    }
                }
            }
            blnHayCam=false;
        ...
        try{
            ...
            if (!txtCodTipDoc.getText().equals("")){
                ...
                if (con!=null){
                    ...
                    strSQL+=" , x.co_loc, x.co_tipDoc, x.co_doc, x.tx_desCorUniMed, y.co_itmEmp";
                    strSQL+=" FROM(";
                    ...
                    strSQL+="       , b1.co_loc, b1.co_tipDoc, b1.co_doc, a2.tx_desCor AS tx_desCorUniMed";
                    ...
                    strSQL+="       , b1.nd_valTotGas, b1.nd_valTotCos, b1.nd_cosUni, b1.co_reg";
                    strSQL+="       , b1.co_loc, b1.co_tipDoc, b1.co_doc, a2.tx_desCor";
                    ...
                    while (rst.next()){
                        ...
                        vecReg.add(objCom77_02.INT_TBL_DAT_LIN,"");
                        vecReg.add(objCom77_02.INT_TBL_DAT_COD_ITM_MAE,    rst.getString("co_itmMae"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_COD_ITM,        rst.getString("co_itm"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_COD_ALT_ITM,    rst.getString("tx_codAlt"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_COD_LET_ITM,    rst.getString("tx_codAlt2"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_BUT_ITM,        null);
                        vecReg.add(objCom77_02.INT_TBL_DAT_NOM_ITM,        rst.getString("tx_nomItm"));
                        ...
                        if(  (optTmFob.isSelected())  ||  (optTmCfr.isSelected()) )
                            ...
                            vecReg.add(objCom77_02.INT_TBL_DAT_CAN_TON_MET,    rst.getString("nd_can"));
                        
                        vecReg.add(objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP,    rst.getString("nd_can"));

                        vecReg.add(objCom77_02.INT_TBL_DAT_PRE_UNI,        rst.getString("nd_preUni"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_TOT_FOB_CFR,    rst.getString("nd_valTotFobCfr"));
                        ...
                        vecReg.add(objCom77_02.INT_TBL_DAT_TOT_ARA,        rst.getString("nd_valTotAra"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_TOT_GAS,        rst.getString("nd_valTotGas"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_TOT_COS,        rst.getString("nd_valTotCos"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_COS_UNI,        rst.getString("nd_cosUni"));
                        
                        vecReg.add(objCom77_02.INT_TBL_DAT_COD_ITM_EMP,    rst.getString("co_itmEmp"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_COD_ITM_EMP_ACT,rst.getString("co_itmEmp"));//no va el campo "co_itmAct" porque en tablas de pedidos no existe, solo en tbm_detMovInv, entonces uso el mismo co_itm
                        vecReg.add(objCom77_02.INT_TBL_DAT_COD_ITM_EMP_AUX,rst.getString("co_itmEmp"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_CAN_PED_EMB,    rst.getString("nd_can"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_CAN_PEN_PED_EMB,rst.getString("nd_can"));
                        vecReg.add(objCom77_02.INT_TBL_DAT_CAN_UTI_ING_IMP,"0");       
                        vecReg.add(objCom77_02.INT_TBL_DAT_CAN_ING_IMP_AUX,"0");
                        vecDat.add(vecReg);
                    }
                    rst.close();
                    stm.close();
    ...
    private boolean verificaItmUni(){
       ...
       try{
           for(int i=0; i<objTblModCom77_02.getRowCountTrue();i++){
               if(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM_EMP) != null){
                   int intCodItm    = Integer.parseInt((objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM_EMP).toString()));
                   int intCodItmAct = Integer.parseInt((objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM_EMP_ACT).toString()));
                   if(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_LIN).equals("M")){
                       if(intCodItm!=intCodItmAct){
                           mostrarMsgInf("El Item "+objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ALT_ITM).toString()+ " esta Unificado \n No es posible realizar cambio." );
                           blnRes=false;
                           break;
                       }
                   }
    ...
    public boolean eliminaRegistrosEliminados()
    {
        boolean blnRes=true;
        int intReaActStk=0;
        int intCodItm=0;
        ...
        try{
            arlAux=objTblModCom77_02.getDataSavedBeforeRemoveRow();
            if(arlAux!=null)
            {
                arlDatStkInvItm = new ArrayList(); 
                
                for(int i=0;i<arlDatFilEliCom77_03.size();i++)
                {
                    intCodItm = objUti.getIntValueAt(arlDatFilEliCom77_03, i, objCom77_02.INT_CFE_COD_ITM_EMP);
                    dblCan = objUti.getDoubleValueAt(arlDatFilEliCom77_03, i, objCom77_02.INT_CFE_CAN_ING_IMP_AUX);
    ...
    public boolean AnularRegDetalle()
    {
        boolean blnRes=false;
        int intReaActStk=0;
        int intCodItmOri=0;
        ...
        try
        {
            ...
            for(int i=0; i<objTblModCom77_02.getRowCountTrue();i++)
            {
                if(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM_EMP) != null){
                    ...
                    intCodItmOri=Integer.parseInt(((objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM_EMP_AUX)==null)?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM_EMP_AUX).toString()));
                    intCodBodOri=getCodigoBodegaEmpresa();
                    dblCanOri=Double.parseDouble(((objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_ING_IMP_AUX)==null)?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_ING_IMP_AUX).toString()));
                    intCodItm2 =   Integer.parseInt((objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM_EMP).toString()));
                    intCodBod2 =   intCodBodOri;
                    strNomItem =  ((objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_NOM_ITM)==null || objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_NOM_ITM).toString().equals(""))?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_NOM_ITM).toString());

                    dblCan=Double.parseDouble((objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP)==null)?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP).toString()));
            ...
            if (con!=null)
            {
                ...
                {                
                    case 'n':
                        ...
                        if(!objUti.costearDocumento(this, objParSis, con, Integer.parseInt(txtCodImp.getText()), Integer.parseInt(strCodLocPre), Integer.parseInt(txtCodTipDoc.getText()), Integer.parseInt(txtCodDoc.getText()))){
                            blnRes=false;
                        }
                        break;
                    case 'm':
                        ...
                        if (datFecDoc.compareTo(objUti.parseDate(dtpFecDoc.getText(), "dd/MM/yyyy"))>0){
                            for (i=0;i<objTblModCom77_02.getRowCountTrue();i++){
                                System.out.println("recostearItm");
                                //recostea la empresa
                                objUti.recostearItm2009DesdeFecha(this, objParSis, con, Integer.parseInt(txtCodImp.getText()), objTblModCom77_02.getValueAt(i,objCom77_02.INT_TBL_DAT_COD_ITM_EMP).toString(), dtpFecDoc.getText(), "dd/MM/yyyy");
                                //recostea el grupo
                                objUti.recostearItm2009DesdeFecha(this, objParSis, con, objParSis.getCodigoEmpresa(), objTblModCom77_02.getValueAt(i,objCom77_02.INT_TBL_DAT_COD_ITM).toString(), dtpFecDoc.getText(), "dd/MM/yyyy");
                            }
                        }
                        else{
                            for (i=0;i<objTblModCom77_02.getRowCountTrue();i++){
                                System.out.println("recostearItm");
                                //recostea la empresa
                                objUti.recostearItm2009DesdeFecha(this, objParSis, con, Integer.parseInt(txtCodImp.getText()), objTblModCom77_02.getValueAt(i,objCom77_02.INT_TBL_DAT_COD_ITM_EMP).toString(), objUti.formatearFecha(datFecDoc,"dd/MM/yyyy"), "dd/MM/yyyy");
                                //recostea el grupo
                                objUti.recostearItm2009DesdeFecha(this, objParSis, con, objParSis.getCodigoEmpresa(), objTblModCom77_02.getValueAt(i,objCom77_02.INT_TBL_DAT_COD_ITM).toString(), objUti.formatearFecha(datFecDoc,"dd/MM/yyyy"), "dd/MM/yyyy");
                            }
                        }
                        break;
                    default:
    ...
    private boolean anularEliminar_tbmDetMovInv()
    {
        ...
        try{
            if(con!=null){
                ...
                strSQL+=" WHERE a.co_emp="+objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_EMP);
                strSQL+=" AND a.co_loc="+objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_LOC);
                strSQL+=" AND a.co_doc="+objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_DOC);
                strSQL+=" AND a.co_tipDoc="+objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_TIPDOC);
    ...
    private boolean anularEliminar_tbmCabOrdConInv(int tipoOperacion){
        ...
        try{
            if (con!=null){
                ...
                strSQL+=" , co_usrMod=" + objParSis.getCodigoUsuario();
                strSQL+=" WHERE co_empRel=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_EMP);
                strSQL+=" AND co_locRel=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_LOC);
                strSQL+=" AND co_tipDocRel=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_TIPDOC);
                strSQL+=" AND co_docRel=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_DOC);
                strSQL+=" ; ";
                stm.executeUpdate(strSQL);
                stm.close();
                stm=null;
        ...
        try{
            if(con!=null){
                ...
                for(int i=0; i<objTblModCom77_02.getRowCountTrue(); i++){
                    ...
                    strSQL+="" + intCodDocOrdConImp + ",";//co_doc
                    strSQL+="" + j + ",";//co_reg
                    strSQL+="" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM) + ",";//co_itm
                    strSQL+="'I'";//st_regrep
                    strSQL+=");";
    ...
    private boolean actualizar_tbmDetMovInv(){
        ...
        try{
            if (con!=null){
                ...
                strSQL+=" WHERE a2.co_empRel=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_EMP);
                strSQL+=" AND a2.co_locRel=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_LOC);
                strSQL+=" AND a2.co_tipDocRel=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_TIPDOC);
                strSQL+=" AND a2.co_docRel=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_DOC);
                rst=stm.executeQuery(strSQL);
                if(rst.next()){
                ...
                for(int i=0; i<objTblModCom77_02.getRowCountTrue(); i++){
                    ...
                    if( !(isExisteItem_detMovInv( Integer.parseInt(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM_EMP).toString())     ))   ){//item empresa
                        //si no existe en tbm_detOrdConInv y se toma el maximo co_reg de tbm_detOrdConInv, NOOOOO!!!! de tbm_detMovInv
                        if(isExisteItem_detOrdConInv( Integer.parseInt(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM).toString())     ))  {//item grupo
                    ...
                    strSQL+=" SET nd_can=" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP) + "";
                    strSQL+=", nd_cosUni=" + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI).toString()), /*objParSis.getDecimalesBaseDatos()*/ 4) + "";
                    strSQL+=", nd_tot=" + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString()), objParSis.getDecimalesBaseDatos()) + "";
                    strSQL+=", nd_cosTot=" + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString()), /*objParSis.getDecimalesBaseDatos()*/ 4) + "";
                    strSQL+=", nd_cosUniGrp=" + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI).toString()), /*objParSis.getDecimalesBaseDatos()*/ 4) + "";
                    strSQL+=", nd_cosTotGrp=" + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString()), /*objParSis.getDecimalesBaseDatos()*/ 4) + "";
                    strSQL+=", nd_ara=" + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_POR_ARA)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_POR_ARA).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_POR_ARA).toString()), objParSis.getDecimalesBaseDatos()) + "";
                    strSQL+=", nd_preUniImp=" + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_PRE_UNI)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_PRE_UNI).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_PRE_UNI).toString()), objParSis.getDecimalesBaseDatos()) + "";
                    strSQL+=", nd_valTotFobCfr=" + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_FOB_CFR)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_FOB_CFR).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_FOB_CFR).toString()), objParSis.getDecimalesBaseDatos()) + "";
                    strSQL+=", nd_cantonmet=" + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_TON_MET)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_TON_MET).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_TON_MET).toString()), objParSis.getDecimalesBaseDatos()) + "";
                    strSQL+=", nd_valFle=" + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_FLE)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_FLE).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_FLE).toString()), objParSis.getDecimalesBaseDatos()) + "";
                    strSQL+=", nd_valCfr=" + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_CFR)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_CFR).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_CFR).toString()), objParSis.getDecimalesBaseDatos()) + "";
                    strSQL+=", nd_valTotAra=" + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_ARA)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_ARA).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_ARA).toString()), objParSis.getDecimalesBaseDatos()) + "";
                    strSQL+=", nd_valTotGas=" + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_GAS)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_GAS).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_GAS).toString()), objParSis.getDecimalesBaseDatos()) + "";
                    strSQL+=" WHERE co_emp=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_EMP) + "";
                    strSQL+=" AND co_loc=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_LOC) + "";
                    strSQL+=" AND co_tipDoc=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_TIPDOC) + "";
                    strSQL+=" AND co_doc=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_DOC) + "";                    
                    strSQL+=" AND co_itm=" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM_EMP) + "";
                    strSQL+=" AND EXISTS(";
                    ...
                    strSQL+=" (";
                    strSQL+=" SELECT ";
                    strSQL+="  " + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_EMP) + " AS co_emp"; //co_emp
                    strSQL+=", " + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_LOC) + " AS co_loc"; //co_loc
                    strSQL+=", " + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_TIPDOC) + " AS co_tipdoc"; //co_tipdoc
                    strSQL+=", " + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_DOC) + " AS co_doc"; //co_doc
                    strSQL+=", " + intMaxCodReg_detOrdCon + " AS co_reg"; //co_reg
                    strSQL+=", Null AS ne_numFil";//ne_numFil
                    strSQL+=", " + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM_EMP) + " AS co_itm";//co_itm
                    strSQL+=", " + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM_EMP) + " AS co_itmAct";//co_itmAct
                    strSQL+=", '" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ALT_ITM) + "' AS tx_codAlt";//tx_codAlt
                    strSQL+=", '" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_LET_ITM) + "' AS tx_codAlt2";//tx_codAlt2
                    strSQL+=", " + objUti.codificar(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_NOM_ITM)) + " AS tx_nomItm";//tx_nomItm
                    strSQL+=", '" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_UNI_MED) + "' AS tx_uniMed";//tx_uniMed
                    strSQL+=", " + intCodBodEmp + " AS co_bod";//co_bod
                    strSQL+=", '" + txtNomBod.getText() + "' AS tx_nomBodOrgDes";//tx_nomBodOrgDes
                    //strSQL+=", " + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP) + " AS nd_can";//nd_can
                    strSQL+=", " + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP) + " AS nd_can";//nd_can
                    strSQL+=", Null AS nd_canOrg";//nd_canOrg
                    strSQL+=", 0 AS nd_canDev";//nd_canDev
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI).toString()), /*objParSis.getDecimalesBaseDatos()*/ 4) + " AS nd_cosUni";//nd_cosUni
                    ...
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString()), /*objParSis.getDecimalesBaseDatos()*/ 4) + " AS nd_tot";//nd_tot 'precio al publico'
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString()), /*objParSis.getDecimalesBaseDatos()*/ 4) + " AS nd_cosTot";//nd_cosTot 'precio de compra para vender'
                    strSQL+=", 0 AS nd_exi";//nd_exi
                    strSQL+=", 0 AS nd_valExi";//nd_valExi
                    strSQL+=", 0 AS nd_cosPro";//nd_cosPro
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI).toString()), /*objParSis.getDecimalesBaseDatos()*/ 4) + " AS nd_cosUniGrp";//nd_cosUniGrp
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_COS).toString()), /*objParSis.getDecimalesBaseDatos()*/ 4) + " AS nd_cosTotGrp";//nd_cosTotGrp
                    ...
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_POR_ARA)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_POR_ARA).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_POR_ARA).toString()), objParSis.getDecimalesBaseDatos()) + " AS nd_ara";//nd_ara
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_PRE_UNI)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_PRE_UNI).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_PRE_UNI).toString()), objParSis.getDecimalesBaseDatos()) + " AS nd_preUniImp";//nd_preUniImp
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_FOB_CFR)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_FOB_CFR).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_FOB_CFR).toString()), objParSis.getDecimalesBaseDatos()) + " AS nd_valTotFobCfr";//nd_valTotFobCfr
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_TON_MET)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_TON_MET).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_TON_MET).toString()), objParSis.getDecimalesBaseDatos()) + " AS nd_cantonmet";//nd_cantonmet
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_FLE)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_FLE).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_FLE).toString()), objParSis.getDecimalesBaseDatos()) + " AS nd_valFle";//nd_valFle
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_CFR)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_CFR).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_VAL_CFR).toString()), objParSis.getDecimalesBaseDatos()) + " AS nd_valCfr";//nd_valCfr
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_ARA)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_ARA).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_ARA).toString()), objParSis.getDecimalesBaseDatos()) + " AS nd_valTotAra";//nd_valTotAra
                    strSQL+=", " + objUti.redondearBigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_GAS)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_GAS).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_TOT_GAS).toString()), objParSis.getDecimalesBaseDatos()) + " AS nd_valTotGas";//nd_valTotGas
                    ...
                    if(blnCreItmOrdConInv){
                        ...
                        strSQL+="            , " + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM) + " AS co_itm";//codigoGrupo
                        ...
                        strSQL+="		AND a1.st_reg='A'";
                        strSQL+="		AND a4.co_itm=" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM) + "";
                        strSQL+="	   )";
                        strSQL+=")";
                        strSQL+=";";
                        ...
                        strSQL+="            , " + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM) + " AS co_itm";
                    ...
                    if(blnCreItmOrdDisInm){
                        ...
                        strSQL+="            , " + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM) + " AS co_itm";//codigoGrupo
                        strSQL+="            , " + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP) + " AS nd_can";//nd_can
                        strSQL+="            , " + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_EMP) + " AS co_emprel";//co_emprel
                        strSQL+="            , " + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_LOC) + " AS co_locrel";//co_locrel
                        strSQL+="            , " + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_TIPDOC) + " AS co_tipdocrel";//co_tipdocrel
                        strSQL+="            , " + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_DOC) + "AS co_docrel";//co_docrel
                        ...
                        strSQL+="                   AND a2.co_tipDocRel=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_TIPDOC) + "";
                        strSQL+="                   AND a2.co_docRel=" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_DOC) + "";
                        strSQL+="                   AND a2.co_itm=" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM) + "";
                        strSQL+="                   AND a1.co_bod=" + INT_COD_BOD_INM_GRP + "";//15
                        strSQL+="                   AND a1.st_reg='A'";
...
//                stm=null;
    ...
    private boolean isExisteItemRepetido(){
        ...
        try{
            for(int i=0; i<objTblModCom77_02.getRowCountTrue(); i++){
                for(int j=(i+1); j<objTblModCom77_02.getRowCountTrue(); j++){
                    if(objTblModCom77_02.compareStringCells(i, objCom77_02.INT_TBL_DAT_COD_ITM, j, objCom77_02.INT_TBL_DAT_COD_ITM)){
                        blnRes=true;
                        break;
                    }
     ...
     * <BR> false : caso contrario
     */
    private boolean configurarCuentaComprasLocalesCabTipDoc(){
        boolean blnRes=false;
    ...
    private void generarAsiDia()
    {
        ...
        try{
            ...
            if(!configurarCuentaComprasLocalesCabTipDoc()){
        ...
        try{
            if(con!=null){
                ...
                for(int i=0; i<objTblModCom77_02.getRowCountTrue(); i++){
                    ...
                    strSQL+=", " + j ;//co_reg
                    strSQL+=", " + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM) ;//co_itm
                    bgdCanSel=new BigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP).equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP).toString())   );
    ...
    private boolean actualizar_tbmDetOrdDis(){
        ...
        try{
            if(con!=null){
                ...
                for(int i=0; i<objTblModCom77_02.getRowCountTrue(); i++){
                    strLin=objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_LIN)==null?"":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_LIN).toString();
                    if(strLin.equals("I")){//son nuevos registros
                        ...
                        strSQL+="" + intUltReg + ",";//co_reg
                        strSQL+="" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM) + ",";//co_itm
                        bgdCanSelAct=new BigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP).equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP).toString())   );
                   
                        strSQL+="" + bgdCanSelAct + ",";//nd_can
                        strSQL+="" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_EMP) + ",";//co_empRel
                        strSQL+="" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_LOC) + ",";//co_locRel
                        strSQL+="" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_TIPDOC) + ",";//co_tipDocRel
                        strSQL+="" + objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_DOC) + ",";//co_docRel
                        ...
                        bgdCanSelAct=new BigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP).equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP).toString())   );
                        bgdCanSelAnt=new BigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_ING_IMP_AUX)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_ING_IMP_AUX).equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_CAN_ING_IMP_AUX).toString())   );
                        ...
                        strSQL+=" AND co_itm=" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM) + ";";//codigo de item de grupo
    ...
    private boolean enviarCorElePreVta(){
        ...
        try{
            ...
            if(conValPreVta!=null){
                ...
                objCom77_02.ordenarDatPorCodAlt();
                objTblModCom77_02.setModoOperacion(objTblModCom77_02.INT_TBL_NO_EDI);
                objTblModCom77_02.removeEmptyRows();                   
                ...
                for(int i=0; i<objTblModCom77_02.getRowCountTrue(); i++){
                    ...
                    strSQL+=" WHERE a1.co_emp=" + objParSis.getCodigoEmpresa() + "";
                    strSQL+=" AND a1.co_itm=" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ITM) + "";
                    strSQL+=";";
                    ...
                    bgdCosUniInsPed=objUti.redondearBigDecimal((new BigDecimal(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI)==null?"0":(objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI).toString().equals("")?"0":objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COS_UNI).toString()))), objParSis.getDecimalesMostrar());
                    ...
                    if(bgdRelCosUniMarPreVta.compareTo(objUti.redondearBigDecimal( (bgdPreVtaItm.subtract((bgdPreVtaItm.multiply(new BigDecimal("0.25")))).multiply(new BigDecimal("1.005"))), objParSis.getDecimalesMostrar()))>0){//bgdPreVtaDscItm      por debajo del margen  - rojo
                        ...
                        strMsg+="	<td>" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_ALT_ITM) + "</td>";
                        strMsg+="	<td>" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_COD_LET_ITM) + "</td>";
                        strMsg+="	<td>" + objTblModCom77_02.getValueAt(i, objCom77_02.INT_TBL_DAT_NOM_ITM) + "</td>";
                ...
                objTblModCom77_02.setModoOperacion(objTblModCom77_02.INT_TBL_INS);
                conValPreVta.close();
                conValPreVta=null;
            }
        }
                ...
                if (objRptSis.getOpcionSeleccionada()==objRptSis.INT_OPC_ACE){
                    ...
                    for (i=0;i<intNumTotRpt;i++){
                        if (objRptSis.isReporteSeleccionado(i)){
                            ...
                            strSQL+="	        ON c1.co_emprelpedembimp=d1.co_emp AND c1.co_locrelpedembimp=d1.co_loc AND c1.co_tipdocrelpedembimp=d1.co_tipDoc	";
                            strSQL+="	        AND c1.co_docrelpedembimp=d1.co_doc               )	";
                            strSQL+="	        INNER JOIN       (           (	";
                            strSQL+="	                                         (tbm_inv AS a1 INNER JOIN tbm_equInv AS a3 ON a1.co_emp=a3.co_emp AND a1.co_itm=a3.co_itm)	";
                            strSQL+="	                                          LEFT OUTER JOIN tbm_var AS a2 ON (a1.co_uni=a2.co_reg)	";
                            strSQL+="	                                     )	";
                            ...
                            strSQL+="	 ) AS x	";
                            strSQL+="	 INNER JOIN(	";
                            strSQL+="	                         SELECT b1.co_itmMae, b2.co_itm AS co_itmGrp, b2.co_parara, b2.tx_par, b2.tx_des FROM(	";
                            strSQL+="	                                  SELECT a2.co_itmMae	";
                            strSQL+="	                                  FROM tbm_inv AS a1 INNER JOIN tbm_equInv AS a2	";
                            ...
                            try{
                                ...
                                double cantidad= objUti.redondear(objCom77_02.getTblTot().getValueAt(0, objCom77_02.INT_TBL_DAT_TOT_FOB_CFR)==null?"0":(objCom77_02.getTblTot().getValueAt(0, objCom77_02.INT_TBL_DAT_TOT_FOB_CFR).toString().equals("")?"0":objCom77_02.getTblTot().getValueAt(0, objCom77_02.INT_TBL_DAT_TOT_FOB_CFR).toString()), objParSis.getDecimalesMostrar());
                            ...
                            //strRutImg="D:\\DesaFuentes_Zafiro\\Reportes\\Compras\\ZafCom77";
                            ...
                            switch (Integer.parseInt(objRptSis.getCodigoReporte(i))){
                                case 473: //Compras Locales
                                    ...
                                    mapPar.put("strCamAudRpt", "" + (objUti.getStringValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_USR_ING) + " / " + objUti.getStringValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_USR_MOD) + " / " + objParSis.getNombreUsuario()) + "      " + strFecHorSer + "      " + this.getClass().getName() + "      " +  strNomRpt + " v0.1    ");
                                ...
                                default: //Ingreso por Importación
                                    ...
                                    //Inicializar los parametros que se van a pasar al reporte.
                                    mapPar.put("strCamAudRpt", "" + (objUti.getStringValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_USR_ING) + " / " + objUti.getStringValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_USR_MOD) + " / " + objParSis.getNombreUsuario()) + "      " + strFecHorSer + "      " + this.getClass().getName() + "      " +  strNomRpt + " v0.1    ");
                                    mapPar.put("codEmp", new Integer(objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_EMP)));
                                    mapPar.put("codLoc", new Integer(objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_LOC)));
                                    mapPar.put("codTipDoc", new Integer(objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_TIPDOC)));
                                    mapPar.put("codDoc", new Integer(objUti.getIntValueAt(arlDatConIngImp, intIndiceIngImp, INT_ARL_CON_ING_IMP_COD_DOC)));
                                    mapPar.put("strSQLRep", strSQLRep);
                                    ...
                                    if( (optTmFob.isSelected()) || (optTmCfr.isSelected()) ){
                                        mapPar.put("totMts", new BigDecimal(objCom77_02.getTblTot().getValueAt(0, objCom77_02.INT_TBL_DAT_CAN_TON_MET)==null?"0":(objCom77_02.getTblTot().getValueAt(0, objCom77_02.INT_TBL_DAT_CAN_TON_MET).toString().equals("")?"0":objCom77_02.getTblTot().getValueAt(0, objCom77_02.INT_TBL_DAT_CAN_TON_MET).toString())));//SUMA DE LA CANTIDAD
                                    }
                                    else{
                                        mapPar.put("totMts", new BigDecimal(objCom77_02.getTblTot().getValueAt(0, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP)==null?"0":(objCom77_02.getTblTot().getValueAt(0, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP).toString().equals("")?"0":objCom77_02.getTblTot().getValueAt(0, objCom77_02.INT_TBL_DAT_CAN_PZA_ING_IMP).toString())));//SUMA DE LA CANTIDAD
                                    }
                                    mapPar.put("fleApr", new BigDecimal("0"));
                                    mapPar.put("cfrApr", new BigDecimal(objCom77_02.getTblTot().getValueAt(0, objCom77_02.INT_TBL_DAT_VAL_CFR)==null?"0":(objCom77_02.getTblTot().getValueAt(0, objCom77_02.INT_TBL_DAT_VAL_CFR).toString().equals("")?"0":objCom77_02.getTblTot().getValueAt(0, objCom77_02.INT_TBL_DAT_VAL_CFR).toString())));//SUMA DE LA CANTIDAD
