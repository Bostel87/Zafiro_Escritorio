 ...
 * @author  Ingrid Lino
 */
public class ZafCom76_01 extends javax.swing.JPanel
{
    ...
    private ZafTblModLisCom76_01 objTblModLis;           //Detectar cambios de valores en las celdas.
    ...
    //private boolean blnIsEditableFlete;
    //private String strTipoCargoPagar;
    
    protected EventListenerList objEveLisLis=new EventListenerList();

    /** Crea una nueva instancia de la clase ZafCom76_01. */
    public ZafCom76_01(ZafParSis obj)
    {
        initComponents();
        //Inicializar objetos.
        objParSis=obj;
...
//            //Configurar JTable: Ocultar columnas del sistema.
            ...
            objTblCelEdiTxt.addTableEditorListener(new Librerias.ZafTblUti.ZafTblEvt.ZafTableAdapter() {
                ...
                public void afterEdit(Librerias.ZafTblUti.ZafTblEvt.ZafTableEvent evt) {
                    if(strTipCar.equals("F")){
                        ...
                        System.out.println("bgdDerAra: " + bgdDerAra);
                        ////bgdDerAra=new BigDecimal(objTblTot.getValueAt(1, INT_TBL_DAT_VAL_CAR_PAG_IMP)==null?"0":(objTblMod.getValueAt(1, INT_TBL_DAT_VAL_CAR_PAG_IMP).toString().equals("")?"0":objTblMod.getValueAt(1, INT_TBL_DAT_VAL_CAR_PAG_IMP).toString()));
                        intFilAra=intFil;
                        intColAra=intCol;
                    }
            ...
            objTblModLis=new ZafTblModLisCom76_01();
...
//            objTblTot.setValueAt("Total Gastos:",    2, INT_TBL_DAT_NOM_CAR_PAG_IMP);
     ...
     */
    private class ZafTblModLisCom76_01 implements javax.swing.event.TableModelListener
    {
...
//           }
    ...
    public void setObjectoCom76_02(ZafCom76_02 objCom76_02){
        this.objCom76_02=objCom76_02;
    }

    public ZafTblMod getTblModCom76_01() {
        return objTblMod;
    }

    public void setTblModCom76_01(ZafTblMod objTblMod) {
...
//            calculaTotalGastos();
    ...
    public boolean limpiarTablaCom76_01(){
        boolean blnRes=true;
        try{
            objTblMod.removeAllRows();
            inicializarTablaTotales();
    ...
    public boolean isBlnHayCamCom76_01() {
        return blnHayCam;
    }

    public void setBlnHayCamCamCom76_01(boolean blnHayCam) {
...
//    public boolean isBlnIsPerModCarPag() {
//        return blnIsPerModCarPag;
//    }
