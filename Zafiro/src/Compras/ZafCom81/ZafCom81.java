 ...
 * ZafCom81.java
 *
 * Created on 22 de octubre de 2014, 09:00 AM
 */
package Compras.ZafCom81;
 ...
 * @author  Eddye Lino
 */
public class ZafCom81 extends javax.swing.JInternalFrame 
{
    ...
    static final int INT_TBL_DAT_DOC_ORI=7;                     //Documento que origina la guía de remisión.
    static final int INT_TBL_DAT_NUM_DOC=8;                     //Número del documento (Preimpreso).
    ...
    static final int INT_TBL_DAT_DIR_CLI=12;                    //Nombre del cliente.
    static final int INT_TBL_DAT_COD_BOD=13;                    //Código de la bodega.
    static final int INT_TBL_DAT_NOM_BOD=14;                    //Nombre de la bodega.
    static final int INT_TBL_DAT_COD_ITM=15;                    //Código del item (Sistema).
    static final int INT_TBL_DAT_COD_ALT=16;                    //Código del item (Alterno).
    static final int INT_TBL_DAT_NOM_ITM=17;                    //Nombre del item.
    static final int INT_TBL_DAT_DEC_UNI=18;                    //Descripción corta de la unidad de medida.
    static final int INT_TBL_DAT_CAN=19;                        //Cantidad.
    static final int INT_TBL_DAT_PES_KGR=20;                    //Peso en kilogramos.
    static final int INT_TBL_DAT_COD_VEH=21;                    //Código del vehículo.
    static final int INT_TBL_DAT_PLA_VEH=22;                    //Placa del vehículo.
    static final int INT_TBL_DAT_COD_CHO=23;                    //Código del chofer.
    static final int INT_TBL_DAT_IDE_TRA=24;                    //Identificación del transportista.
    static final int INT_TBL_DAT_NOM_TRA=25;                    //Nombre del transportista.
    static final int INT_TBL_DAT_OBS2=26;                       //Observación 2.
    static final int INT_TBL_DAT_EST_DOC=27;                    //Estado del documento.
    //Variables
...
//            lsm.addListSelectionListener(new ZafLisSelLisCre());
    ...
    private boolean configurarTblDat()
    {
        ...
        try
        {
            //Configurar JTable: Establecer el modelo.
            vecDat=new Vector();    //Almacena los datos
            vecCab=new Vector(28);  //Almacena las cabeceras
            vecCab.clear();
            ...
            vecCab.add(INT_TBL_DAT_OBS2,"Obs.2");
            ...
            tcmAux.getColumn(INT_TBL_DAT_NOM_CLI).setPreferredWidth(130);
            ...
            tcmAux.getColumn(INT_TBL_DAT_NOM_TRA).setPreferredWidth(130);
            tcmAux.getColumn(INT_TBL_DAT_OBS2).setPreferredWidth(120);
        ...
        try
        {
            ...
            if (con!=null)
            {
                ...
                for (j=0; j<intNumFilTblBod; j++)
                {
                    ...
                    {
                        if (i==0)
                            strAux+=" (a5.co_empGrp=" + objTblModBod.getValueAt(j, INT_TBL_BOD_COD_EMP) + " AND a5.co_bodGrp=" + objTblModBod.getValueAt(j, INT_TBL_BOD_COD_BOD) + ")";
                        else
                            strAux+=" OR (a5.co_empGrp=" + objTblModBod.getValueAt(j, INT_TBL_BOD_COD_EMP) + " AND a5.co_bodGrp=" + objTblModBod.getValueAt(j, INT_TBL_BOD_COD_BOD) + ")";
                        i++;
                    }
                }
                ...
                //Armar la sentencia SQL.
                strSQL="";
                strSQL+="SELECT a1.co_emp, a1.co_loc, a1.co_tipDoc, a4.tx_desCor, a4.tx_desLar, a1.co_doc, a1.tx_datDocOriGuiRem, a1.ne_numDoc, a1.fe_doc, a1.co_cliDes, a1.tx_nomCliDes, a1.tx_dirCliDes, a5.co_bodGrp, a3.tx_nom AS a3_tx_nom";
                strSQL+=", a2.co_itm, a2.tx_codAlt, a2.tx_nomItm, a2.tx_uniMed, a2.nd_can, a2.nd_pesTotKgr";
                strSQL+=", a1.co_veh, (CASE WHEN a1.co_veh IS NULL THEN a1.tx_plaVehTra ELSE a6.tx_pla END) AS tx_plaVehTra";
                strSQL+=", a1.co_cho, (CASE WHEN a1.co_cho IS NULL THEN a1.tx_ideTra ELSE a7.tx_ide END) AS tx_ideTra, (CASE WHEN a1.co_cho IS NULL THEN a1.tx_nomTra ELSE a7.tx_nom || ' ' || a7.tx_ape END) AS tx_nomTra";
                strSQL+=", a1.tx_obs2, a1.st_reg";
                ...
                strSQL+=" INNER JOIN tbm_bod AS a3 ON (a1.co_emp=a3.co_emp AND a1.co_ptoPar=a3.co_bod)";
                strSQL+=" INNER JOIN tbm_cabTipDoc AS a4 ON (a1.co_emp=a4.co_emp AND a1.co_loc=a4.co_loc AND a1.co_tipDoc=a4.co_tipDoc)";
                strSQL+=" INNER JOIN tbr_bodEmpBodGrp AS a5 ON (a3.co_emp=a5.co_emp AND a3.co_bod=a5.co_bod)";
                strSQL+=" LEFT OUTER JOIN tbm_veh AS a6 ON (a1.co_veh=a6.co_veh)";
                strSQL+=" LEFT OUTER JOIN tbm_tra AS a7 ON (a1.co_cho=a7.co_tra)";
                strSQL+=" WHERE a1.ne_numOrdDes=0";
                strSQL+=strConSQL;
                strSQL+=" ORDER BY a5.co_bodGrp, a1.ne_numDoc, a2.co_reg";
                rst=stm.executeQuery(strSQL);
                //Limpiar vector de datos.
                vecDat.clear();
                //Obtener los registros.
                ...
                while (rst.next())
                {
                    if (blnCon)
                    {
                        ...
                        vecReg.add(INT_TBL_DAT_DIR_CLI,rst.getString("tx_dirCliDes"));
                        vecReg.add(INT_TBL_DAT_COD_BOD,rst.getString("co_bodGrp"));
                        vecReg.add(INT_TBL_DAT_NOM_BOD,rst.getString("a3_tx_nom"));
                        ...
                        vecReg.add(INT_TBL_DAT_OBS2,rst.getString("tx_obs2"));
        ...
        public void mouseMoved(java.awt.event.MouseEvent evt)
        {
            ...
            switch (intCol)
            {
                ...
                case INT_TBL_DAT_NOM_TRA:
                    ...
                    break;
                case INT_TBL_DAT_OBS2:
                    strMsg="Observación 2";
                    break;
