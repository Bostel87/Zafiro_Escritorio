 ...
 * ZafCon06.java
 *
 * Created on 31 de octubre de 2005, 14:02 PM
 */
package Contabilidad.ZafCon07;
 ...
 * @author  Eddye Lino
 */
public class ZafCon07 extends javax.swing.JInternalFrame 
{
    ...
    private String strIdeBen, strDirBen;                //Campos: RUC y Direcci�n del Beneficiario.
    ...
    public ZafCon07(ZafParSis obj, Integer codigoCuenta)
    {
        this(obj);
//        txtCodSis.setText(codigoCuenta.toString());
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        txtDesLarBen = new javax.swing.JTextField();
        ...
        lblCodDoc.setBounds(0, 64, 100, 20);

        panGenCab.add(txtCodDoc);
        txtCodDoc.setBounds(100, 64, 148, 20);
        ...
        lblBen.setToolTipText("Tipo de documento");
        ...
        txtCodBen.setBounds(100, 44, 56, 20);

        txtDesLarBen.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtDesLarBenActionPerformed(evt);
            }
        });
        txtDesLarBen.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtDesLarBenFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtDesLarBenFocusLost(evt);
            }
        });

        panGenCab.add(txtDesLarBen);
        txtDesLarBen.setBounds(156, 44, 236, 20);
    ...
    private void txtDesLarBenFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtDesLarBenFocusLost
        //Validar el contenido de la celda s�lo si ha cambiado.
        if (!txtDesLarBen.getText().equalsIgnoreCase(strDesLarBen))
        {
            if (txtDesLarBen.getText().equals(""))
            {
                txtCodBen.setText("");
                txtDesLarBen.setText("");
            }
            else
            {
                mostrarVenConBen(2);
    ...
    }//GEN-LAST:event_txtDesLarBenFocusLost

    private void txtDesLarBenFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtDesLarBenFocusGained
        strDesLarBen=txtDesLarBen.getText();
        txtDesLarBen.selectAll();
    }//GEN-LAST:event_txtDesLarBenFocusGained

    private void txtDesLarBenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDesLarBenActionPerformed
        txtDesLarBen.transferFocus();
    }//GEN-LAST:event_txtDesLarBenActionPerformed
    ...
    private javax.swing.JTextField txtDesLarBen;
    ...
    private boolean configurarFrm()
    {
        ...
        try
        {
            ...
            this.setTitle(objParSis.getNombreMenu() + " v0.2.2");
            ...
            if(System.getProperty("os.name").equals("Linux"))
                strNomRep="//zafiro//reportes_impresos//RptDebBan.jrxml";
            else
                strNomRep="C://Zafiro//Reportes_impresos//RptDebBan.jrxml";
        ...
        public boolean vistaPreliminar()
        {
            ...
            try
            {
                if(conIns!=null){                
                    ...
                    //JasperDesign jasperDesign = JRXmlLoader.load("//Tuval//Ingrid_Lino//Fuentes//Reportes//Reportes_impresos//RptDebBan.jrxml");
                    JasperReport jasperReport = JasperCompileManager.compileReport(jasperDesign);                                
                    // Second, create a map of parameters to pass to the report.
                    Map parameters = new HashMap();
                    parameters.put("codEmp", ""+intCodEmp);
                    System.out.println("codigo empresa:"+intCodEmp);
                    
                    parameters.put("codLoc", ""+intCodLoc);
                    System.out.println("codigo local:"+intCodLoc);
                    
                    parameters.put("codTipDoc", txtCodTipDoc.getText());
                    System.out.println("codigo tipo doc:"+txtCodTipDoc.getText());
                    
                    parameters.put("codDia", txtCodDoc.getText());
                    System.out.println("codigo diario:"+txtCodDoc.getText());
                                        
                    parameters.put("nomEmp", nomEmp);
                    System.out.println("nombre empresa:"+nomEmp);                    
                    
                    parameters.put("dirEmp", dirEmp);
                    System.out.println("direccion empresa:"+dirEmp);
                    
                    parameters.put("rucEmp", rucEmp);          
                    System.out.println("ruc empresa:"+rucEmp);
                                        
                    parameters.put("nomBen", txtDesLarBen.getText());                                                            
                    System.out.println("nombre beneficiario:"+txtDesLarBen.getText());
                                        
                    parameters.put("fecDoc", dtpFecDoc.getText());
                    System.out.println("fecha documento:"+dtpFecDoc.getText());
                                        
                    parameters.put("nomCta", txtDesLarCta.getText());                    
                    System.out.println("nombre cta:"+txtDesLarCta.getText());
                                        
                    parameters.put("glo", glo);
                    System.out.println("glosa:"+glo);
                    
                    parameters.put("monDoc", txtMonDoc.getText());
                    System.out.println("monto documento:"+txtMonDoc.getText());                    
                    
                    parameters.put("numAlt", txtNumDoc1.getText());
                    System.out.println("numero comprobante:"+txtNumDoc1.getText());
...
//            cargarReg();
    ...
    private boolean consultarRegIns()
    {
        ...
        try
        {
            ...
            if (conCab!=null)
            {
                ...
                strSQL+=" AND a1.st_reg <> 'E' " ;  ///Eliminacion Logica/////
    ...
    private boolean insertarCab()
    {
        ...
        try
        {
            if (con!=null)
            {
                ...
                strSQL+=", " + objUti.codificar(txtCodBen.getText(),2);
                strSQL+=", " + objUti.codificar(strIdeBen);
                strSQL+=", " + objUti.codificar(txtDesLarBen.getText());
                strSQL+=", " + objUti.codificar(strDirBen);
    ...
    private boolean cargarCabReg()
    {
        ...
        try
        {
            ...
            if (con!=null)
            {
                ...
                strSQL+=", a1.ne_numDoc1, a1.co_cta, a3.tx_codCta, a3.tx_desLar AS a3_tx_desLar, a1.co_cli";
                ...
                if (rst.next())
                {
                    ...
                    strIdeBen=rst.getString("tx_ruc");
                    strAux=rst.getString("tx_nomCli");
                    txtDesLarBen.setText((strAux==null)?"":strAux);
                    strDirBen=rst.getString("tx_dirCli");
    ...
    private boolean actualizarCab()
    {
        ...
        try
        {
            if (con!=null)
            {
                ...
                strSQL+=", co_cli=" + objUti.codificar(txtCodBen.getText(),2);
                strSQL+=", tx_ruc=" + objUti.codificar(strIdeBen);
                strSQL+=", tx_nomCli=" + objUti.codificar(txtDesLarBen.getText());
                strSQL+=", tx_dirCli=" + objUti.codificar(strDirBen);
    ...
    private boolean mostrarVenConBen(int intTipBus)
    {
        ...
        try
        {
            strAli="C�digo, Identificaci�n, Nombre, Direcci�n";
