 ...
 * @author sistemas9
 */
public class ZafCon64_02 extends javax.swing.JDialog 
{        
    ...
    public ZafCon64_02(java.awt.Frame parent, boolean modal, ZafParSis obj, int codEmpresa, int codLocal, int codTipoDocumento, int codDocumento, int codRegistro, char estadoOperacion) {
        super(parent, modal);
        try{
            initComponents();
              //Inicializar objetos.
