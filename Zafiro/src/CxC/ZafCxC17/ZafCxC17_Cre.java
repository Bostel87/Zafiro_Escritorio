 ...
 * @author  jayapata
 */
public class ZafCxC17_Cre extends javax.swing.JDialog {
    ...
    public ZafCxC17_Cre(java.awt.Frame parent, boolean modal, Librerias.ZafParSis.ZafParSis obj, int intCod_Emp, String strCocLoc, String strDocTipDoc, String strCocDoc ) {
         super(parent, modal);
        try{ /**/
...
private boolean configurarVenConVendedor() {
   ...
   return blnRes;
    ...
    private void initComponents() {
        ...
        lblTit.setText("Noda de Crédito");
        lblTit.setPreferredSize(new java.awt.Dimension(78, 34));
        ...
        panCotGenSurCen.setPreferredSize(new java.awt.Dimension(650, 70));
