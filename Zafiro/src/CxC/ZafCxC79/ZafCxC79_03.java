/*
 * Se exporto código del ZafVenConCxC01.java
 *
 ...
 * @author  Eddye Lino
 */
public class ZafCxC79_03 extends javax.swing.JDialog
{
    //Constantes:
    ...
    public static final int INT_TBL_DAT_TIP_CRE=26;             //Tipo de credito (TARJETAS DE CREDITO) José Marín 11/Mar/2014.
    ZafCxC79 objZafCxC79;
    ...
    private String strVersion=" v 0.1";                         //Version de la ventana José Marín M.
    private int intTipCre;
     ...
     */
    public ZafCxC79_03(java.awt.Frame padre, ZafParSis parametros, String titulo)
    {
        // this(padre, parametros, titulo, false);
        System.out.println("ZafCxC79_03 Constructor 1 ");
    }
     ...
     */
    public ZafCxC79_03(java.awt.Frame padre, ZafParSis parametros, String titulo, boolean tarjetasCredito, CxC.ZafCxC79.ZafCxC79 objZafCxC79)
    {
        super(padre, true);
        initComponents();
        //Inicializar objetos.
        this.objParSis = parametros;
        strTit=titulo;
        intButSelDlg=INT_BUT_CAN;
        this.objZafCxC79 = objZafCxC79;
        blnTarCre=tarjetasCredito;
        intTipCon=1;
        System.out.println("ZafCxC79_03 Constructor 2 ");
        if (!configurarFrm())
            exitForm();
    }
    ...
    private boolean configurarFrm()
    {
        ...
        try
        {
            ...
            //Inicializar objetos.
            objUti=new ZafUtil();
            this.setTitle(strTit + strVersion);
    ...
    private boolean configurarTblDat()
    {
        ...
        try
        {
            ...
            vecCab.add(INT_TBL_DAT_TIP_CRE,"Tip.Cre."); // TC José Marín 11/Mar/2014
            ...
            tcmAux.getColumn(INT_TBL_DAT_TIP_CRE).setPreferredWidth(70);  // TC José Marín 11/Marzo/2014
            ...
            objTblMod.addSystemHiddenColumn(INT_TBL_DAT_TIP_CRE, tblDat); // TC José Marín 11/Marzo/2014
    ...
    private boolean cargarDetReg()
    {
        ...
        try
        {
            intTipCre=objZafCxC79.getTipCre();
            ...
            if (con!=null)
            {
                ...
                strSQL+=", a4.tx_desLar AS a4_tx_desLar, a2.tx_numCtaChq, a2.tx_numChq, a2.fe_recChq, a2.fe_venChq, a2.nd_monChq, a1.co_tipCre";  // TC José Marín 11/Marzo/2014
                strSQL+=" FROM ";
                if (objUti.utilizarClientesEmpresa(objParSis, objParSis.getCodigoEmpresa(), objParSis.getCodigoLocal(), objParSis.getCodigoUsuario()))
                {
                ...
                strSQL+=" INNER JOIN tbm_tipCreRedTarCre as a6 ON (a1.co_emp=a6.co_emp AND a1.co_tipCre=a6.co_tipCre)";
                strSQL+=" INNER JOIN tbm_redTarCre as a7 ON (a6.co_redTarCre=a7.co_redTarCre)";
                strSQL+=" WHERE a1.co_emp=" + objParSis.getCodigoEmpresa();
                ...
                if (blnTarCre)
                    ...
                    strSQL+=" AND a5.ne_tipForPag<>4";
                strSQL+=" AND a7.co_redTarCre=" + intTipCre;
                strSQL+=" ORDER BY a2.co_emp, a2.co_loc, a2.co_tipDoc, a2.co_doc, a2.co_reg";
                System.out.println("zafCxC79_03:cargarDetReg: " + strSQL);
                ...
                while (rst.next())
                {
                    if (blnCon)
                    {
                        ...
                        vecReg.add(INT_TBL_DAT_TIP_CRE,rst.getString("co_tipCre")); //TC José Marín 11/Marzo/2014
                        vecDat.add(vecReg);
                    }
                    else
                    {
    ...
    {
        System.out.println("setTipoConsulta: " + tipo);
        intTipCon=tipo;
        switch (intTipCon)
        {
            case 1: //CxC (Todos los cobros).
