 ...
 * @author  ilino
 */
public class ZafHer19 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblCodHis.setBounds(230, 20, 120, 22);

        panCab.add(txtCodHis);
        txtCodHis.setBounds(350, 20, 80, 20);
    ...
    private boolean configurarFrm(){
        ...
        vecCab.add(INT_TBL_DAT_CHK, "CIE");
    ...
    private boolean consultarReg()
    {
        ...
        try
        {
            ...
            if (conCab!=null)
            {
                ...
                strSQL="";
                strSQL+=" select a1.co_emp, a1.ne_ani, a1.co_his";
                strSQL+=" from tbh_cabCieSis as a1 left outer join tbh_detCieSis as a2";
                ...
                strSQL+=" group by a1.co_emp, a1.ne_ani, a1.co_his";
                strSQL+=" order by a1.co_emp, a1.co_his";
    ...
    private boolean cargarDetReg()
    {
        ...
        try{
            ...
            if (con!=null){
                ...
                strSQL+=" and a1.ne_ani=" + rstCab.getString("ne_ani") + "";
                strSQL+=" and a1.co_his=" + rstCab.getString("co_his") + "";
                strSQL+=" order by a1.co_emp, a1.co_his, a2.ne_mes";
...
//                while (rst.next()){
                    for( int k=0; rst.next(); k++){
                        ...
                        System.out.println("EL MES ES: " + strCodCtaRst[k]);
