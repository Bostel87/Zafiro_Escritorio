 ...
 * @author  Eddye Lino
 */
public class ZafHer14 extends javax.swing.JInternalFrame 
{
    ...
    final int INT_TBL_DAT_NIV=3;                        //Nivel.
    final int INT_TBL_DAT_NOM=4;                        //Nombre del menú.
    //Variables generales.
...
////////////////////////////////////////////////////////////////////////////////////////////////////                
                ...
                if(optGrp.isSelected()){
                    stm=con.createStatement();
                    strSQL="";
                    strSQL+=" SELECT a1.co_usr, a1.tx_usr, a1.tx_nom, c1.co_emp, c1.co_loc, ";
                    strSQL+=" c1.co_usr, c1.co_mnu, a2.co_grp, a2.tx_desCor, a2.tx_desLar";
                    ...
                    strSQL+="         INNER JOIN tbr_perUsr AS c1 ON a1.co_usr=c1.co_usr AND c1.co_emp=" + objParSis.getCodigoEmpresa() + " AND c1.co_loc=" + objParSis.getCodigoLocal() + ")";
                    strSQL+=" INNER JOIN tbm_grpUsr AS a2";
                    strSQL+=" ON a1.co_grpUsr=a2.co_grp";
                    strSQL+=" where c1.co_emp=" + objParSis.getCodigoEmpresa() + "";
                    strSQL+=" AND c1.co_loc=" + objParSis.getCodigoLocal() + "";
                    ...
                    strSQL+=" ORDER BY a1.co_usr, c1.co_emp, c1.co_loc, c1.co_mnu";
                                ...
                                while( !(strColVec.equals(""))  ){
                                    if(strColVec.toString().equals(strColTbl)){
                                        if(objTblMod.isChecked(i, j)){
                                            ...
                                            stm=con.createStatement();
                                            strSQL="";
                                            strSQL+="INSERT INTO tbr_perUsr(";
                                            strSQL+=" co_emp, co_loc, co_usr, co_mnu)";
                                            strSQL+=" VALUES (";
