 ...
 * @author usuario
 */
public class ZafContOD extends JFrame{
    ...
    private ZafTblMod objTblMod; 
      ...
      public ZafContOD (/*ZafParSis objParSis*/){
          try{
      ...
      private void initComponents(){
          ...
          JLabel lblNumOD= new javax.swing.JLabel();
          lblNumOD.setFont(new java.awt.Font("SansSerif", 0, 11));
          lblNumOD.setText("NumeroOD:"); 
          panSup.add(lblNumOD);
          lblNumOD.setBounds(5, 10, 100, 20);
