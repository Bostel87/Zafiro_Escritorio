...
public abstract class ZafTableColBut_uni implements Click{
    String strTexto = ".."; // Texto en el Boton
    /** Creates a new instance of tblColBut */
    public ZafTableColBut_uni(javax.swing.JTable tblWithBut, int intColumna, String strMsn) {
  
        tblWithBut.getColumnModel().getColumn(intColumna).setCellRenderer(new CustomButtonRenderer(strMsn)); 
    ...
    class CustomButtonRenderer extends javax.swing.JButton implements javax.swing.table.TableCellRenderer {
        ...
        public CustomButtonRenderer(String strMsn) {
            setOpaque(true);
            this.setToolTipText(strMsn);
        }
