 ...
 */
public class ZafConItm_10 extends javax.swing.JDialog {
    
    //Constantes: Columnas del JTable:
    final int INT_TBL_LIN=0;                        //Línea
    final int INT_TBL_NUMFAC=1;                    // NUMERO DE FACTURA
    final int INT_TBL_FECDOC=2;                    // FECHA DEL DOCUMENTO 
    ...
    public ZafConItm_10(java.awt.Frame parent, boolean modal, java.util.ArrayList vector , ZafParSis obj,  javax.swing.JDesktopPane dskGe, String strTit) {  //(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
         objParSis=obj;
        initComponents();
         arlDat=vector;
