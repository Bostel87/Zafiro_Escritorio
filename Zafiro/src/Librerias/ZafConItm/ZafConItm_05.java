 ...
 */
public class ZafConItm_05 extends javax.swing.JDialog {
    
    //Constantes: Columnas del JTable:
    final int INT_TBL_LIN=0;                        //Línea
    final int INT_TBL_CODEMP=1;                    // empresa-local.
    final int INT_TBL_CODLOC=2;                    // fecha de documento.
    final int INT_TBL_CODCOT=3;                    // numero de cotizacion.
    final int INT_TBL_FECCOT=4;                    // usuario vendedor
    final int INT_TBL_CODCLI=5;                    // boton de busqueda
    final int INT_TBL_NOMCLI=6;                    // boton de busqueda
    final int INT_TBL_VALTOT=7;                    // Codigo empresa.
    final int INT_TBL_BUTCLI=8;                    // boton de busqueda
    final int INT_TBL_BUTCOT=9;                    // Codigo empresa.
    ...
    public ZafConItm_05(java.awt.Frame parent, boolean modal, java.util.ArrayList vector , ZafParSis obj,  javax.swing.JDesktopPane dskGe) {  //(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
         objParSis=obj;
        initComponents();
         arlDat=vector;
    ...
    private boolean configurarFrm()
    {
        ...
        try
        {
            //Inicializar objetos.
            objUti=new ZafUtil();
            strAux="Listado de cotizaciones a contactar ";  //objParSis.getNombreMenu();
            ...
            vecCab.add(INT_TBL_FECCOT,"Fet.Cot.");
            vecCab.add(INT_TBL_CODCLI,"Cod.Cli.");
            vecCab.add(INT_TBL_NOMCLI,"Nom.Cli.");
            vecCab.add(INT_TBL_VALTOT,"Valor.");
            vecCab.add(INT_TBL_BUTCLI,"Cliente.");
            vecCab.add(INT_TBL_BUTCOT,"Cotizacion");
            ...
            tcmAux.getColumn(INT_TBL_FECCOT).setPreferredWidth(70);
            tcmAux.getColumn(INT_TBL_CODCLI).setPreferredWidth(25);
            tcmAux.getColumn(INT_TBL_NOMCLI).setPreferredWidth(120);
            tcmAux.getColumn(INT_TBL_VALTOT).setPreferredWidth(80);
            tcmAux.getColumn(INT_TBL_BUTCLI).setPreferredWidth(20);
            tcmAux.getColumn(INT_TBL_BUTCOT).setPreferredWidth(20);
            
	    
            
            tcmAux.getColumn(INT_TBL_CODCLI).setWidth(0);
            tcmAux.getColumn(INT_TBL_CODCLI).setMaxWidth(0);
            tcmAux.getColumn(INT_TBL_CODCLI).setMinWidth(0);
            tcmAux.getColumn(INT_TBL_CODCLI).setPreferredWidth(0);
	    ...
	    objTblCelRenLbl=new Librerias.ZafTblUti.ZafTblCelRenLbl.ZafTblCelRenLbl();
            ...
            tcmAux.getColumn(INT_TBL_VALTOT).setCellRenderer(objTblCelRenLbl);
            ...
            objTblCelRenBut=new Librerias.ZafTblUti.ZafTblCelRenBut.ZafTblCelRenBut();
            tcmAux.getColumn(INT_TBL_BUTCOT).setCellRenderer(objTblCelRenBut);
            objTblCelRenBut=null;
            new ButCot(tblDat, INT_TBL_BUTCOT);   //*****
            objTblCelRenBut=null;
    ...
    private class ButCli extends Librerias.ZafTableColBut.ZafTableColBut_uni{
        public ButCli(javax.swing.JTable tbl, int intIdx){
            super(tbl,intIdx, "Cliente.");
           
        }
        public void butCLick() {
           int intCol = tblDat.getSelectedRow();
           String strCodCLi = tblDat.getValueAt(intCol,  INT_TBL_CODCLI ).toString();
           invocarClaseCli("Maestros.ZafMae07.ZafMae07", strCodCLi, "828" );
    ...
    private class ButCot extends Librerias.ZafTableColBut.ZafTableColBut_uni{
        ...
        public void butCLick() {
           ...
           String strCodCot = tblDat.getValueAt(intCol,  INT_TBL_CODCOT ).toString();
     ...
     private boolean invocarClaseCli(String clase, String strCodCli, String strCodMod )
    {
        boolean blnRes=true;
        try
        {
            ...
            Object objObj[]=new Object[3];
            objObj[0]=objParSis;
            objObj[1]= new Integer(Integer.parseInt(strCodCli));
            objObj[2]= new Integer(Integer.parseInt(strCodMod));
...
private void cargarDatos(){
 ...
 for(int i=0; i<arlDat.size(); i++){
        ...
        vecReg.add(INT_TBL_CODCOT, objUti.getStringValueAt(arlDat, i, 2) );
        vecReg.add(INT_TBL_FECCOT, objUti.getStringValueAt(arlDat, i, 3) ); 
        vecReg.add(INT_TBL_CODCLI, objUti.getStringValueAt(arlDat, i, 4) ); 
        vecReg.add(INT_TBL_NOMCLI, objUti.getStringValueAt(arlDat, i, 5) ); 
        vecReg.add(INT_TBL_VALTOT, objUti.getStringValueAt(arlDat, i, 6) ); 
 ...
 public void mouseMoved(java.awt.event.MouseEvent evt){
    ...
    switch (intCol){
        ...
        case INT_TBL_CODLOC:
            ...
            break;
        case INT_TBL_CODCOT:
            strMsg="Código de la cotización.";
            break;
        case INT_TBL_FECCOT:
        ...
        case INT_TBL_NOMCLI:
            ...
            break;
        case INT_TBL_VALTOT:
            strMsg="Valor de la cotización.";
            break;
        case INT_TBL_BUTCLI:
            strMsg="Visualizar cliente.";
            break; 
        case INT_TBL_BUTCOT:
            strMsg="Visualizar cotización.";
            break;
