 ...
 */
public class ZafConItm_09 extends javax.swing.JDialog {
    
    //Constantes: Columnas del JTable:
    final int INT_TBL_LIN=0;                        //Línea
    final int INT_TBL_NUMFAC=1;                    // NUMERO DE FACTURA
    final int INT_TBL_NUMSOL=2;                    // NUMERO DE SOLICITUD
    final int INT_TBL_CODCLI=3;                    // CODIGO CLIENTE
    final int INT_TBL_NOMCLI=4;                    // NOMBRE DEL CLIENTE
    ...
    public ZafConItm_09(java.awt.Frame parent, boolean modal, java.util.ArrayList vector , ZafParSis obj,  javax.swing.JDesktopPane dskGe, String strTit) {  //(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
         objParSis=obj;
        initComponents();
         arlDat=vector;
    ...
    private boolean configurarFrm()
    {
        ...
        try
        {
            ...
            vecCab.add(INT_TBL_NUMSOL,"Num.Sol.");
            ...
            tcmAux.getColumn(INT_TBL_NUMSOL).setPreferredWidth(60);
...
private void cargarDatos(){
 ...
 for(int i=0; i<arlDat.size(); i++){
        ...
        vecReg.add(INT_TBL_NUMFAC, objUti.getStringValueAt(arlDat, i, 0) );
        vecReg.add(INT_TBL_NUMSOL, objUti.getStringValueAt(arlDat, i, 1) );
        vecReg.add(INT_TBL_CODCLI, objUti.getStringValueAt(arlDat, i, 2) );
