/*
 * ZafTreeCellRenderer.java
 *
 * Created on 13 de enero de 2006, 13:00
 */
 ...
 * @author  jsalazar
 */
public class ZafTreeCellRenderer extends JLabel implements TreeCellRenderer{
    ...
    // Colors
    protected Color textColorNegativo = Color.red;
    protected Color textColorPositivo = Color.blue;
	...
	if(sel)
        ...
        Librerias.ZafUtil.ZafUtil objUti = new Librerias.ZafUtil.ZafUtil();
            if (objUti.isNumero(value.toString())){
