...
package Librerias.ZafTblUti.ZafTblCelEdiTxtVco;
 ...
 * @author  Eddye Lino
 */
public class ZafTblCelEdiTxtVco extends javax.swing.JTextField implements javax.swing.table.TableCellEditor
{
    //Constantes:
    ...
    private boolean blnMosVenCon=true;         //Determina si la ventana de consulta debe mostrarse
     ...
     */
    public ZafTblCelEdiTxtVco(javax.swing.JTable tabla, ZafVenCon ventana, int[] columnasVentana, int[] columnasTabla)
    {
        tblDat=tabla;
        vcoGen=ventana;
