/*
 * ZafTblCelEdiTxtCon.java
 *
 * Created on 10 de septiembre de 2005, 20:44 PM
 */

package Librerias.ZafTblUti.ZafTblCelEdiTxtCon;
 ...
 * <BR>"objTblCelEdiTxtCon" es la instancia de "ZafTblCelEdiTxtCon".
 * <PRE>
 ...
 *                   objTblCelEdiTxtCon.setCondicionesSQL(" AND a1.tx_desLar LIKE '" + strAux + "%'");
 *               }
 ...
 * @author  Eddye Lino
 */
public class ZafTblCelEdiTxtCon extends javax.swing.JTextField implements javax.swing.table.TableCellEditor
{
    //Constantes:
    ...
    private String strTit, strCon, strUsr, strCla, strSQL, strCam, strAli, strCriBus, strConSQL;
    private int intTipBus, intCamBus;           //Indice de Tipo de búsqueda y Campo de búsqueda.
    private int intColVen[], intColTbl[], intTipCam;
    ...
    /** 
     * Crea una nueva instancia de la clase ZafTblCelEdiTxtCon.
     ...
     */
    public ZafTblCelEdiTxtCon(String titulo, javax.swing.JTable tabla, String stringConexion, String usuario, String clave, String sentenciaSQL, String campos, String alias, int[] columnasVentana, int[] columnasTabla)
    {
        strTit=titulo;
        tblDat=tabla;
    ...
    private void mostrarVenCon()
    {
        ...
        objVenCon=new Librerias.ZafConsulta.ZafConsulta(javax.swing.JOptionPane.getFrameForComponent(this), strAli, strCam, strSQL + strConSQL, this.getText(), strCon, strUsr, strCla);
        objVenCon.setTitle(strTit);
        //Inicializar la variable que almacena si se aceptó/canceló la consulta.
        blnConAce=true;
        //Buscar campo en la base de datos.
        if (objVenCon.buscar(strCriBus + ((intTipCam==INT_CAM_NUM)?"=" + this.getText():"='" + this.getText() + "'")))
        {
            int i, intFilSel;
        ...
        {
            objVenCon.setSelectedTipBus(intTipBus);
            objVenCon.setSelectedCamBus(intCamBus);
            objVenCon.show();
            if (objVenCon.acepto())
            {
                int i, intFilSel;
    ...
    /**
     * Esta función obtiene el campo por el cual se va a efectuar la búsqueda.
     * El campo de búsqueda es una condición adicional que se agrega a la sentencia
     * SQL ingresada previamente.
     * <BR>Por ejemplo:
     * <CENTER>
     * <TABLE BORDER=1>
     *     <TR><TD><I>Campo</I></TD></TR>
     *     <TR><TD>co_itm</TD></TR>
     *     <TR><TD>tx_codAlt</TD></TR>
     *     <TR><TD>a2.tx_codAlt</TD></TR>
     * </TABLE>
     * </CENTER>
     * @return El campo por el cual se va a efectuar la búsqueda.
     */
    ...
    /**
     * Esta función establece el campo por el cual se va a efectuar la búsqueda.
     * El campo de búsqueda es una condición adicional que se agrega a la sentencia
     * SQL ingresada previamente.
     * <BR>Por ejemplo:
     * <CENTER>
     * <TABLE BORDER=1>
     *     <TR><TD><I>Campo</I></TD><TD><I>Tipo de campo</I></TD><TD><I>Conclusión</I></TD></TR>
     *     <TR><TD>co_itm</TD><TD>INT_CAM_NUM</TD><TD>AND co_itm=...</TD></TR>
     *     <TR><TD>tx_codAlt</TD><TD>INT_CAM_STR</TD><TD>AND tx_codAlt='...'</TD></TR>
     *     <TR><TD>a2.tx_codAlt</TD><TD>INT_CAM_STR</TD><TD>AND a2.tx_codAlt='...'</TD></TR>
     * </TABLE>
     * </CENTER>
     * <BR>Nota.- Los "..." representan lo que el usuario ha digitado en la celda.
     * @param campo El campo por el cual se va a efectuar la búsqueda.
     * @param tipoCampo El tipo de campo. Puede tomar los siguientes valores:
     * <UL>
     * <LI>0: Campo numérico (INT_CAM_NUM).
     * <LI>1: Campo cadena (INT_CAM_STR).
     * </UL>
     */
    public void setCampoBusqueda(String campo, int tipoCampo)
    {
        strCriBus=campo;
        intTipCam=tipoCampo;
    }
     ...
     * Indica lo que aparece seleccionado en el JComboBox "Campo" de ZafConsulta.
     * <BR>Puede devolver uno de los siguientes valores:
     * <CENTER>
     * <TABLE BORDER=1>
     *     <TR><TD><I>Indice</I></TD><TD><I>Campo</I></TD></TR>
     *     <TR><TD>0</TD><TD>Campo1</TD></TR>
     *     <TR><TD>1</TD><TD>Campo2</TD></TR>
     *     <TR><TD>2</TD><TD>Campo3</TD></TR>
     * </TABLE>
     * </CENTER>
     * @return El indice del campo por el cual se va a efectuar la búsqueda.
     */
    public int getIndiceCampoBusqueda()
    {
        return intCamBus;
    }
     ...
     * Sirve para indicar lo que debe aparecer seleccionado en el JComboBox de ZafConsulta.
     ...
     * </TABLE>
     * </CENTER>
     * @param campoBusqueda El indice del campo por el cual se va a efectuar la búsqueda.
     */
    public void setIndiceCampoBusqueda(int campoBusqueda)
    {
        intCamBus=campoBusqueda;
    }
    
    /**
     * Esta función obtiene el indice del Tipo de búsqueda a efectuar.
     * Indica lo que aparece seleccionado en el JComboBox "Tipo de búsqueda" de ZafConsulta.
     * <BR>Puede devolver uno de los siguientes valores:
     * <CENTER>
     * <TABLE BORDER=1>
     *     <TR><TD><I>Indice</I></TD><TD><I>Campo</I></TD></TR>
     *     <TR><TD>0</TD><TD>Contengan</TD></TR>
     *     <TR><TD>1</TD><TD>Directa</TD></TR>
     *     <TR><TD>2</TD><TD>Comienzan con</TD></TR>
     *     <TR><TD>3</TD><TD>No comienzan con</TD></TR>
     *     <TR><TD>4</TD><TD>Terminan con</TD></TR>
     *     <TR><TD>5</TD><TD>No terminan con</TD></TR>
     * </TABLE>
     * </CENTER>
     * @return El indice del tipo de búsqueda por el cual se va a efectuar la búsqueda.
     */
    public int getIndiceTipoBusqueda()
    {
        return intTipBus;
    }
    
    /**
     * Esta función establece el indice del Tipo de búsqueda a efectuar.
     * Indica lo que aparece seleccionado en el JComboBox "Tipo de búsqueda" de ZafConsulta.
     * <BR>Puede recibir uno de los siguientes valores:
     * <CENTER>
     * <TABLE BORDER=1>
     ...
     * </TABLE>
     * </CENTER>
     * @param tipoBusqueda El tipo de búsqueda por el cual se va a efectuar la búsqueda.
     */
    public void setIndiceTipoBusqueda(int tipoBusqueda)
    {
        intTipBus=tipoBusqueda;
    }
