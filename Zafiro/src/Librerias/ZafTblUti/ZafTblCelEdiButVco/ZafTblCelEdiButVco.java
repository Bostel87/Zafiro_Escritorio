/*
 * ZafTblCelEdiButVco.java
 *
 * Created on 09 de abril de 2006, 08:47 AM
 * v0.3        Modificado por Ingrid Lino  12/Sep/2017
 */

package Librerias.ZafTblUti.ZafTblCelEdiButVco;
 ...
 * <BR>"objTblCelEdiButVco" es la instancia de "ZafTblCelEdiButVco".
 * <PRE>
 ...
 * @author  Eddye Lino
 */
public class ZafTblCelEdiButVco extends javax.swing.JButton implements javax.swing.table.TableCellEditor
{
    //Constantes:
    ...
    private boolean blnMosVenCon=true;
     ...
     */
    public ZafTblCelEdiButVco(javax.swing.JTable tabla, ZafVenCon ventana, int[] columnasVentana, int[] columnasTabla)
    {
        super("...");
        tblDat=tabla;
        vcoGen=ventana;
    ...
    private void mostrarVenCon()
    {
        ...
        if(blnMosVenCon)
            vcoGen.setVisible(true);        
        else
            vcoGen.setVisible(false);
    ...
    public boolean isMosVenCon() {
        return blnMosVenCon;
    }

    public void setMosVenCon(boolean blnMosVenCon) {
        this.blnMosVenCon = blnMosVenCon;
    }
