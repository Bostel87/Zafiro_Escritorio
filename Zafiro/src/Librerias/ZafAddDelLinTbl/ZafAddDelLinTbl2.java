...
public class ZafAddDelLinTbl2 {
     ...
     */    
    public ZafAddDelLinTbl2(javax.swing.JTable objTbl) {
        this.objTbl = objTbl;
        setListeners();
    }
    /**
     ...
     */    
    public ZafAddDelLinTbl2(javax.swing.JTable objTbl, int[] intColNoSeleccion, int NumLineas) {
        this.objTbl = objTbl;
                ...
                if (tecla == 27){
                 ...
                 //Convierto el ENTER en un TAB para que el foco pase a la siguiente celda de la misma fila y no a la siguiente celda de la misma columna.
                    ...
                    if (((tblAddDelLin.getRowCount() - 1) == tblAddDelLin.getSelectedRow())){
                        if( (tblAddDelLin.getSelectedRow()+1) <  NumLineas  ){
