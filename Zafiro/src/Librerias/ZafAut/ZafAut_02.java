 ...
 * @author  Eddye Lino
 */
public class ZafAut_02 extends javax.swing.JDialog
{
     ...
     * </UL>
     */
    public ZafAut_02(java.util.ArrayList parametros)
    {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        txtMonCre.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        panGenCab.add(txtMonCre);
        txtMonCre.setBounds(100, 4, 100, 20);

        lblMonCre.setText("Monto de cr\u00e9dito:");
        lblMonCre.setToolTipText("Monto de cr\u00e9dito");
        panGenCab.add(lblMonCre);
        lblMonCre.setBounds(0, 4, 100, 20);
    ...
    private boolean configurarFrm()
    {
        ...
        try
        {
            //Inicializar objetos.
            objUti=new ZafUtil();
            strAux="Listado de documentos pendientes";
            this.setTitle(strAux + " v0.6");
            lblTit.setText(strAux);
            //Configurar objetos.
            txtMonCre.setEditable(false);
    ...
    private boolean cargarDetReg()
    {
        ...
        try
        {
            ...
            if (con!=null)
            {
                ...
                if (rst.next())
                {
                    txtMonCre.setText("" + rst.getDouble("nd_monCre"));
                }
                else
                {
                    txtMonCre.setText("0");
