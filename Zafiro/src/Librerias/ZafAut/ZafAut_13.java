 ...
 * ZafAut_11.java
 *
 * Created on 04 de diciembre de 2013, 02:35 PM
 */
 ...
 * @author  Eddye Lino
 */
public class ZafAut_13 extends javax.swing.JDialog
{
    //Constantes: Columnas del JTable:
    static final int INT_TBL_DAT_LIN=0;                         //Línea
    static final int INT_TBL_DAT_COD_EMP=1;                     //Código de la empresa.
    static final int INT_TBL_DAT_COD_BOD=2;                     //Código de la bodega.
    static final int INT_TBL_DAT_NOM_BOD=3;                     //Nombre de la bodega.
    static final int INT_TBL_DAT_COD_ITM=4;                     //Código del item.
    static final int INT_TBL_DAT_COD_ALT=5;                     //Código alterno.
    static final int INT_TBL_DAT_NOM_ITM=6;                     //Nombre del item.
    static final int INT_TBL_DAT_CAN=7;                         //Cantidad.
    static final int INT_TBL_DAT_CHK_AUT=8;                     //Necesita autorización.
    //Variables
     ...
     * </UL>
     */
    public ZafAut_13(java.util.ArrayList parametros)
    {
    ...
    private boolean configurarFrm()
    {
        ...
        try
        {
            //Inicializar objetos.
            objUti=new ZafUtil();
            strAux="Pedidos a otras bodegas";
...
//            txtForPagSol.setEditable(false);
    ...
    private boolean configurarTblDat()
    {
        ...
        try
        {
            ...
            vecCab.add(INT_TBL_DAT_CHK_AUT,"Nec.Aut.");
            ...
            tcmAux.getColumn(INT_TBL_DAT_NOM_ITM).setPreferredWidth(235);
    ...
    private boolean cargarDetReg()
    {
        ...
        try
        {
            ...
            if (con!=null)
            {
                ...
                strSQL="";
                strSQL+="SELECT a1.co_empRel, a1.co_bodRel, a2.tx_nom AS a2_tx_nom, a1.co_itmRel, a3.tx_codAlt, a3.tx_nomItm, a1.nd_can, a1.st_necAut";
                strSQL+=" FROM tbm_pedOtrBodCotVen AS a1";
                strSQL+=" INNER JOIN tbm_bod AS a2 ON (a1.co_empRel=a2.co_emp AND a1.co_bodRel=a2.co_bod)";
                strSQL+=" INNER JOIN tbm_inv AS a3 ON (a1.co_empRel=a3.co_emp AND a1.co_itmRel=a3.co_itm)";
                ...
                while (rst.next())
                {
                    if (blnCon)
                    {
                        ...
                        vecReg.add(INT_TBL_DAT_COD_EMP,rst.getString("co_empRel"));
                        vecReg.add(INT_TBL_DAT_COD_BOD,rst.getString("co_bodRel"));
                        vecReg.add(INT_TBL_DAT_NOM_BOD,rst.getString("a2_tx_nom"));
                        vecReg.add(INT_TBL_DAT_COD_ITM,rst.getString("co_itmRel"));
                        ...
                        strAux=rst.getString("st_necAut");
                        if (strAux==null)
