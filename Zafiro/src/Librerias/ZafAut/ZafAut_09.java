 ...
 * @author  Eddye Lino
 */
public class ZafAut_09 extends javax.swing.JDialog
{
    ...
    static final int INT_TBL_DAT_CHK_TAT=5;                     //Estado de Transferencia automática total.
    static final int INT_TBL_DAT_STK_LOC=6;                     //Stock del local.
    static final int INT_TBL_DAT_STK_BOD_CEN=7;                 //Stock de la bodega central.
    //Variables
     ...
     * </UL>
     */
    public ZafAut_09(java.util.ArrayList parametros)
    {
    ...
    private boolean configurarFrm()
    {
        ...
        try
        {
            //Inicializar objetos.
            objUti=new ZafUtil();
            strAux="Transferencias automáticas totales";
...
//            txtForPagSol.setEditable(false);
    ...
    private boolean configurarTblDat()
    {
        ...
        try
        {
            ...
            vecCab.add(INT_TBL_DAT_CHK_TAT,"Tra.Aut.Tot.");
            vecCab.add(INT_TBL_DAT_STK_LOC,"Stock");
            vecCab.add(INT_TBL_DAT_STK_BOD_CEN,"Stk.Bod.Cen.");
            ...
            tcmAux.getColumn(INT_TBL_DAT_NOM_ITM).setPreferredWidth(188);
            tcmAux.getColumn(INT_TBL_DAT_CAN).setPreferredWidth(60);
            tcmAux.getColumn(INT_TBL_DAT_CHK_TAT).setPreferredWidth(70);
            tcmAux.getColumn(INT_TBL_DAT_STK_LOC).setPreferredWidth(80);
            tcmAux.getColumn(INT_TBL_DAT_STK_BOD_CEN).setPreferredWidth(80);
...
//            objTblEdi=new ZafTblEdi(tblDat);
            ...
            tcmAux.getColumn(INT_TBL_DAT_STK_LOC).setCellRenderer(objTblCelRenLbl);
            tcmAux.getColumn(INT_TBL_DAT_STK_BOD_CEN).setCellRenderer(objTblCelRenLbl);
            objTblCelRenLbl=null;
            
            objTblCelRenChk=new ZafTblCelRenChk();
            tcmAux.getColumn(INT_TBL_DAT_CHK_TAT).setCellRenderer(objTblCelRenChk);
    ...
    private boolean cargarDetReg()
    {
        ...
        try
        {
            ...
            if (con!=null)
            {
                ...
                strSQL="";
                strSQL+="SELECT d2.co_itm, d2.tx_codAlt, d2.tx_nomItm, d2.nd_can, d2.st_traAutTot, d1.nd_stkAct, d3.nd_stkAct AS nd_stkBodCen";
                strSQL+=" FROM (";
                ...
                strSQL+=" INNER JOIN tbr_bodEmp AS a3 ON (a2.co_emp=a3.co_empPer AND a2.co_bod=a3.co_bodPer)";
                ...
                strSQL+=" ) AS d1 INNER JOIN (";
                strSQL+=" SELECT b2.co_itmMae, b1.co_itm, b1.tx_codAlt, b1.tx_nomItm, b4.co_reg, b4.nd_can, b4.st_traAutTot";
                strSQL+=" FROM tbm_inv AS b1";
                strSQL+=" INNER JOIN tbm_equInv AS b2 ON (b1.co_emp=b2.co_emp AND b1.co_itm=b2.co_itm)";
                strSQL+=" LEFT OUTER JOIN tbm_detCotVen AS b4 ON (b1.co_emp=b4.co_emp AND b1.co_itm=b4.co_itm)";
                strSQL+=" WHERE b4.co_emp=" + intCodEmp;
                strSQL+=" AND b4.co_loc=" + intCodLoc;
                strSQL+=" AND b4.co_cot=" + intCodDoc;
                strSQL+=" AND b1.st_reg='A'";
                strSQL+=" ) AS d2 ON (d1.co_itmMae=d2.co_itmMae)";
                strSQL+=" INNER JOIN (";
                strSQL+=" SELECT c1.co_itmMae, SUM(c2.nd_stkAct) AS nd_stkAct";
                strSQL+=" FROM tbm_equInv AS c1";
                strSQL+=" INNER JOIN tbm_invBod AS c2 ON (c1.co_emp=c2.co_emp AND c1.co_itm=c2.co_itm)";
                strSQL+=" INNER JOIN tbr_bodEmp AS c3 ON (c2.co_emp=c3.co_empPer AND c2.co_bod=c3.co_bodPer)";
                strSQL+=" INNER JOIN tbm_inv AS c4 ON (c1.co_emp=c4.co_emp AND c1.co_itm=c4.co_itm)";
                strSQL+=" WHERE c3.co_emp=1";
                strSQL+=" AND c3.co_loc=1";
                strSQL+=" AND c4.st_reg='A'";
                strSQL+=" GROUP BY c1.co_itmMae";
                strSQL+=" ) AS d3 ON (d1.co_itmMae=d3.co_itmMae)";
                strSQL+=" WHERE d1.co_itmMae IS NOT NULL";
                strSQL+=" ORDER BY d2.co_reg";
                ...
                while (rst.next())
                {
                    if (blnCon)
                    {
                        ...
                        if (rst.getString("st_traAutTot").equals("S"))
                            vecReg.add(INT_TBL_DAT_CHK_TAT,new Boolean(true));
                        else
                            vecReg.add(INT_TBL_DAT_CHK_TAT,new Boolean(false));
                        vecReg.add(INT_TBL_DAT_STK_LOC,rst.getString("nd_stkAct"));
                        vecReg.add(INT_TBL_DAT_STK_BOD_CEN,rst.getString("nd_stkBodCen"));
                        vecDat.add(vecReg);
                    }
                    else
                    {
        ...
        public void mouseMoved(java.awt.event.MouseEvent evt)
        {
            ...
            switch (intCol)
            {
                ...
                case INT_TBL_DAT_CAN:
                    strMsg="Cantidad";
                    break;
                case INT_TBL_DAT_CHK_TAT:
                    strMsg="Transferencias automáticas totales";
                    break;
                case INT_TBL_DAT_STK_LOC:
                    strMsg="Stock del local";
                    break;
                case INT_TBL_DAT_STK_BOD_CEN:
                    strMsg="Stock de la bodega central";
                    break;
                default:
                    strMsg="";
                    break;
