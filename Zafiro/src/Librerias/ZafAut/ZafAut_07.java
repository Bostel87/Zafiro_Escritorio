 ...
 * ZafAut_03.java
 *
 * Created on 29 de marzo de 2006, 11:33 AM
 */
 ...
 * @author  Eddye Lino
 */
public class ZafAut_07 extends javax.swing.JDialog
{
    ...
    /**
     * Este constructor crea una instancia de la clase ZafAut_02.
     ...
     * </UL>
     */
    public ZafAut_07(java.util.ArrayList parametros)
    {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        txtDiaGra = new javax.swing.JTextField();
        lblDiaGra = new javax.swing.JLabel();
        ...
        txtDiaGra.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        panGenCab.add(txtDiaGra);
        txtDiaGra.setBounds(100, 4, 100, 20);

        lblDiaGra.setText("D\u00edas de gracia:");
        lblDiaGra.setToolTipText("D\u00edas de gracia");
        panGenCab.add(lblDiaGra);
        lblDiaGra.setBounds(0, 4, 100, 20);
    ...
    private javax.swing.JLabel lblDiaGra;
    ...
    private javax.swing.JTextField txtDiaGra;
    ...
    private boolean configurarFrm()
    {
        ...
        try
        {
            //Inicializar objetos.
            objUti=new ZafUtil();
            strAux="Listado de documentos sin soporte";
            this.setTitle(strAux + " v0.2");
            lblTit.setText(strAux);
            //Configurar objetos.
            txtDiaGra.setEditable(false);
    ...
    private boolean cargarDetReg()
    {
        ...
        try
        {
            ...
            if (con!=null)
            {
                ...
                strSQL="";
                strSQL+="SELECT a1.ne_diaGraChqFec";
                ...
                if (rst.next())
                {
                    txtDiaGra.setText("" + rst.getInt("ne_diaGraChqFec"));
                }
                else
                {
                    txtDiaGra.setText("0");
                ...
                strSQL+=" AND a2.st_sop='S' AND a2.st_entSop='N'";
