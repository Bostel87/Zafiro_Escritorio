 ...
 *Ver 2.0
 */
public class ZafPopupMenu2 extends javax.swing.JPopupMenu{
     ...
     */
    public ZafPopupMenu2(javax.swing.JTable Obj, int NumLineas) {
        ObjTbl = Obj;
...
//        Arbolito.addElement(new Boolean(true));
     ...
     //  System.out.println("==>  "+NumLineas);
          if( ObjTbl.getRowCount() <  NumLineas  )
...
*/
class PortaPapelAdapter2 implements ActionListener
   {
...
public PortaPapelAdapter2(JTable myJTable)
   {
      jTable1 = myJTable;
