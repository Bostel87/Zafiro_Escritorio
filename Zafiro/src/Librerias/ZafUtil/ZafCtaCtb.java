...
public class ZafCtaCtb {
        ...
        private int intCtaSerCompras;  //Iva en COMPRAS
        ...
        private String strNumCtaSerCom;
        private String strNomCtaSerCom;
       
        private int intCtaCompras;  // Descuento en Ventas
        private String strNumCtaCom;
        private String strNomCtaCom;

        public String strVersion= "v 0.02";  //JM  18/Oct/2016    
        
        
    /** Creates a new instance of ZafCtaCtb */
    public ZafCtaCtb(Librerias.ZafParSis.ZafParSis obj,int intCodTipDoc)
    {
      try{
               isEmpty = true;
     ...
     * @param intCodTipDoc 
     */
     public ZafCtaCtb(Librerias.ZafParSis.ZafParSis obj,int incCodEmp, int intCodLoc,int intCodTipDoc)
    {
      try{
               isEmpty = true;
               objZafParSis  = (Librerias.ZafParSis.ZafParSis) obj.clone();
               CodEmpresa = incCodEmp;
               CodLocal   = intCodLoc;
               objUti = new ZafUtil();
               vecCtaExi = new java.util.Vector();
               cargarCtasEmpLoc();
    ...
    public ZafCtaCtb(Librerias.ZafParSis.ZafParSis obj,int intCodTipDoc,String intdevcom)
    {
      try{
               isEmpty = true;
               objZafParSis  = (Librerias.ZafParSis.ZafParSis) obj.clone();
               ...
               cargarCtasEmpLoc();
               cargarCtasBodega();
               cargarCtasEmpDevCom(intCodTipDoc);
      ...
      public ZafCtaCtb(Librerias.ZafParSis.ZafParSis obj)
    {
      try{
               isEmpty = true;
               objZafParSis  = (Librerias.ZafParSis.ZafParSis) obj.clone();
     ...
     */
    public ZafCtaCtb(Librerias.ZafParSis.ZafParSis obj, int Empresa, int Local){
      try{
               isEmpty = true;
               objZafParSis  = (Librerias.ZafParSis.ZafParSis) obj.clone();
               CodEmpresa = Empresa;
     ...
     public void cargarCtasEmp(int intCodTipDoc){
    ...
    public void cargarCtasBodega(){
       ...
       strSQL += " where emp.co_emp = " + CodEmpresa + "  and bod.st_reg='A' ";
      //and loc.co_loc = " + CodLocal + "
    ...
    public void cargarCtasEmpLoc(){
       ...
       try{
           ...
           strSQL = "";
           strSQL = " Select emp.co_ctaivacom,co_ctaivaven,co_ctaban,co_ctacaj,co_ctares,co_ctagas,co_ctaretftecom,co_ctaretfteven,co_ctaretivacom,co_ctaretivaven,co_ctadescom,co_ctadesven,co_ctacosven,nd_ivacom,nd_ivaven, pla.tx_codcta,pla.tx_deslar " +
           "   ,emp.co_ctacomser ,  emp.co_ctavenser  ,pla1.tx_codcta as CodCtaSerCom ,pla1.tx_deslar as NomCtaSerCom " +
           " ,pla2.tx_codcta as CodCtaSerVen ,pla2.tx_deslar as NomCtaSerVen  " +
           " FROM  tbm_emp as emp left outer join tbm_loc as loc on (emp.co_emp  = loc.co_emp) ";
           strSQL += " inner join tbm_placta as pla on (emp.co_emp=pla.co_emp and  emp.co_ctaivacom=pla.co_cta)";
           strSQL += " LEFT join tbm_placta as pla1 on (emp.co_emp=pla1.co_emp and  emp.co_ctacomser=pla1.co_cta) ";
           strSQL += " LEFT join tbm_placta as pla2 on (emp.co_emp=pla2.co_emp and  emp.co_ctavenser=pla2.co_cta)  ";
           ...
           while (rst.next())
           {
               ...
               intCtaSerCompras = (rst.getString("co_ctacomser")==null?0:rst.getInt("co_ctacomser"));
               ...
               strNumCtaSerCom = (rst.getString("CodCtaSerCom")==null?"":rst.getString("CodCtaSerCom"));
               strNomCtaSerCom = (rst.getString("NomCtaSerCom")==null?"":rst.getString("NomCtaSerCom"));
    ...
    ///*****************************************************PARA OBTENER NUMERO Y NOMBRE DE LA CUENTA 
       ...
       public String getNumCtaSerCom(){
            return (isEmpty)?"":strNumCtaSerCom;
        }
    
        public String getNomCtaSerCom(){
            return (isEmpty)?"":strNomCtaSerCom;
        }
    ...
    //********************************************************************************************
         ...
         public int getCtaSerCompras(){
           //System.out.println(">>>>> "+isEmpty + " >>** " + intCtaIvaCompras );
            return (isEmpty)?-1:intCtaSerCompras;
        }
