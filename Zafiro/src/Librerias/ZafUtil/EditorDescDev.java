 ...
 * @version 3.0
 */
public abstract class EditorDescDev extends javax.swing.JTextField implements javax.swing.table.TableCellEditor, Librerias.ZafUtil.ActionToDo
{
    ...
    public EditorDescDev(int intColEditar, int intColNext, int intColCodItm, javax.swing.JTable tabla, Librerias.ZafParSis.ZafParSis objZafParSis)
    {
...
//            int intBodActual = Integer.parseInt( (tblDat.getValueAt(tblDat.getSelectedRow(), intColBodega)==null || tblDat.getValueAt(tblDat.getSelectedRow(), intColBodega).toString().equals(""))?"0":tblDat.getValueAt(tblDat.getSelectedRow(), intColBodega).toString());
            ...
            if(!objZafTipItm.isServicio( intCodItmAct)){      
                double dblCant     = Double.parseDouble(this.getText());
...
//                System.out.println("Valor solicitado " + dblValSolicitado );  
                ...
                double dblCantFac = 100; // Double.parseDouble(tblDat.getValueAt(tblDat.getSelectedRow(),15).toString());
                if(dblCant>=0&&dblCant<=dblCantFac){
