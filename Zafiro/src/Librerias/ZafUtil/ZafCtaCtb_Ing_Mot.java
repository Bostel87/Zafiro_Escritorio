 ...
 */  
public class ZafCtaCtb_Ing_Mot {
         /*
        ...
        private String StrCtaIvaCompras="";
       
        private int intCtaCompras;  // Descuento en Ventas
        private String StrCtaCompras;  // Descuento en Ventas
    ...
    public ZafCtaCtb_Ing_Mot(Librerias.ZafParSis.ZafParSis obj,int intCodTipDoc, String tipCta)
    {
      try{
               isEmpty = true;
      ...
      public ZafCtaCtb_Ing_Mot(Librerias.ZafParSis.ZafParSis obj)
    {
      try{
               isEmpty = true;
               objZafParSis  = (Librerias.ZafParSis.ZafParSis) obj.clone();
     ...
     */
    public ZafCtaCtb_Ing_Mot(Librerias.ZafParSis.ZafParSis obj, int Empresa, int Local){
      try{
               isEmpty = true;
               objZafParSis  = (Librerias.ZafParSis.ZafParSis) obj.clone();
               CodEmpresa = Empresa;
         ...
         String sql = "SELECT a.co_ctahab ,b.tx_codcta,b.tx_deslar FROM tbm_cabtipdoc as a" +
          ...
          System.out.println(" CONEXION A BASE 22 " + sql );
            ...
            while (rst.next())
            {
              ...
              StrCtaCompras = (rst.getString("co_ctahab")==null?"":rst.getString("co_ctahab"));
         ...
         String sql = "SELECT a.co_ctadeb ,b.tx_codcta,b.tx_deslar FROM tbm_cabtipdoc as a" +
           ...
           System.out.println(" CONEXION A BASE 22 " + sql );
            ...
            while (rst.next())
            {
              ...
              StrCtaCompras = (rst.getString("co_ctadeb")==null?"":rst.getString("co_ctadeb"));
              strNumCtaCom =  (rst.getString("tx_codcta")==null?"":rst.getString("tx_codcta"));
              strNomCtaCom =  (rst.getString("tx_deslar")==null?"":rst.getString("tx_deslar"));
              isEmpty2 = false;
            }
    ...
    public void cargarCtasEmpLoc(){
       ...
       try{
           ...
           while (rst.next())
           {
               ...
               StrCtaIvaCompras = (rst.getString("co_ctaivacom")==null?"":rst.getString("co_ctaivacom"));
    ...
    //********************************************************************************************
        ...
        public String getCuentaIvaCompras(){
           return (isEmpty)?"":StrCtaIvaCompras;
        }
        ...
        public int getCtaExistencia(int intCodBod){
         ...
         public String getCuentaExistencia(int intCodBod){
            for (int i=0;i<vecCtaExi.size();i++)
            {
                if (intCodBod==Integer.parseInt((((java.util.Vector)vecCtaExi.get(i)).get(INT_CODBOD).toString())))
                {
                    return  ((java.util.Vector)vecCtaExi.get(i)).get(INT_CTABOD).toString();
                }
            }
            return "";
        }
