 ...
 * @version 3.0
 */
public abstract class EditorCanDev extends javax.swing.JTextField implements javax.swing.table.TableCellEditor, Librerias.ZafUtil.ActionToDo
{
    ...
    public EditorCanDev(int intColEditar, int intColNext, int intColCodItm, javax.swing.JTable tabla, Librerias.ZafParSis.ZafParSis objZafParSis)
    {
...
//                System.out.println("Valor solicitado " + dblValSolicitado );
                ...
                double dblCantFac = Double.parseDouble(tblDat.getValueAt(tblDat.getSelectedRow(),5).toString());
