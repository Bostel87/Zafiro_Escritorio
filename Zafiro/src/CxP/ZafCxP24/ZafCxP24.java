 ...
 * @author sistemas9
 */
public class ZafCxP24 extends javax.swing.JInternalFrame
{
    //Constantes
    ...
    public String strVer=" v0.1.24 ";
	
    /** Crea una nueva instancia de la clase ZafCxP24. */
    public ZafCxP24(ZafParSis obj)
    {
        try{
            strCtaPadExi="";
    ...
    public ZafCxP24(ZafParSis obj, Integer codigoCuenta){
        try{
            strCtaPadExi="";
            objParSis=(ZafParSis)obj.clone();
    ...
    /** Crea una nueva instancia de la clase ZafCxP24. */
    public ZafCxP24(ZafParSis obj, int codigoEmpresa, int codigoLocal, int codigoTipoDocumento, int codigoDocumento, int codigoMenu)
    {
        try{
            objParSis=(ZafParSis)obj.clone();
            objUti=new ZafUtil();
    ...
    public ZafCxP24(ZafParSis obj, int codigoEmpresaBancaria, String existePadreGrupo, String codigoCuenta, String numeroCuenta, String nombreCuenta, BigDecimal valorTransferencia){
        try{
            objParSis=(ZafParSis)obj.clone();
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        if(objParSis.getCodigoEmpresa()==objParSis.getCodigoEmpresaGrupo()) {
            ZafCxP24_01 objCon64_01=new ZafCxP24_01(objParSis);
