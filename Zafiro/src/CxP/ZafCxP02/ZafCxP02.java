 ...
 * @author  ilino
 */
public class ZafCxP02 extends javax.swing.JInternalFrame {
    ...
    private ZafCxP02.ZafTblModLis objTblModLis;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblCta.setBounds(4, 26, 70, 15);

        txtDesCorCta.setMaximumSize(null);
        txtDesCorCta.setPreferredSize(new java.awt.Dimension(70, 20));
        ...
        txtDesCorCta.setBounds(128, 25, 66, 20);
        ...
        txtNomCta.setBounds(194, 25, 170, 20);

        butCta.setFont(new java.awt.Font("SansSerif", 1, 12));
        butCta.setText("...");
        ...
        lblCodDoc.setBounds(4, 70, 130, 15);
        ...
        lblMonDoc.setBounds(4, 92, 130, 15);
        ...
        txtNomPro.setBounds(194, 46, 170, 20);
        ...
        txtCodPro.setBounds(128, 46, 66, 20);
        ...
        txtCodCta.setBounds(100, 24, 0, 0);
...
//    }
    ...
    private boolean configurarFrm() {
        ...
        try {
            ...
            lblTit.setText("Pago Individual a Proveedores... V.2");
            ...
            vecCab.add(INT_TBL_DAT_DIA_CRE,"Días Cre.");
            vecCab.add(INT_TBL_DAT_FEC_VEN,"Fec. Venc.");
            ...
            //tblValPnd.getColumnModel().getColumn(INT_TBL_DAT_AUX_ABO).setPreferredWidth(100);
            //tblValPnd.getColumnModel().getColumn(INT_TBL_DAT_COD_DOC).setPreferredWidth(100);
            ...
            tblValPnd.getColumnModel().getColumn(INT_TBL_DAT_POR_RET).setWidth(0);
            tblValPnd.getColumnModel().getColumn(INT_TBL_DAT_POR_RET).setMaxWidth(0);
            tblValPnd.getColumnModel().getColumn(INT_TBL_DAT_POR_RET).setMinWidth(0);
            tblValPnd.getColumnModel().getColumn(INT_TBL_DAT_POR_RET).setPreferredWidth(0);
            tblValPnd.getColumnModel().getColumn(INT_TBL_DAT_POR_RET).setResizable(false);            
            ...
            objTblCelEdiChk.addTableEditorListener(new Librerias.ZafTblUti.ZafTblEvt.ZafTableAdapter() {
                ...
                public void afterEdit(Librerias.ZafTblUti.ZafTblEvt.ZafTableEvent evt) {
                                ...
                                calcularAboTot();
                                //System.out.println("la ubicacion de la cta en CxP02 es:" +strUbiCta);//strUbiCta
                                //objAsiDia.generarDiario(txtCodTipDoc.getText(), txtCodCta.getText(), txtMonDoc.getText(), txtMonDoc.getText());                                
                                objAsiDia.generarDiario(txtCodTipDoc.getText(), txtCodCta.getText(), strNatCta(), txtMonDoc.getText(), INT_POR_RET, STR_COD_CTA_POR_RET);
                            }
                });
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
                objTblModLis=new ZafCxP02.ZafTblModLis();
        ...
        try
        {
            ...
            if (con!=null)
            {
                ...
                while (rst.next())
                {
                    ...
                    vecReg.add(INT_TBL_DAT_FEC_VEN, objUti.formatearFecha(rst.getDate("fe_ven"), "dd-MM-yyyy"));
            ...
            if (!txtCodPro.getText().equals(""))
            {
                ...
                if (con!=null)
                {
                    ...
                    if (objTooBar.getEstado()=='x' || objTooBar.getEstado()=='m')
                    {
                        ...
                        strSQL+=" a2.nd_porret, a2.mo_pag, a2.co_reg, a4.nd_abo as aboDoc, a2.co_loc, a2.co_doc as codDoc, (a2.mo_pag+a2.nd_abo) as valPnd, a4.nd_abo";
                        ...
                        System.out.println("en cargarDetReg--modficar:"+strSQL);
                    }
                    else
                    {
    ...
    */
    ...
    private boolean regenerarDiario()
    {
        ...
        else
        {
            ...
            if(txtMonDoc.getText().toString().length()==0){
                txtMonDoc.setText("0");
            }
                objAsiDia.generarDiario(txtCodTipDoc.getText(), txtCodCta.getText(), strNatCta(), txtMonDoc.getText(), INT_POR_RET, STR_COD_CTA_POR_RET);
        }
