/*
 * ZafMae10.java
 * Esta clase sirve para almacenar los registros de los Grupos de usuarios
 * Created on 20 de octubre de 2004, 12:21
 */

package Maestros.ZafMae10;
 ...
 *
 * @author  kcerezo
 * corregido por jsalazar 21/oct/2005
 * ultima actualizacion 28/dic/2005
 */

public class ZafMae10 extends javax.swing.JInternalFrame {
    ...
    String strAux;        //Variable de tipo string la cual va a almacenar el query de manera auxiliar y esta va a import cambiando segun la funcion
    int intConEst;        //Contador de vector de estado
    int intOpp;           //Entero que almacena lo que elige el usuario en el OptionPane
    int intCodGrp;        //Entero que va a guardar el codigo del registro al que estamos haciendo referencia
    ...
    /** Creates new form ZafMae10 */
    public ZafMae10(ZafParSis obj) {
        initComponents();
        addListenerCambios();
        try{
    ...
    private boolean cargarCabReg()
    {
        ...
        try
        {
            ...
            if (con!=null)
            {
                ...
                String strSQL = "  SELECT * FROM tbm_grpUsr WHERE co_grp = " + rstCab.getString("co_grp") ;
//                System.out.println(strSQL);
                java.sql.ResultSet rst=stm.executeQuery(strSQL);
                if (rst.next())
                {
                    int intCodGrp = rst.getInt("co_grp");
                    txtCodGrp.setText(""+intCodGrp);
    ...
    private boolean validaCampos(){
        if (txtDesCor.getText().equals("")){
            MensajeInf("Ingrese descripcion corta ");
            txtDesCor.requestFocus();
            return false;
        }
        if (txtDesLar.getText().equals("")){
            MensajeInf("Ingrese descripcion larga ");
       ...
       public boolean anular()
            ...
            try{
                ...
                try{
                    if (con!=null){
                        ...
                        String strSQL = "";
                        strSQL = " Update tbm_grpusr set st_reg = 'I' " +
        ...
        public boolean modificar()
        {
            ...
            if (strAux.equals("Anulado"))
            {
                    if (mensaje("Para modificar primero debe reactivar el grupo de usuario \n ¿Desea reactivarlo?")==JOptionPane.YES_OPTION){
                        return Reactivar();
                    }   
            }
            if (!validaCampos())
        ...
        try{
            ...
            try{
                if (con!=null){
                    java.sql.PreparedStatement pstReg;
                    String strSQL="";
                    strSQL = " Update tbm_grpusr set st_reg= 'A' where co_grp = " + txtCodGrp.getText() ;
//                    System.out.println(strSQL);
                    pstReg = con.prepareStatement(strSQL);
                    pstReg.executeUpdate();
                    con.commit();
        ...
        try
        {
            ...
            try{
                if (con!=null){
                    ...
                    java.sql.Statement stm = con.createStatement();
                    strSql = "";
                    strSql = strSql + "SELECT MAX (co_grp)+1 as co_grp from tbm_grpUsr";
                    java.sql.ResultSet rst = stm.executeQuery(strSql);
                    ...
                    strSql = "";
                    strSql = strSql + "INSERT INTO tbm_grpUsr (co_grp, tx_desCor, tx_desLar, tx_obs1, st_reg)";
            ...
            try
            {
                ...
                try{
                    if (con!=null){
                        ...
                        strSql = "";
                        strSql = strSql + "UPDATE tbm_grpUsr SET";
        ...
        try
        {
            ...
            try{
                if (con!=null){
                    ...
                    strSql = "";
                    strSql ="DELETE FROM tbm_grpUsr WHERE co_grp= "+ txtCodGrp.getText().replaceAll("'", "''") +"";
                    pstReg = con.prepareStatement(strSql);
                    pstReg.executeUpdate(); 
                    con.commit();
                    con.close();
       ...
       try{
            ...
            if (conCab!=null){
                ...
                if(rstCab.next()){
                    ...
                    strMsg="No se ha encontrado ningÃºn registro que cumpla el criterio de busqueda especÃ­ficado.";
   ...
   return true;     
    ...
    private void valTxt (javax.swing.JTextField jtfTxt, javax.swing.JTextField jtfTxtAux, String strCam, String strMsj, int intOpc,String strMsjGen, int intTab) {
        ...
        if (intOpp == JOptionPane.YES_OPTION){
            tabGenGrpUsr.setSelectedIndex(intTab);
            jtfTxt.selectAll();
            jtfTxt.requestFocus();
        }
        else {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        tabGenGrpUsr = new javax.swing.JTabbedPane();
        panGrpUsr = new javax.swing.JPanel();
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Zafiro >> Grupo Usuarios");
        setFrameIcon(null);
        ...
        labTit.setText("Maestro de Grupos de Usuarios");
        panGen.add(labTit, java.awt.BorderLayout.NORTH);

        tabGenGrpUsr.setFont(new java.awt.Font("SansSerif", 1, 11));
        panGrpUsr.setLayout(null);

        lblCodGrp.setFont(new java.awt.Font("SansSerif", 0, 11));
        lblCodGrp.setText("Codigo de Grupo");
        panGrpUsr.add(lblCodGrp);
        ...
        panGrpUsr.add(txtCodGrp);
        txtCodGrp.setBounds(132, 16, 40, 20);

        lblDesCor.setFont(new java.awt.Font("SansSerif", 0, 11));
        lblDesCor.setText("Descripci\u00f3n Corta");
        panGrpUsr.add(lblDesCor);
        lblDesCor.setBounds(16, 40, 124, 14);

        txtDesCor.setFont(new java.awt.Font("SansSerif", 0, 11));
        ...
        panGrpUsr.add(butCodGrp);
        butCodGrp.setBounds(172, 16, 24, 20);

        tabGenGrpUsr.addTab("Grupos", panGrpUsr);

        panGen.add(tabGenGrpUsr, java.awt.BorderLayout.CENTER);
        ...
        if (chrFlgLst == 'N') {
            ...
            if (txtCodGrp.getText().length()>0 && chrFlgMsj == 'N') {
                ...
                if (objUti.isNumero(numero) == false) {
                    ...
                    intOpp = oppMsg.showConfirmDialog(this,strMsg,strTit,JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
                    if (intOpp == JOptionPane.YES_OPTION){
                        tabGenGrpUsr.setSelectedIndex(0);
    ...
    private void FndGrpUsr(String strBusqueda, int intTipoBusqueda){
        Librerias.ZafConsulta.ZafConsulta objFnd= 
            ...
            "Select co_grp,tx_desCor,tx_desLar,st_reg from tbm_grpUsr ", strBusqueda, 
            objZafParSis.getStringConexion(), 
            objZafParSis.getUsuarioBaseDatos(), 
            objZafParSis.getClaveBaseDatos()
            );

            objFnd.setTitle("Listado de Grupos de Usuarios");
    ...
    private javax.swing.JPanel panGrpUsr;
    private javax.swing.JScrollPane spnObs1;
    private javax.swing.JTabbedPane tabGenGrpUsr;
