 ...
 * @author  Ingrid
 */
public class ZafImp32_04 extends javax.swing.JDialog 
{
    ...
    public ZafImp32_04(java.awt.Frame parent, boolean modal, ZafParSis obj, char opcionTooBar) {
        super(parent, modal);
        initComponents();
        //Inicializar objetos.
        objParSis=obj;
    ...
    private boolean cargarPedidosPrevios(){
        ...
        try{
            ...
            if (con!=null){
                ...
                //System.out.println("SQL cargarPedidosPrevios: " + strSQL);
                rst=stm.executeQuery(strSQL);
