 ...
 * @author  Ingrid Lino
 */
public class ZafImp32_01 extends javax.swing.JPanel
{
    ...
    private ZafTblModLisImp32_01 objTblModLis;                     //Detectar cambios de valores en las celdas.
    ...
    /** Crea una nueva instancia de la clase ZafImp32_01. */
    public ZafImp32_01(ZafParSis obj)
    {
        initComponents();
        //Inicializar objetos.
        objParSis=obj;
...
//            //Configurar JTable: Ocultar columnas del sistema.
            ...
            objTblModLis=new ZafTblModLisImp32_01();
...
//            objTblTot.setValueAt("Total Gastos:",    2, INT_TBL_DAT_NOM_CAR_PAG_IMP);
     ...
     */
    private class ZafTblModLisImp32_01 implements javax.swing.event.TableModelListener
    {
    ...
    public boolean generarDatosCargoPagar(){
        ...
        try{
            ...
            if (con!=null){
                ...
                strSQL="";
                strSQL+=" SELECT a1.co_carpag, a1.tx_nom, a1.tx_tipcarpag, a1.tx_obs1, a1.st_reg, (CASE WHEN a1.st_pagExt IS NULL THEN 'N' ELSE a1.st_pagExt END) AS st_pagExt";
   ...
   private boolean calculaTotalAranceles(){
    ...
    public void setObjectoImp32_02(ZafImp32_02 objImp32_02){
        this.objImp32_02=objImp32_02;
    }

    public ZafTblMod getTblModImp32_01() {
        return objTblMod;
    }

    public void setTblModImp32_01(ZafTblMod objTblMod) {
    ...
    public boolean limpiarTablaImp32_01(){
        boolean blnRes=true;
        try{
            objTblMod.removeAllRows();
            inicializarTablaTotales();
    ...
    public boolean isBlnHayCamImp32_01() {
        return blnHayCam;
    }

    public void setBlnHayCamCamImp32_01(boolean blnHayCam) {
