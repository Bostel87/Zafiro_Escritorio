 ...
 * @author  Ingrid Lino
 */
public class ZafImp33_02 extends javax.swing.JPanel
{
    //Constantes:
    ...
    public static final int INT_TBL_DAT_CAN_PZA=17;           //Cantidad Piezas - Pedido Embarcado
    ...
    public static final int INT_TBL_DAT_VAL_ISD=23;           //Valor ISD * Porcentaje de ISD
    public static final int INT_TBL_DAT_CHK_ISD_CRE_TRI=24;   //ISD: SI es credito tributario o NO.    
    public static final int INT_TBL_DAT_TOT_ARA=25;           //Total de arancel
    public static final int INT_TBL_DAT_TOT_GAS=26;           //Total de gasto
    public static final int INT_TBL_DAT_TOT_COS=27;           //Total de costo
    public static final int INT_TBL_DAT_COS_UNI=28;           //Costo unitario
    public static final int INT_TBL_DAT_COS_KGR=29;           //Costo por Kgr
    public static final int INT_TBL_DAT_COD_EMP_REL=30;       //Codigo de empresa de la nota de pedido no del pedido de embarque
    public static final int INT_TBL_DAT_COD_LOC_REL=31;       //Codigo de local de la nota de pedido no del pedido de embarque
    public static final int INT_TBL_DAT_COD_TIP_DOC_REL=32;   //Codigo de tipo de documento de la nota de pedido no del pedido de embarque
    public static final int INT_TBL_DAT_COD_DOC_REL=33;       //Codigo de documento de la nota de pedido no del pedido de embarque
    public static final int INT_TBL_DAT_COD_REG_REL=34;       //Codigo de registro de la nota de pedido no del pedido de embarque
    public static final int INT_TBL_DAT_CAN_NOT_PED=35;       //Cantidad Nota de Pedido
    public static final int INT_TBL_DAT_CAN_PEN_NOT_PED=36;   //Cantidad utilizada de la nota de pedido.
    public static final int INT_TBL_DAT_CAN_UTI_PED_EMB=37;   //Cantidad utilizada del pedido embarcado    
    public static final int INT_TBL_DAT_CAN_PED_EMB_AUX=38;   //Cantidad pedido embarcado auxiliar   
    public static final int INT_TBL_DAT_REV_ITM=39;           //Revisión Item.
    ...
    private java.awt.Color colFonColRoj=new java.awt.Color(255,0,0);
    ...
    private int intTipNotPed;           //TipoNotaPedido, viene de ZafImp33
    private String strSQL;
    private String strFechaDocumento, strFechaEmbarque;

    protected EventListenerList objEveLisLis=new EventListenerList();    

    /** Crea una nueva instancia de la clase ZafImp33_02. */
    public ZafImp33_02(ZafParSis obj, ZafImp33_01 objImp33_01Ref)
    {
        initComponents();
        //Inicializar objetos.
        objParSis=obj;
    ...
    private boolean configurarTblDat(){
        ...
        try{
            ...
            vecCab=new Vector(40);   //Almacena las cabeceras
            vecCab.clear();
            ...
            vecCab.add(INT_TBL_DAT_VAL_ISD,    "Val.ISD");
            vecCab.add(INT_TBL_DAT_CHK_ISD_CRE_TRI,"Cre.Tri.");            
            ...
            vecCab.add(INT_TBL_DAT_CAN_PED_EMB_AUX,"Auxiliar");
            ...
            objTblMod.setColumnDataType(INT_TBL_DAT_VAL_ISD, objTblMod.INT_COL_DBL, new Integer(0), null);
            ...
            objTblMod.setColumnDataType(INT_TBL_DAT_CAN_PED_EMB_AUX, objTblMod.INT_COL_DBL, new Integer(0), null);
            ...
            tcmAux.getColumn(INT_TBL_DAT_VAL_ISD).setPreferredWidth(70);
            tcmAux.getColumn(INT_TBL_DAT_CHK_ISD_CRE_TRI).setPreferredWidth(30);            
            ...
            tcmAux.getColumn(INT_TBL_DAT_CAN_UTI_PED_EMB).setPreferredWidth(80);            
            tcmAux.getColumn(INT_TBL_DAT_CAN_PED_EMB_AUX).setPreferredWidth(80);
            tcmAux.getColumn(INT_TBL_DAT_REV_ITM).setPreferredWidth(20);
            
            //Configurar JTable: Renderizar celdas.
            objTblCelRenChk=new ZafTblCelRenChk();
            tcmAux.getColumn(INT_TBL_DAT_CHK_ISD_CRE_TRI).setCellRenderer(objTblCelRenChk);
...
//            tcmAux.getColumn(INT_TBL_DAT_COD_ITM).setResizable(false);
            ...
            objTblMod.addSystemHiddenColumn(INT_TBL_DAT_CAN_PED_EMB_AUX, tblDat); 
            ...
            tcmAux.getColumn(INT_TBL_DAT_COD_EMP_REL).setCellRenderer(objTblCelRenLblText);
            tcmAux.getColumn(INT_TBL_DAT_COD_LOC_REL).setCellRenderer(objTblCelRenLblText);
            tcmAux.getColumn(INT_TBL_DAT_COD_TIP_DOC_REL).setCellRenderer(objTblCelRenLblText);
            tcmAux.getColumn(INT_TBL_DAT_COD_DOC_REL).setCellRenderer(objTblCelRenLblText);
            tcmAux.getColumn(INT_TBL_DAT_COD_REG_REL).setCellRenderer(objTblCelRenLblText);
            ...
            tcmAux.getColumn(INT_TBL_DAT_VAL_ISD).setCellRenderer(objTblCelRenLblNum);            
            ...
            tcmAux.getColumn(INT_TBL_DAT_CAN_NOT_PED).setCellRenderer(objTblCelRenLblNum);            
            tcmAux.getColumn(INT_TBL_DAT_CAN_PEN_NOT_PED).setCellRenderer(objTblCelRenLblNum);   
            tcmAux.getColumn(INT_TBL_DAT_CAN_UTI_PED_EMB).setCellRenderer(objTblCelRenLblNum);   
            tcmAux.getColumn(INT_TBL_DAT_CAN_PED_EMB_AUX).setCellRenderer(objTblCelRenLblNum);   
            ...
            objTblCelEdiTxtCan.addTableEditorListener(new Librerias.ZafTblUti.ZafTblEvt.ZafTableAdapter() {
                ...
                public void beforeEdit(Librerias.ZafTblUti.ZafTblEvt.ZafTableEvent evt) {
                    ...
                    bgdValCanPedEmbAux=new BigDecimal(objTblMod.getValueAt(intFil, INT_TBL_DAT_CAN_PED_EMB_AUX)==null?"0":(objTblMod.getValueAt(intFil, INT_TBL_DAT_CAN_PED_EMB_AUX).toString().equals("")?"0":objTblMod.getValueAt(intFil, INT_TBL_DAT_CAN_PED_EMB_AUX).toString()));
                }
                public void afterEdit(Librerias.ZafTblUti.ZafTblEvt.ZafTableEvent evt) {
                    ...
                    fireImp33_02Listener(new ZafAsiDiaEvent(this), INT_AFT_EDI_CEL);
            ...
            objTblCelEdiTxtPie.addTableEditorListener(new Librerias.ZafTblUti.ZafTblEvt.ZafTableAdapter() {
                ...
                public void beforeEdit(Librerias.ZafTblUti.ZafTblEvt.ZafTableEvent evt) {
                    intFil=tblDat.getSelectedRow();
                    if((intTipNotPed==0) || (intTipNotPed==3) || (intTipNotPed==4) ) //1=TM FOB;2=TM CFR;3=PZA FOB;4=PZA CFR 
            ...
            if(objParSis.getCodigoUsuario()==1){
                ...
                //INSERCION
                if(objPerUsr.isOpcionEnabled(2925)){ //permiso para insertar items
            ...
            intColTbl[11]=INT_TBL_DAT_CHK_ISD_CRE_TRI;
            ...
            objTblCelEdiTxtVcoItm.addTableEditorListener(new Librerias.ZafTblUti.ZafTblEvt.ZafTableAdapter() {
                ...
                public void beforeEdit(Librerias.ZafTblUti.ZafTblEvt.ZafTableEvent evt) {
                    ...
                    //INSERCION
                    if( (objPerUsr.isOpcionEnabled(2925)) && (strLin.equals("I")) ){
                        objTblCelEdiTxtVcoItm.setCancelarEdicion(false);
                    }
                    else if(  (objPerUsr.isOpcionEnabled(2925)) && (strLin.equals("M")) ){//MODIFICACION                        
                        objTblCelEdiTxtVcoItm.setCancelarEdicion(false);
                    }
                    else{
                ...
                public void beforeConsultar(Librerias.ZafTblUti.ZafTblEvt.ZafTableEvent evt) {
                    //Inicializar la ventana de consulta de Items
                    vcoItm.limpiar();                    
                    ...
                    strSQLAdi+=" GROUP BY a3.co_itmMae, a3.co_itm, a1.tx_codAlt, a1.tx_codAlt2, a1.tx_nomItm, a1.nd_pesitmkgr, a5.co_parara, a5.tx_par, a5.tx_des, a5.st_isdCos, a2.tx_desCor, a6.nd_ara";
                ...
                public void afterEdit(Librerias.ZafTblUti.ZafTblEvt.ZafTableEvent evt) {
                    if (objTblCelEdiTxtVcoItm.isConsultaAceptada()){
                        ...
                        if(vcoItm.getValueAt(12).equals("N")) /*st_isdCos*/
                            objTblMod.setValueAt(new Boolean (true), intFil, INT_TBL_DAT_CHK_ISD_CRE_TRI);
                        else
                            objTblMod.setValueAt(new Boolean (false), intFil, INT_TBL_DAT_CHK_ISD_CRE_TRI);
            ...
            objTblCelEdiTxtVcoExpCod.addTableEditorListener(new Librerias.ZafTblUti.ZafTblEvt.ZafTableAdapter() {
                ...
                public void beforeEdit(Librerias.ZafTblUti.ZafTblEvt.ZafTableEvent evt) {
                    ...
                    if( (chrOpcManDatTooBar=='x')  ||  (chrOpcManDatTooBar=='m')  ){//MODIFICACION
                        if( strLin.equals("I") ){ //Cuando se agrega el item en el pedido embarcado, se permite edición de exportador.
                            objTblCelEdiTxtVcoExpCod.setCancelarEdicion(false);
                        }
                        else if( strLin.equals("M") ){//Cuando el item ya existe en el pedido embarcado, se bloquea edición de exportador.
                            objTblCelEdiTxtVcoExpCod.setCancelarEdicion(true);
                        }
                    }
                    else {//Inserción y otros
                        objTblCelEdiTxtVcoExpCod.setCancelarEdicion(false);
                    }
                }
                public void beforeConsultar(Librerias.ZafTblUti.ZafTblEvt.ZafTableEvent evt) {
            ...
            int intCol[]={INT_TBL_DAT_CAN_TON_MET, INT_TBL_DAT_CAN_PZA, INT_TBL_DAT_TOT_FOB_CFR, INT_TBL_DAT_VAL_FLE, INT_TBL_DAT_VAL_CFR, INT_TBL_DAT_VAL_CFR_ARA, INT_TBL_DAT_VAL_ISD, INT_TBL_DAT_TOT_ARA, INT_TBL_DAT_TOT_GAS, INT_TBL_DAT_TOT_COS};
                ...
                public void beforeClick(Librerias.ZafTblUti.ZafTblEvt.ZafTblPopMnuEvent evt) {
                    if (objTblPopMnu.isClickEliminarFila()){
                        ...
                        for(int p=(intFilEli.length-1);p>=0; p--){
                            ...
                            arlRegFilEli.add(INT_CFE_CAN_PED_EMB_AUX,   "" + objTblMod.getValueAt(intFilEli[p], INT_TBL_DAT_CAN_PED_EMB_AUX));
                            ...
                            arlRegFilEli.add(INT_CFE_CAN_PED_EMB,       "" + objTblMod.getValueAt(intFilEli[p], INT_TBL_DAT_CAN_PZA));
        ...
        public void mouseMoved(java.awt.event.MouseEvent evt)
        {
            ...
            switch (intCol)
            {
                ...
                case INT_TBL_DAT_CAN_PZA:
                    strMsg="Cantidad de Pedido Embarcado";
                    break;
                ...
                case INT_TBL_DAT_VAL_CFR_ARA:
                    strMsg="";
                    break;
                case INT_TBL_DAT_VAL_ISD:
                    strMsg="";
                    break;    
                case INT_TBL_DAT_CHK_ISD_CRE_TRI:
                    strMsg="Impuesto Tributario. S=Si aplica; N=No aplica.";
                    break;                      
    ...
    private boolean configurarVenConItm()
    {
        ...
        try
        {
            ...
            strSQL+="      , a6.nd_ara, (CASE WHEN a5.st_isdCos IS NULL THEN 'N' ELSE a5.st_isdCos END) AS st_isdCos";
    ...
    private boolean calcularV2_FleteItem(){
        ...
        try{
            bgdValFle=new BigDecimal(objImp33_01.getFleteItem()==null?"0":(objImp33_01.getFleteItem().toString().equals("")?"0":objImp33_01.getFleteItem().toString()));
            ...
            //System.out.println("bgdV2_FleItm: " + bgdV2_FleItm);
        }
        catch(Exception e){
            objUti.mostrarMsgErr_F1(this, e);
            blnRes=false;
    ...
    public boolean calcularC21_ValISD(){
        boolean blnRes=true;
        BigDecimal bgdTotFobCfr=new BigDecimal(BigInteger.ZERO);
        BigDecimal bgdPorISD =new BigDecimal(BigInteger.ZERO); /*Porcentaje ISD*/
        BigDecimal bgdValISD=new BigDecimal(BigInteger.ZERO);
        try{
            bgdPorISD=objZafImp.getPorcentajeISD(objParSis.getCodigoEmpresaGrupo(), 1); 
            for(int i=0; i<objTblMod.getRowCountTrue();i++){
                bgdTotFobCfr=new BigDecimal(objTblMod.getValueAt(i, INT_TBL_DAT_TOT_FOB_CFR)==null?"0":(objTblMod.getValueAt(i, INT_TBL_DAT_TOT_FOB_CFR).toString().equals("")?"0":objTblMod.getValueAt(i, INT_TBL_DAT_TOT_FOB_CFR).toString()));
                bgdValISD=bgdTotFobCfr.multiply(bgdPorISD);
                objTblMod.setValueAt((bgdValISD), i, INT_TBL_DAT_VAL_ISD);
            }
        }
        catch(Exception e){
            objUti.mostrarMsgErr_F1(this, e);
    ...
    public boolean calcularV5_FactorArancel(){//          V5=   V4>0  ->   V3/V4
        ...
        try{
            if(bgdValV4ItmPagAra.compareTo(new BigDecimal("0"))>0){
                bgdValV5FacAra=objImp33_01.getDerechosArancelarios().divide(bgdValV4ItmPagAra, 20, BigDecimal.ROUND_HALF_UP);
            }
        }
        catch(Exception e){
            objUti.mostrarMsgErr_F1(this, e);
        ...
        try{
            for(int i=0; i<objTblMod.getRowCountTrue();i++){
                ...
                if(bgdValV5FacAra.compareTo(new BigDecimal("0"))>0){
                    ...
                    if(objImp33_01.getDerechosArancelarios().compareTo(new BigDecimal("0"))>0)
    ...
    /**
     * Función que Prorrateo el valor de gastos de los cargos a pagar y actualiza en el detalle del pedido.
     * @return 
     */
    public boolean calcularV15_FactorGastos(){//          V5=   V4>0  ->   V3/V4
        boolean blnRes=true;
        BigDecimal bgdValTotGas=objImp33_01.getTotalGastos();
    ...
    public void regenerarCalculos(){
        System.out.println("regenerarCalculos");
    ...
    public ZafTblMod getTblModImp33_02() {
        return objTblMod;
    }

    public void setTblModImp33_02(ZafTblMod objTblMod) {
    ...
    public void regenerarCalculoValISD(){
        calcularC21_ValISD();
        objTblTot.calcularTotales();
    }        
    ...
    public boolean limpiarTablaImp33_02(){
        boolean blnRes=true;
        try{
            objTblMod.removeAllRows();
            objTblTot.calcularTotales();
    ...
    /**
     * Esta función adiciona el listener que controlará los eventos que se generen sobre la clase "ZafImp33_02".
     * @param listener El objeto que implementa los métodos de la interface "ZafAsiDiaListener".
     */
    public void addImp33_02Listener(ZafAsiDiaListener listener)
    {
     ...
     * @param listener El objeto que implementa los métodos de la interface "ZafAsiDiaListener".
     */
    public void removeImp33_02Listener(ZafAsiDiaListener listener)
    {
     ...
     * </CENTER>
     */
    private void fireImp33_02Listener(ZafAsiDiaEvent evt, int metodo)
    {
        int i;
    ...
    public boolean isBlnHayCamImp33_02() {
        return blnHayCam;
    }

    public void setBlnHayCamCamImp33_02(boolean blnHayCam) {
    ...
    public void addArregloFilasEliminadas(ArrayList arlRegFilEliImp33_03) {
        this.arlDatFilEli.add(arlRegFilEliImp33_03);
    }


    /**Función usada para la nota de embarque, cuando se seleccionan items, se debe colocar el valor de la suma del flete pero
     * de los items seleccionados, se lee este valor y se lo setea en en ZafImp33_01.
        ...
        try{
            ...
            if (conLoc!=null){
                ...
                for(int i=0; i<objTblMod.getRowCountTrue(); i++) {
                    //Armar sentencia SQL
                    strSqlAux ="";
                    strSqlAux+=" SELECT a3.co_itmMae, (CASE WHEN a5.st_isdCos IS NULL THEN 'N' ELSE a5.st_isdCos END) AS st_isdCos";
                    strSqlAux+=" FROM ((tbm_inv AS a1 INNER JOIN tbm_equInv AS a3 ON a1.co_emp=a3.co_emp AND a1.co_itm=a3.co_itm)";
                    strSqlAux+="        LEFT OUTER JOIN tbm_var AS a2 ON (a1.co_uni=a2.co_reg) )";
                    strSqlAux+=" LEFT OUTER JOIN(";
                    strSqlAux+="      tbm_grpInvImp AS a4 LEFT OUTER JOIN tbm_parAraImp AS a5 ON a4.co_parAra=a5.co_parAra";
                    strSqlAux+="      LEFT OUTER JOIN tbm_vigParAraImp AS a6 ON a5.co_parAra=a6.co_parAra";
                    strSqlAux+="      AND CAST('"+datFecAux+"' AS date) BETWEEN a6.fe_vigDes AND (CASE WHEN a6.fe_vigHas IS NULL THEN CURRENT_DATE ELSE a6.fe_vigHas END)";
                    strSqlAux+=" ) ON a1.co_grpImp=a4.co_grp";
                    strSqlAux+=" WHERE a3.co_itmMae="+objTblMod.getValueAt(i, INT_TBL_DAT_COD_ITM_MAE);
                    strSqlAux+=" GROUP BY a3.co_itmMae, a5.st_isdCos";   
                    //System.out.println("regenerarISD: "+strSqlAux);
                    rstLoc=stmLoc.executeQuery(strSqlAux);
                    if(rstLoc.next()){
                        /* Cuando la partida arancelaria aplica al costo, NO genera credito Tributario. */
                        String strChkISD=rstLoc.getObject("st_isdCos")==null?"N":(rstLoc.getString("st_isdCos").equals("")?"N":rstLoc.getString("st_isdCos"));
                        if(strChkISD.equals("N")) {
                            objTblMod.setValueAt(new Boolean(true), i, INT_TBL_DAT_CHK_ISD_CRE_TRI);
                        } 
                        else{
                            objTblMod.setValueAt(null, i, INT_TBL_DAT_CHK_ISD_CRE_TRI);
                        }
                    }
                    rstLoc.close();
                    rstLoc=null;
                }   
                regenerarCalculoValISD();
                stmLoc.close();
                stmLoc=null;
                conLoc.close();
                conLoc=null;
