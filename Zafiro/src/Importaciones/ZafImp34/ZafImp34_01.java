 ...
 * @author  Ingrid Lino
 */
public class ZafImp34_01 extends javax.swing.JPanel
{
    ...
    public static final int INT_TBL_DAT_TIP_PAG_EXT=7;             //Indica si el tipo de pago es al exterior.
    ...
    private ZafTblModLisImp34_01 objTblModLis;                      //Detectar cambios de valores en las celdas.
    ...
    /** Crea una nueva instancia de la clase ZafImp34_01. */
    public ZafImp34_01(ZafParSis obj)
    {
        initComponents();
        //Inicializar objetos.
        objParSis=obj;
...
//            //Configurar JTable: Ocultar columnas del sistema.
            ...
            objTblModLis=new ZafTblModLisImp34_01();
...
//            objTblTot.setValueAt("Total Gastos:",    2, INT_TBL_DAT_NOM_CAR_PAG_IMP);
     ...
     */
    private class ZafTblModLisImp34_01 implements javax.swing.event.TableModelListener
    {
    ...
    public boolean generarDatosCargoPagar(){
        ...
        try{
            ...
            if (con!=null){
                ...
                strSQL+="     , (CASE WHEN a1.st_pagExt IS NULL THEN 'N' ELSE a1.st_pagExt END) AS st_pagExt";
   ...
   public boolean calculaTotalFletes(){
       boolean blnRes=true;
       BigDecimal bdeValFilFle=BigDecimal.ZERO;
       BigDecimal bdeValTotFle=BigDecimal.ZERO;
       String strTipCar="";
       try{
           for(int i=0;i<objTblMod.getRowCountTrue(); i++){
               ...
               if(strTipCar.equals("F")){
                   bdeValFilFle=new BigDecimal(objTblMod.getValueAt(i, INT_TBL_DAT_VAL_CAR_PAG_IMP)==null?"0":(objTblMod.getValueAt(i, INT_TBL_DAT_VAL_CAR_PAG_IMP).toString().equals("")?"0":objTblMod.getValueAt(i, INT_TBL_DAT_VAL_CAR_PAG_IMP).toString()));
                   bdeValTotFle=bdeValTotFle.add(bdeValFilFle);
               }
           }
           objTblTot.setValueAt(bdeValTotFle, 0, INT_TBL_DAT_VAL_CAR_PAG_IMP);
       }
       catch(Exception e){
           objUti.mostrarMsgErr_F1(this, e);
           blnRes=false;
   ...
   private boolean calculaTotalAranceles(){
       ...
       try{
           ...
           objTblTot.setValueAt(bdeValTotFle, 1, INT_TBL_DAT_VAL_CAR_PAG_IMP);
       }
       catch(Exception e){
           objUti.mostrarMsgErr_F1(this, e);
           blnRes=false;
   ...
   private boolean calculaTotalGastos(){
       boolean blnRes=true;
       BigDecimal bdeValFilFle=new BigDecimal(BigInteger.ZERO);
       BigDecimal bdeValTotFle=new BigDecimal(BigInteger.ZERO);
       String strTipCar="";
       try{
           for(int i=0;i<objTblMod.getRowCountTrue(); i++){
               strTipCar=objTblMod.getValueAt(i, INT_TBL_DAT_TIP_CAR_PAG_IMP)==null?"":objTblMod.getValueAt(i, INT_TBL_DAT_TIP_CAR_PAG_IMP).toString();
           ...
           objTblTot.setValueAt(bdeValTotFle, 2, INT_TBL_DAT_VAL_CAR_PAG_IMP);
           bgdTotGas=bdeValTotFle;
       }
       catch(Exception e){
           objUti.mostrarMsgErr_F1(this, e);
           blnRes=false;
    ...
    public void setObjectoImp34_02(ZafImp34_02 objImp34_02){
        this.objImp34_02=objImp34_02;
    }

    public ZafTblMod getTblModImp34_01() {
        return objTblMod;
    }

    public void setTblModImp34_01(ZafTblMod objTblMod) {
    ...
    public boolean limpiarTablaImp34_01(){
        boolean blnRes=true;
        try{
            objTblMod.removeAllRows();
            inicializarTablaTotales();
    ...
    public boolean isBlnHayCamImp34_01() {
        return blnHayCam;
    }

    public void setBlnHayCamCamImp34_01(boolean blnHayCam) {
    ...
    public boolean colocaTotalGastosAdicionales(BigDecimal nuevoValorGasto, int codigoCargo){//si el tipo es 0 -> se suma normalmente, si es 1 -> se setea(colocar cero)
        ...
        String strTipCar="";
        int intCodCar=-1;
        BigDecimal bdeValCarAdiCel=new BigDecimal(BigInteger.ZERO);
        try{
            for(int i=0;i<objTblMod.getRowCountTrue(); i++){
                ...
                if(intCodCar==codigoCargo){
                    bdeValCarAdiCel=new BigDecimal(objTblMod.getValueAt(i, INT_TBL_DAT_VAL_CAR_PAG_IMP)==null?"0":(objTblMod.getValueAt(i, INT_TBL_DAT_VAL_CAR_PAG_IMP).toString().equals("")?"0":objTblMod.getValueAt(i, INT_TBL_DAT_VAL_CAR_PAG_IMP).toString()));
                    objTblMod.setValueAt(bdeValCarAdiCel.add(nuevoValorGasto), i, INT_TBL_DAT_VAL_CAR_PAG_IMP);
                }
            }
    ...
    private boolean calcular_CargoValorTotalPagoExterior() {
        ...
        try{
            ...
            /* El cargo: Valor de la factura, menos el Valor de Gastos Origen. Sería el valor que se validará con Tot.Fob/Cfr.*/
