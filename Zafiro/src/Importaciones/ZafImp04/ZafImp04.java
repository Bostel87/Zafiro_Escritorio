 ...
 */
package Importaciones.ZafImp04;
 ...
 * @author  Ingrid Lino
 */
public class ZafImp04 extends javax.swing.JInternalFrame
{
    ...
    static final int INT_TBL_DAT_DIA_CRE=13;
    static final int INT_TBL_DAT_TOT_FOB_CFR=14;
    static final int INT_TBL_DAT_TOT_ARA_FOD_IVA=15;
    static final int INT_TBL_DAT_EST=16;
    static final int INT_TBL_DAT_BUT=17;
    static final int INT_TBL_DAT_BUT_NOT_PED=18;
    static final int INT_TBL_DAT_CHK_ING_IMP=19;
    static final int INT_TBL_DAT_BUT_ING_IMP=20;
    static final int INT_TBL_DAT_CHK_DOC_AJU=21;
    ...
    private ZafTblCelRenChk objTblCelRenChkIngImp, objTblCelRenChkDocAju;       //Render: Presentar JCheckBox en JTable.
    private ZafTblCelEdiChk objTblCelEdiChkIngImp, objTblCelEdiChkDocAju;       //Editor: JCheckBox en celda.
    private ZafTblCelRenBut objTblCelRenBut, objTblCelRenButNotPed, objTblCelRenButIngImp, objTblCelRenButDocAju;
    private ZafTblCelEdiButGen objTblCelEdiButGen, objTblCelEdiButGenNotPed, objTblCelEdiButGenIngImp, objTblCelEdiButGenDocAju;
    ...
    private int intCodEmpIngImp=0, intCodLocIngImp=0;
    private int intCodTipDocIngImp=0, intCodDocIngImp=0;
    ...
    private boolean configurarFrm()
    {
        ...
        try
        {
            ...
            if (!objPerUsr.isOpcionEnabled(3209))
            {
                butCon.setVisible(false);
            }
            if (!objPerUsr.isOpcionEnabled(3210))
            {
    ...
    private boolean configurarTblDat()
    {
        ...
        try
        {
            ...
            vecCab.add(INT_TBL_DAT_BUT,"Emb.");
            ...
            tcmAux.getColumn(INT_TBL_DAT_NOM_EXP).setPreferredWidth(55);
            tcmAux.getColumn(INT_TBL_DAT_DIA_CRE).setPreferredWidth(55);
            tcmAux.getColumn(INT_TBL_DAT_TOT_FOB_CFR).setPreferredWidth(68);
            tcmAux.getColumn(INT_TBL_DAT_TOT_ARA_FOD_IVA).setPreferredWidth(75);
            tcmAux.getColumn(INT_TBL_DAT_EST).setPreferredWidth(23);
...
//            tcmAux.getColumn(INT_TBL_DAT_BUT_CTA).setResizable(false);
        ...
        public void mouseMoved(java.awt.event.MouseEvent evt)
        {
            ...
            switch (intCol)
            {
                ...
                case INT_TBL_DAT_DIA_CRE:
                    strMsg="Dias de Crédito de la Factura del Proveedor";
                    break;                    
                ...
                case INT_TBL_DAT_EST:
                    strMsg="Estado del pedido embarcado";
                    break;
    ...
    private void initComponents() {
        ...
        chkMosNotPedAso.setBounds(40, 140, 290, 20);
    ...
    private void mostrarFormularioNotaPedido(int fila){
        try{
            ...
            ZafImp04_01 objImp04_01=new ZafImp04_01(objParSis);//datos de nota de pedido
            objImp04_01.setCodigoTipoDocumentoPedidoEmbarcado(Integer.parseInt(objTblMod.getValueAt(fila, INT_TBL_DAT_COD_TIP_DOC).toString()));
            objImp04_01.setCodigoDocumentoPedidoEmbarcado(Integer.parseInt(objTblMod.getValueAt(fila, INT_TBL_DAT_COD_DOC).toString()));
            objImp04_01.cargarDocumentos();
             
            if(objImp04_01.getNumeroRegistros()==1){
                //se carga el programa Nota de Pedido
                Importaciones.ZafImp32.ZafImp32 objImp_32=new Importaciones.ZafImp32.ZafImp32(objParSis, objParSis.getCodigoLocal(), objImp04_01.getCodigoTipoDocumentoNotaPedido(), objImp04_01.getCodigoDocumentoNotaPedido());
                this.getParent().add(objImp_32,javax.swing.JLayeredPane.DEFAULT_LAYER);
                objImp_32.setVisible(true);
                objImp_32=null;
            }
            else{
                this.getParent().add(objImp04_01,javax.swing.JLayeredPane.DEFAULT_LAYER);
                objImp04_01.setVisible(true);
                objImp04_01=null;
            }
        }
        catch (Exception e){
    ...
    private void mostrarFormularioIngresoImportacion (int fila)
    {
        try
        {
            getNumeroIngresosImportacionAsociados(fila);

            //Se carga el programa Ingresos por Importación.
            Importaciones.ZafImp34.ZafImp34 objImp_34=new Importaciones.ZafImp34.ZafImp34(objParSis, intCodEmpIngImp, intCodLocIngImp, intCodTipDocIngImp, intCodDocIngImp);
    ...
    private void getNumeroIngresosImportacionAsociados(int fila)
    {
        try{
            ...
            if(con!=null){
                ...
                strSQL+=" FROM(";
                strSQL+="	SELECT a5.co_emp, a5.co_loc, a5.co_tipDoc, a5.co_doc";
                strSQL+="	     , a7.tx_desCor, a7.tx_desLar, a5.ne_numDoc, a5.tx_numDoc2";
                strSQL+="	     , a4.co_tipDoc AS co_tipDocNotPed, a4.co_doc AS co_docNotPed";
                ...
                strSQL+="       AND a5.co_tipDoc in (select co_tipDoc from tbr_tipDocPrg where co_emp=" + objParSis.getCodigoEmpresa();
                strSQL+="                            and co_loc=" + objParSis.getCodigoLocal()+" and co_mnu IN( "+objImp.INT_COD_MNU_PRG_ING_IMP+", "+objImp.INT_COD_MNU_PRG_COM_LOC+") )";
                strSQL+=" 	AND a4.co_emp=" + objTblMod.getValueAt(fila, INT_TBL_DAT_COD_EMP) + " AND a4.co_loc=" + objTblMod.getValueAt(fila, INT_TBL_DAT_COD_LOC) + "";
                strSQL+="       AND a4.co_tipDoc=" + objTblMod.getValueAt(fila, INT_TBL_DAT_COD_TIP_DOC) + " AND a4.co_doc=" + objTblMod.getValueAt(fila, INT_TBL_DAT_COD_DOC) + "";
                strSQL+="	GROUP BY a5.co_emp, a5.co_loc, a5.co_tipDoc, a5.co_doc, a7.tx_desCor, a7.tx_desLar";
                strSQL+=" 	       , a5.ne_numDoc, a5.tx_numDoc2, a4.co_tipDoc, a4.co_doc";
                strSQL+=" 	ORDER BY a4.co_doc, a5.co_emp, a5.co_loc, a5.co_tipDoc, a5.co_doc";
                strSQL+=" ) AS b1";
                strSQL+=" GROUP BY b1.co_emp, b1.co_loc, b1.co_tipDoc, b1.co_doc, b1.tx_desCor, b1.tx_desLar, b1.co_tipDocNotPed, b1.co_docNotPed";
    ...
    private boolean getDocumentosAjuste(int fila)
    {
        ...
        try
        {
            ...
            if(con!=null)
            {
                ...
                strSQL+=" WHERE  a2.co_emp=" + objTblMod.getValueAt(fila, INT_TBL_DAT_COD_EMP); 
                strSQL+=" AND a2.co_loc=" + objTblMod.getValueAt(fila, INT_TBL_DAT_COD_LOC);
                strSQL+=" AND a2.co_tipDoc=" + objTblMod.getValueAt(fila, INT_TBL_DAT_COD_TIP_DOC);
                strSQL+=" AND a2.co_doc=" + objTblMod.getValueAt(fila, INT_TBL_DAT_COD_DOC);
    ...
    private boolean cargarDetReg()
    {
        ...
        try
        {
            ...
            if (con!=null)
            {
                ...
                strSQL="";
                strSQL+=" SELECT b1.co_emp, b1.co_loc, b1.co_tipDoc, b1.co_doc, b1.tx_desCor, b1.tx_desLar";
                strSQL+="      , b1.ne_numDoc, b1.tx_numDoc2, b1.fe_doc, b1.fe_emb, b1.fe_arr, b1.ne_diacre";
                strSQL+="      , b1.co_exp, b1.tx_nomExp, b2.nd_valDoc, b4.co_EmpIngImp, b4.st_tieAju, b1.st_Reg";
                strSQL+="      , SUM(b3.nd_valCarPag) as nd_valCarPag";
                strSQL+=" FROM(";
                strSQL+="      SELECT a1.co_emp, a1.co_loc, a1.co_tipDoc, a1.co_doc, a3.tx_desCor, a3.tx_desLar";
                strSQL+=" 	  , a1.ne_numDoc, a1.tx_numDoc2, a1.fe_doc, a1.fe_emb, a1.fe_arr, a1.ne_diacre, a1.st_reg, a2.co_exp, a4.tx_nom as tx_nomExp";
                ...
                strSQL+="      INNER JOIN tbm_expImp as a4 on a2.co_exp=a4.co_exp";
                ...
                strSQL+="      GROUP BY a1.co_emp, a1.co_loc, a1.co_tipDoc, a1.co_doc, a3.tx_desCor, a3.tx_desLar";
                strSQL+=" 	      , a1.ne_numDoc, a1.tx_numDoc2, a1.fe_doc, a1.fe_emb, a1.fe_arr, a1.ne_diacre, a1.st_reg, a2.co_exp, a4.tx_nom";	
                strSQL+=" ) AS b1";
                strSQL+=" INNER JOIN(";
                strSQL+="      SELECT a1.co_emp, a1.co_loc, a1.co_tipDoc, a1.co_doc, a1.co_exp, SUM (a1.nd_valTotCos) as nd_valDoc";
                strSQL+="      FROM tbm_detPedEmbImp AS a1";
                strSQL+="      GROUP BY a1.co_emp, a1.co_loc, a1.co_tipDoc, a1.co_doc, a1.co_exp";
                strSQL+=" ) AS b2 ON b1.co_emp=b2.co_emp AND b1.co_loc=b2.co_loc AND b1.co_tipDoc=b2.co_tipDoc AND b1.co_doc=b2.co_doc AND b1.co_exp=b2.co_exp";
                strSQL+=" INNER JOIN(";
                strSQL+="      SELECT  a1.co_emp, a1.co_loc, a1.co_tipDoc, a1.co_doc, a2.co_exp, a1.nd_valCarPag";
                strSQL+="      FROM tbm_carPagPedEmbImp as a1 INNER JOIN tbm_detPedEmbImp AS a2 on a1.co_emp=a2.co_emp";
                ...
                strSQL+=" ) AS b3 ON b1.co_emp=b3.co_emp AND b1.co_loc=b3.co_loc AND b1.co_tipDoc=b3.co_tipDoc AND b1.co_doc=b3.co_doc AND b1.co_exp=b3.co_exp";
                strSQL+=" LEFT OUTER JOIN(";
                strSQL+=" 	SELECT a2.co_emp as co_EmpIngImp, a1.co_emp, a1.co_loc, a1.co_tipDoc, a1.co_doc";
                strSQL+=" 	      ,CASE WHEN a2.st_cieAjuInvIngImp IS NULL THEN 'N' ELSE a2.st_cieAjuInvIngImp END as st_tieAju";
                strSQL+=" 	FROM tbm_cabPedEmbImp AS a1";
                strSQL+=" 	INNER JOIN tbm_cabMovInv AS a2";
                strSQL+=" 	ON a1.co_emp=a2.co_empRelPedEmbImp AND a1.co_loc=a2.co_locRelPedEmbImp AND a1.co_tipDoc=a2.co_tipDocRelPedEmbImp AND a1.co_doc=a2.co_docRelPedEmbImp";
                strSQL+=" 	LEFT OUTER JOIN tbr_cabMovInv as a3";
                ...
                strSQL+="  	GROUP BY a2.co_emp, a1.co_emp, a1.co_loc, a1.co_tipDoc, a1.co_doc, a2.st_cieAjuInvIngImp";
                strSQL+=" ) AS b4 ON b1.co_emp=b4.co_emp AND b1.co_loc=b4.co_loc AND b1.co_tipDoc=b4.co_tipDoc AND b1.co_doc=b4.co_doc";
                ...
                while (rst.next()){
                    if (blnCon)
                    {
                        ...
                        vecReg.add(INT_TBL_DAT_COD_EMP,         rst.getString("co_emp"));      //co_empPedEmb
                        vecReg.add(INT_TBL_DAT_COD_LOC,         rst.getString("co_loc"));      //co_locPedEmb
                        vecReg.add(INT_TBL_DAT_COD_TIP_DOC,     rst.getString("co_tipDoc"));   //co_tipDocPedEmb
                        vecReg.add(INT_TBL_DAT_DES_COR_TIP_DOC, rst.getString("tx_desCor"));   //tx_desCorTipDocPedEmb
                        vecReg.add(INT_TBL_DAT_DES_LAR_TIP_DOC, rst.getString("tx_desLar"));   //tx_desCorTipDocPedEmb
                        vecReg.add(INT_TBL_DAT_COD_DOC,         rst.getString("co_doc"));      //co_docPedEmb
                        vecReg.add(INT_TBL_DAT_NUM_DOC,         rst.getString("tx_numDoc2"));  //Núm.Ped.Emb.
                        ...
                        vecReg.add(INT_TBL_DAT_DIA_CRE,         rst.getString("ne_diaCre"));   //Dias Crédito
                        vecReg.add(INT_TBL_DAT_TOT_FOB_CFR,     rst.getString("nd_valDoc"));   //co_emp
                        vecReg.add(INT_TBL_DAT_TOT_ARA_FOD_IVA, rst.getString("nd_valCarPag"));//co_loc
                        vecReg.add(INT_TBL_DAT_EST,             rst.getString("st_reg"));      //st_reg
                        vecReg.add(INT_TBL_DAT_BUT,             null);//Btn.Ped.Emb.
