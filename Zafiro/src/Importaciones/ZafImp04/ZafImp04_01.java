 ...
 * @author  Ingrid Lino
 */
public class ZafImp04_01 extends javax.swing.JInternalFrame
{
    ...
    private int intCodTipDocPedEmb;
    private int intCodDocPedEmb;
    ...
    public ZafImp04_01(ZafParSis obj)
    {
        try
        {
...
//            objTblEdi=new ZafTblEdi(tblDat);
    ...
    public int getCodigoTipoDocumentoPedidoEmbarcado() {
        return intCodTipDocPedEmb;
    }
    
    public void setCodigoTipoDocumentoPedidoEmbarcado(int intCodTipDocPedEmb) {
        this.intCodTipDocPedEmb = intCodTipDocPedEmb;
    }
    
    public int getCodigoDocumentoPedidoEmbarcado() {
        return intCodDocPedEmb;
    }
    public void setCodigoDocumentoPedidoEmbarcado(int intCodDocPedEmb) {
        this.intCodDocPedEmb = intCodDocPedEmb;
    }
    ...
    public boolean cargarDocumentos()
    {
        ...
        try{
            ...
            if (con!=null){
                ...
                strSQL+="      , a5.tx_desCor, a5.tx_desLar, a1.ne_numDoc, a1.tx_numDoc2";
                strSQL+="      , a4.co_tipDoc AS co_tipDocPedEmb, a4.co_doc AS co_docPedEmb";
                ...
                strSQL+=" ON a1.co_emp=a5.co_emp AND a1.co_loc=a5.co_loc AND a1.co_tipDoc=a5.co_tipDoc";
                strSQL+=" WHERE a4.st_reg NOT IN('E','I')";
                strSQL+=" AND a4.co_emp=" + objParSis.getCodigoEmpresa() + " AND a4.co_loc=" + objParSis.getCodigoLocal() + "";
                strSQL+=" AND a4.co_tipDoc=" + intCodTipDocPedEmb + " AND a4.co_doc=" + intCodDocPedEmb + "";
                strSQL+=" GROUP BY a1.co_emp, a1.co_loc, a1.co_tipDoc, a1.co_doc";
                strSQL+="        , a5.tx_desCor, a5.tx_desLar, a1.ne_numDoc, a1.tx_numDoc2, a4.co_tipDoc, a4.co_doc";
                strSQL+=" ORDER BY a4.co_doc, a1.co_emp, a1.co_loc, a1.co_tipDoc, a1.co_doc";
