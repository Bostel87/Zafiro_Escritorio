 ...
 * ZafImp08_01.java
 *
 * Created on 14 de Mayo de 2018, 13:07
 *
 * v0.1 
 */
 ...
 * "Muestra Ventana con información de conteos asociados"
 */
public class ZafImp08_01 extends javax.swing.JDialog 
{
     ...
     * Constructor
     */
    public ZafImp08_01(java.awt.Frame parent, boolean modal, ZafParSis obj, int codEmpCon, int codLocCon, int codTipDocCon, int codDocCon, int codItmMaeCon) 
    {
        super(parent, modal);
        initComponents();
        //Inicializar objetos.
    ...
    private void initComponents() {
        ...
        lblTit.setText("Listado de conteos asociados");
