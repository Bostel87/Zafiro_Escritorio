 ...
 */
public class ZafImp28_03 extends javax.swing.JDialog 
{
    //Constantes: Columnas del JTable.
    private static final int INT_TBL_DAT_LIN = 0;
    private static final int INT_TBL_DAT_FEC_DOC = 1;
    private static final int INT_TBL_DAT_COD_TIPDOC = 2;
    ...
    private static final int INT_TBL_DAT_EST_REG = 13;
    ...
    private int intCodEmpIngImp, intCodLocIngImp, intCodTipDocIngImp, intCodDocIngImp, intCodItmMae;
     ...
     * Constructor
     */
    public ZafImp28_03(java.awt.Frame parent, boolean modal, ZafParSis obj, int codEmpIngImp, int codLocIngImp, int codTipDocIngImp, int codDocIngImp, int codItmMae) 
    {
        super(parent, modal);
        initComponents();
        //Inicializar objetos.
    ...
    private boolean configurarTblDat() 
    {
        ...
        try 
        {
            ...
            tcmAux.getColumn(INT_TBL_DAT_COD_TIPDOC).setPreferredWidth(30);
            ...
            tcmAux.getColumn(INT_TBL_DAT_EST_REG).setPreferredWidth(44);
            ...
            tcmAux.getColumn(INT_TBL_DAT_EST_REG).setCellRenderer(objTblCelRenLblCen);
        ...
        public void mouseMoved(java.awt.event.MouseEvent evt) 
        {
            ...
            switch (intCol) 
            {
                case INT_TBL_DAT_LIN:
                    ...
                    strMsg+="<tr><td style='background-color: #FFDDBB'>&nbsp;</td><td>&nbsp;</td><td>Indica que son transferencias de \"Documentos de Ajustes\".</td></tr>"; //Color Crema
                ...
                case INT_TBL_DAT_COD_USR:
                    strMsg = "Código del usuario que transfiere";
                    break;
    ...
    private boolean cargarLisTraAso() 
    {
        ...
        try 
        {
            ...
            if (con != null) 
            {
                ...
                strSQL+=" FROM ( \n";
                strSQL+="     SELECT CASE WHEN a2.co_tipdocRel IN ("+strAuxTipDocAju+") THEN 'S' ELSE 'N' END AS st_IsDocAju \n";      
                strSQL+="          , a.fe_doc, a.co_emp, a.co_loc, a.co_tipDoc, a5.tx_desCor, a5.tx_desLar, a.co_doc, a.ne_numDoc, a1.co_bod AS co_bodEmpDes \n";
                strSQL+="          , a7.tx_nom as tx_nomBodDes, a1.co_itm, a1.nd_Can, a6.co_usr, a6.tx_usr, a6.tx_nom AS tx_nomUsr, a.st_Reg \n";
                ...
                strSQL+="     INNER JOIN tbm_bod as a7 ON (a.co_emp=a7.co_emp AND a1.co_bod=a7.co_bod) \n";
                strSQL+="     WHERE a1.nd_can>0 ";
                //strSQL+="     AND a.st_Reg in ('A')"; //Se comenta para que muestre todas las transferencias activas e inactivas.
                ...
                strSQL+=" AND a1.co_itmMae="+intCodItmMae;

                System.out.println("SQL ZafImp28_03: " + strSQL);
                ...
                while (rst.next()) 
                {
                    ...
                    vecReg.add(INT_TBL_DAT_COD_BODDES, rst.getString("co_bodEmpDes"));
