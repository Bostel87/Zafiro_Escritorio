 ...
 * @author  Ingrid Lino
 */
public class ZafImp03_01 extends javax.swing.JInternalFrame
{
    ...
    private int intCodTipDocPedEmb_UnReg;
    private int intCodDocPedEmb_UnReg;
    private Vector vecReg, vecDat, vecCab, vecAux;
    
    /** Crea una nueva instancia de la clase ZafIndRpt. */
    public ZafImp03_01(ZafParSis obj)
    {
        try
        {
...
//            objTblEdi=new ZafTblEdi(tblDat);
            ...
            objTblCelEdiButGen.addTableEditorListener(new Librerias.ZafTblUti.ZafTblEvt.ZafTableAdapter() {
                ...
                public void actionPerformed(Librerias.ZafTblUti.ZafTblEvt.ZafTableEvent evt) {
                        callPrgPedidoEmbarcado(intFilSel);
                }
    ...
    public int getCodigoTipoDocumentoPedidoEmbarcado() {
        return intCodTipDocPedEmb_UnReg;
    }

    public void setCodigoTipoDocumentoPedidoEmbarcado(int intCodTipDocPedEmb_UnReg) {
        this.intCodTipDocPedEmb_UnReg = intCodTipDocPedEmb_UnReg;
    }
    
    public int getCodigoDocumentoPedidoEmbarcado() {
        return intCodDocPedEmb_UnReg;
    }

    public void setCodigoDocumentoPedidoEmbarcado(int intCodDocPedEmb_UnReg) {
        this.intCodDocPedEmb_UnReg = intCodDocPedEmb_UnReg;
    }
    ...
    private void callPrgPedidoEmbarcado(int fila)
    {
        try
        {
            //Se carga el programa Pedido Embarcado
            Importaciones.ZafImp33.ZafImp33 objImp_33=new Importaciones.ZafImp33.ZafImp33(objParSis, Integer.parseInt(objTblMod.getValueAt(fila, INT_TBL_DAT_COD_TIP_DOC).toString()), Integer.parseInt(objTblMod.getValueAt(fila, INT_TBL_DAT_COD_DOC).toString())  );
    ...
    public boolean cargarDocumentos()
    {
        ...
        try
        {
            ...
            if (con!=null)
            {
                ...
                strSQL="";
                strSQL+=" SELECT a4.co_emp, a4.co_loc, a4.co_tipDoc, a4.co_doc, a5.tx_desCor, a5.tx_desLar, a4.ne_numDoc, a4.tx_numDoc2";
                ...
                strSQL+=" GROUP BY a4.co_emp, a4.co_loc, a4.co_tipDoc, a4.co_doc, a5.tx_desCor, a5.tx_desLar, a4.ne_numDoc, a4.tx_numDoc2";
                strSQL+=" ORDER BY a4.co_emp, a4.co_loc, a4.co_tipDoc, a4.tx_numDoc2";
                ...
                while (rst.next())
                {
                    ...
                    if(intExiVarReg==1)
                    {
                        intCodTipDocPedEmb_UnReg=rst.getInt("co_tipDoc");
                        intCodDocPedEmb_UnReg=rst.getInt("co_doc");
                    }

                }
                if(intExiVarReg!=1)
                {
                    intCodTipDocPedEmb_UnReg=0;
                    intCodDocPedEmb_UnReg=0;
                }
