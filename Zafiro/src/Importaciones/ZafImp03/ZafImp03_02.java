 ...
 * @author  Ingrid Lino
 */
public class ZafImp03_02 extends javax.swing.JInternalFrame
{
    ...
    private static final int INT_COD_MNU_INGIMP=2889;  //Ingreso Importación...
    ...
    private int intCodEmpIngImp_UnReg;
    private int intCodLocIngImp_UnReg;
    private int intCodTipDocIngImp_UnReg;
    private int intCodDocIngImp_UnReg;
    
    /** Crea una nueva instancia de la clase ZafIndRpt. */
    public ZafImp03_02(ZafParSis obj)
    {
        try
        {
            ...
            strAux="Ingreso por importación(Listado de notas de pedido)";
...
//            objTblEdi=new ZafTblEdi(tblDat);
            ...
            objTblCelEdiButGen.addTableEditorListener(new Librerias.ZafTblUti.ZafTblEvt.ZafTableAdapter() {
                ...
                public void actionPerformed(Librerias.ZafTblUti.ZafTblEvt.ZafTableEvent evt) {
                        callPrgIngresoImportacion(intFilSel);
                }
    ...
    {
        return intCodEmpIngImp_UnReg;
    }
    public void setCodigoEmpresaIngresoImportacion(int intCodEmpIngImp_UnReg) 
    {
        this.intCodEmpIngImp_UnReg = intCodEmpIngImp_UnReg;
    }
    
    public int getCodigoLocalIngresoImportacion() 
    {
        return intCodLocIngImp_UnReg;
    }
    public void setCodigoLocalIngresoImportacion(int intCodLocIngImp_UnReg) 
    {
        this.intCodLocIngImp_UnReg = intCodLocIngImp_UnReg;
    }
    public int getCodigoTipoDocumentoIngresoImportacion()
    {
        return intCodTipDocIngImp_UnReg;
    }
    public void setCodigoTipoDocumentoIngresoImportacion(int intCodTipDocIngImp_UnReg) 
    {
        this.intCodTipDocIngImp_UnReg = intCodTipDocIngImp_UnReg;
    }
    public int getCodigoDocumentoIngresoImportacion() 
    {
        return intCodDocIngImp_UnReg;
    }
    public void setCodigoDocumentoIngresoImportacion(int intCodDocIngImp_UnReg)
    {
        this.intCodDocIngImp_UnReg = intCodDocIngImp_UnReg;
    }
    ...
    private void callPrgIngresoImportacion(int fila)
    {
        try
        {
            //Se carga el programa Pedido Embarcado
            Importaciones.ZafImp34.ZafImp34 objImp_34=new Importaciones.ZafImp34.ZafImp34(objParSis, Integer.parseInt(objTblMod.getValueAt(fila, INT_TBL_DAT_COD_EMP).toString()), Integer.parseInt(objTblMod.getValueAt(fila, INT_TBL_DAT_COD_LOC).toString()), Integer.parseInt(objTblMod.getValueAt(fila, INT_TBL_DAT_COD_TIP_DOC).toString()), Integer.parseInt(objTblMod.getValueAt(fila, INT_TBL_DAT_COD_DOC).toString())  );
    ...
    public boolean cargarDocumentos()
    {
        ...
        try
        {
            ...
            if (con!=null)
            {
                ...
                strSQL="";
                strSQL+="SELECT a5.co_emp, a5.co_loc, a5.co_tipDoc, a5.co_doc, a7.tx_desCor, a7.tx_desLar, a5.ne_numDoc";
                strSQL+="     , a5.tx_numDoc2, a1.co_tipDoc AS co_tipDocNotPed, a1.co_doc AS co_docNotPed";                
                ...
                strSQL+=" ON a5.co_emp=a7.co_emp AND a5.co_loc=a7.co_loc AND a5.co_tipDoc=a7.co_tipDoc";
                strSQL+=" WHERE a4.st_reg NOT IN('E','I') AND a5.st_reg NOT IN('E','I')";
                strSQL+=" AND a1.co_emp=" + objParSis.getCodigoEmpresa() + " AND a1.co_loc=" + objParSis.getCodigoLocal() + "";
                strSQL+=" AND a1.co_tipDoc=" + intCodTipDocNotPed + "";
                strSQL+=" AND a1.co_doc=" + intCodDocNotPed + "";
                strSQL+=" AND a5.co_tipDoc in (select co_tipDoc from tbr_tipDocPrg where co_emp=" + objParSis.getCodigoEmpresa();
                strSQL+="                      and co_loc=" + objParSis.getCodigoLocal()+" and co_mnu= "+INT_COD_MNU_INGIMP+") ";
                strSQL+=" GROUP BY a5.co_emp, a5.co_loc, a5.co_tipDoc, a5.co_doc";
                strSQL+=" , a7.tx_desCor, a7.tx_desLar, a5.ne_numDoc, a5.tx_numDoc2, a1.co_tipDoc, a1.co_doc";
                ...
                while (rst.next())
                {
                    ...
                    if(intExiVarReg==1)
                    {
                        intCodEmpIngImp_UnReg=rst.getInt("co_emp");
                        intCodLocIngImp_UnReg=rst.getInt("co_loc");
                        intCodTipDocIngImp_UnReg=rst.getInt("co_tipDoc");
                        intCodDocIngImp_UnReg=rst.getInt("co_doc");
                    }
                }
                if(intExiVarReg!=1)
                {
                    intCodEmpIngImp_UnReg=0;
                    intCodLocIngImp_UnReg=0;
                    intCodTipDocIngImp_UnReg=0;
                    intCodDocIngImp_UnReg=0;
                }
