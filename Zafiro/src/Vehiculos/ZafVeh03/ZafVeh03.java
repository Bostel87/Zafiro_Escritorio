 ...
 * @author  José Marín 
 */
public class ZafVeh03 extends javax.swing.JInternalFrame {
    ...
    /** Creates new form ZafVeh03 */
    public ZafVeh03(ZafParSis obj) {
        try{
            initComponents();
            //Inicializar objetos.
        ...
        try{
            ...
            if (con!=null){
                ...
                for(int i=0; i<objTblMod.getRowCountTrue(); i++){
                    if(objTblMod.isChecked(i, INT_TBL_DAT_CHK)){
                        strSQL="";
                        strSQL+="INSERT INTO tbr_vehLocPrg(";
                        strSQL+="co_emp,co_loc,co_mnu,co_veh,st_reg)";
                        strSQL+="VALUES (";
    ...
    private boolean consultarReg(){
        ...
        try{
            ...
            if (conCab!=null){
                ...
                strSQL="";
               strSQL+=" SELECT DISTINCT a1.co_mnu, a2.co_emp";
    ...
    private boolean cargarCabReg(){
        ...
        try{
            ...
            if (con!=null){
                stm=con.createStatement();
                strSQL="";
                strSQL+=" SELECT a2.co_veh, a2.tx_pla, a2.tx_desLar, a1.st_reg,a1.co_mnu,a3.tx_nom , '1' as st";
...
//                objTooBar.setMenSis("Obteniendo datos...");
                ...
                if (objTooBar.getEstado()=='x' || objTooBar.getEstado()=='m'){
                    ...
                    strSQL+=" select co_veh, tx_pla, tx_deslar, st_reg";
                    strSQL+=" from tbm_veh where st_reg='A' ) as a";
                    strSQL+=" LEFT OUTER JOIN (";
                    strSQL+=" SELECT a2.co_veh, a2.tx_pla, a2.tx_desLar, a1.st_reg, a1.co_mnu";
                    strSQL+=" FROM tbr_vehLocPrg as a1";
                    strSQL+=" INNER JOIN tbm_veh as a2 ON(a1.co_veh=a2.co_veh)";
                    ...
                    strSQL="";
                    strSQL+=" SELECT a2.co_veh, a2.tx_pla, a2.tx_desLar, a1.st_reg,'1' as st ";
                    strSQL+=" FROM tbr_vehLocPrg as a1"; 
                    strSQL+=" INNER JOIN tbm_veh as a2 ON(a1.co_veh=a2.co_veh)";
                    strSQL+=" WHERE a2.st_reg='A' and a1.co_mnu=" + rstCab.getString("co_mnu") + "";
                    strSQL+=" AND a1.co_emp="+ objParSis.getCodigoEmpresa() + "";
                    strSQL+=" AND a1.co_loc="+ objParSis.getCodigoLocal() + "";
                    strSQL+=" ORDER BY 1";
                }
        ...
        try{
            ...
            if (con!=null){
                ...
                for(int i=0; i<objTblMod.getRowCountTrue(); i++){
                        if (objTblMod.isChecked(i, INT_TBL_DAT_CHK)) {
                        strSQL="";
                        strSQL+="DELETE FROM tbr_vehLocPrg";
            ...
            if (con!=null){
               ...
               for(int i=0; i<objTblMod.getRowCountTrue(); i++){
                        if (objUti.parseString(objTblMod.getValueAt(i,0)).equals("M")){
                                strSQL2="";
                                strSQL2+=" SELECT a1.co_emp,a1.co_loc,a1.co_mnu,a1.co_veh";
                                strSQL2+=" FROM tbr_vehLocPrg as a1";
                                strSQL2+=" WHERE a1.co_emp="+ objParSis.getCodigoEmpresa() + "";
                                strSQL2+=" AND a1.co_loc="+ objParSis.getCodigoLocal() + "";
                                strSQL2+=" AND a1.co_mnu="+ txtTipPrg.getText() + "";
                                strSQL2+=" AND a1.co_veh="+ objTblMod.getValueAt(i, INT_TBL_DAT_COD_VEH) + "";
                                System.out.println("CONSULTA SI EXISTE::..." + strSQL2);
                                rst=stm.executeQuery(strSQL2);
                                 if(rst.next()){
                                   //intento de UPDATE
                                   strSQL="";
                                   strSQL+=" UPDATE tbr_vehLocPrg";
                                   strSQL+=" SET st_reg=";
                 if(objTblMod.isChecked(i, INT_TBL_DAT_CHK_PRD)){strSQL+="'P'";}
                   else{strSQL+="'A'";}
                                ...
                                {
                                    //insercion por que no existe el registro
                                      strSQL="";
                                       strSQL+="INSERT INTO tbr_vehLocPrg(";
                                       strSQL+="co_emp,co_loc,co_mnu,co_veh,st_reg)";
                                       strSQL+="VALUES (";
                                       ...
                                       strSQL+="" + objParSis.getCodigoLocal() + ",";
                                       strSQL+="" + txtTipPrg.getText() + ",";
                                       strSQL+="" + objTblMod.getValueAt(i, INT_TBL_DAT_COD_VEH) + ",";
                                      if(objTblMod.isChecked(i, INT_TBL_DAT_CHK_PRD)){
                                           strSQL+="'P'";//st_reg
                                       }
                                       else{
