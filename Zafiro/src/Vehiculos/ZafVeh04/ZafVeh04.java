 ...
 * ZafVeh04.java
 *
 * Created on Agosto 19, 2013, 12:41 PM
 */

package Vehiculos.ZafVeh04;
 ...
 * @author  José Marín 
 */
public class ZafVeh04 extends javax.swing.JInternalFrame {
   ...
   // private final int INT_TBL_DAT_CMB_BOX=6;
    ...
    private final int INT_TBL_DAT_COD_VEH=2;
    private final int INT_TBL_DAT_PLA_VEH=3;
    private final int INT_TBL_DAT_DES_LAR_VEH=4;
    private boolean blnPre;
    
    private ZafDocLis objDocLis;
    private String strDesCorUsr, strDesLarUsr;

    /** Creates new form ZafVeh04 */
    public ZafVeh04(ZafParSis obj) {
        try{
            initComponents();
            //Inicializar objetos.
...
//     */
    ...
    private void initComponents() {
        ...
        txtDesCorUsr.setBounds(72, 30, 80, 20);
        ...
        txtDesLarUsr.setBounds(152, 30, 368, 20);
...
//    /** Configurar el formulario. */
    private boolean configurarFrm(){
        ...
        try{
            ...
            tcmAux.getColumn(INT_TBL_DAT_COD_VEH).setPreferredWidth(60);
            tcmAux.getColumn(INT_TBL_DAT_PLA_VEH).setPreferredWidth(100);
            tcmAux.getColumn(INT_TBL_DAT_DES_LAR_VEH).setPreferredWidth(350);
...
//     */
    ...
    int intCodEmp, intCodEmpGrp, intCodMnu;
        ...
        { 
            ...
            strSQL+=" INNER JOIN tbr_vehLocPrg as a2 ON (a1.co_mnu=a2.co_mnu)";
...
//     */
        ...
        public void mouseMoved(java.awt.event.MouseEvent evt)
        {
            ...
            switch (intCol)
            {
                ...
                case INT_TBL_DAT_PLA_VEH:
                    ...
                    break;
                case INT_TBL_DAT_DES_LAR_VEH:
                    strMsg="Descripción Larga del vehículo";
                    break;
    ...
    private boolean isCamVal(){
        ...
        if(isRegAlgunInsertado()){
            tabFrm.setSelectedIndex(0);
            mostrarMsgInf("<HTML>No ha seleccionado ningun vehículo.</HTML>");
            txtNomPrg.requestFocus();
            return false;
        }
            ...
            if (con!=null){
                ...
                for(int i=0; i<objTblMod.getRowCountTrue(); i++){
                    if ((objUti.parseString(objTblMod.getValueAt(i,0)).equals("M")) ||  (objTblMod.isChecked(i, INT_TBL_DAT_CHK))) {
                        if(objTblMod.isChecked(i, INT_TBL_DAT_CHK)){
                            strSQL="";
                            strSQL+="INSERT INTO tbr_vehLocPrgUsr(";
                            strSQL+="co_emp,co_loc,co_mnu,co_usr,co_veh,st_reg)";
                            strSQL+="VALUES (";
                            strSQL+="" + objParSis.getCodigoEmpresa() + ",";
                            strSQL+="" + objParSis.getCodigoLocal() + ",";
                            strSQL+="" + txtTipPrg.getText() + ",";
                            strSQL+="" + txtCodUsr.getText() + ",";
                            strSQL+="" + objTblMod.getValueAt(i, INT_TBL_DAT_COD_VEH) + ",";//co_emp
                           if(objTblMod.isChecked(i, INT_TBL_DAT_CHK_PRD)){
                            ...
                            strSQL="";
                            strSQL+=" DELETE FROM tbr_vehLocPrgusr WHERE";
                            ...
                            strSQL+=" co_veh=" + objTblMod.getValueAt(i, INT_TBL_DAT_COD_VEH) + ";";
                            System.out.println(strSQL);
                            stm.executeUpdate(strSQL);
                        }
                    }
    ...
    private boolean consultarReg(){
        ...
        try{
            ...
            if (conCab!=null){
                ...
                strSQL="";
               strSQL+=" SELECT DISTINCT a1.co_mnu, a2.co_emp, a4.co_usr ";
                strSQL+=" FROM tbm_mnuSis a1 ";
                strSQL+=" INNER JOIN tbr_vehLocPrg as a2 ON (a1.co_mnu=a2.co_mnu)";
                strSQL+=" INNER JOIN tbr_vehLocPrgUsr as a4 ON (a2.co_veh=a4.co_veh and a2.co_emp=a4.co_emp and";
                strSQL+=" a2.co_loc=a4.co_loc and a1.co_mnu=a4.co_mnu)";
                strSQL+=" WHERE 1=1  ";
                if (!txtTipPrg.getText().equals(""))
                    strSQL+=" and a1.co_mnu=" + txtTipPrg.getText();
                if (!txtCodUsr.getText().equals(""))
                    strSQL+=" and a4.co_usr=" + txtCodUsr.getText();
    ...
    private boolean cargarCabReg(){
        ...
        try{
            ...
            if (con!=null){
                stm=con.createStatement();
                strSQL="";
                strSQL+=" SELECT a4.co_veh, a2.tx_pla, a2.tx_desLar, a4.st_reg ,a4.co_mnu, a3.tx_nom, a5.co_usr,a5.tx_usr, a5.tx_nom as tx_nomUsr";
                strSQL+=" FROM tbr_vehLocPrg as a1"; 
                strSQL+=" INNER JOIN tbm_veh as a2 ON(a1.co_veh=a2.co_veh)";
                strSQL+=" INNER JOIN tbm_mnuSis as a3 ON (a1.co_mnu=a3.co_mnu)";
                strSQL+=" INNER JOIN tbr_vehLocPrgUsr as a4 ON (a1.co_veh=a4.co_veh and a1.co_emp=a4.co_emp and ";
                strSQL+=" a1.co_loc=a4.co_loc and a4.co_mnu=a3.co_mnu)";
                strSQL+=" INNER JOIN tbm_usr as a5 ON (a4.co_usr=a5.co_usr)";
                strSQL+=" WHERE 1=1";
                strSQL+=" and a1.co_mnu="+ rstCab.getString("co_mnu") + "";
                strSQL+=" and a4.co_usr="+ rstCab.getString("co_usr") + "";
...
//                objTooBar.setMenSis("Obteniendo datos...");
                ...
                if (objTooBar.getEstado()=='x' || objTooBar.getEstado()=='m'){
                    ...
                    strSQL="";
                    strSQL+=" select DISTInCT  a.co_veh, a.tx_pla, a.tx_deslar, case when b.co_mnu is null then '0' else '1' end as st,";
                    strSQL+=" b.co_mnu, b.st_reg from("; 
                    strSQL+=" select a1.co_veh, a1.tx_pla,a1.tx_deslar, a1.st_reg";
                    strSQL+=" from tbm_veh as a1  ";
                    strSQL+=" INNER JOIN tbr_vehLocPrg as a2 ON (a1.co_veh=a2.co_veh)";
                    strSQL+=" where a1.st_reg='A' ";
                    strSQL+=" and a2.co_mnu="+ txtTipPrg.getText();
                    strSQL+=" ) as a ";
                    strSQL+=" LEFT OUTER JOIN (";
                    strSQL+=" SELECT a2.co_veh, a2.tx_pla, a2.tx_desLar, a4.st_reg, a1.co_mnu";
                    strSQL+=" FROM tbr_vehLocPrg as a1";
                    strSQL+=" INNER JOIN tbm_veh as a2 ON(a1.co_veh=a2.co_veh)";
                    strSQL+=" INNER JOIN tbr_vehLocPrgUsr as a4 ON (a1.co_veh=a4.co_veh and a1.co_emp=a4.co_emp and";
                    strSQL+=" a1.co_loc=a4.co_loc and a1.co_mnu=a4.co_mnu and";
                    strSQL+=" a2.co_veh=a4.co_veh)";
                    strSQL+=" where 1=1 and a2.st_reg='A' AND a1.co_mnu=" + txtTipPrg.getText();
                    if(txtCodUsr.getText().length()>0)
                        strSQL+=" and a4.co_usr=" + txtCodUsr.getText();
                    strSQL+=" AND a1.co_emp="+ objParSis.getCodigoEmpresa() + "";
                    strSQL+=" AND a1.co_loc="+ objParSis.getCodigoLocal() + "";
                    strSQL+=" ) as b ON (a.co_veh=b.co_veh )";
                    strSQL+=" ";
                }
                else{
                    //Para los dem�s modos se muestra: s�lo los documentos pagados.
                    strSQL="";
                    strSQL+=" SELECT distinct a2.co_veh, a2.tx_pla, a2.tx_desLar,a4.co_mnu ,a4.st_reg ,a4.co_usr,'1' as st  ";
                    strSQL+=" FROM tbr_vehLocPrg as a1"; 
                    strSQL+=" INNER JOIN tbm_veh as a2 ON(a1.co_veh=a2.co_veh)";
                    strSQL+=" INNER JOIN tbr_vehLocPrgUsr as a4 ON (a1.co_veh=a4.co_veh and a1.co_emp=a4.co_emp and";
                    strSQL+=" a1.co_loc=a4.co_loc and a2.co_veh=a4.co_veh)";
                    strSQL+=" INNER JOIN tbm_usr as a5 ON (a4.co_usr=a5.co_usr)";
                    strSQL+=" WHERE a2.st_reg='A' and a4.co_mnu=" + rstCab.getString("co_mnu") + "";
                    strSQL+=" and a4.co_usr=" + rstCab.getString("co_usr") + "";
                ...
                while (rst.next()){
                    ...
                    if(rst.getString("st").equals("1"))
                        vecReg.add(INT_TBL_DAT_CHK,true);
                    else
                        vecReg.add(INT_TBL_DAT_CHK,false);
                    vecReg.add(INT_TBL_DAT_COD_VEH, rst.getString("co_veh"));
                    vecReg.add(INT_TBL_DAT_PLA_VEH,rst.getString("tx_pla"));
                    vecReg.add(INT_TBL_DAT_DES_LAR_VEH,rst.getString("tx_deslar"));
        ...
        try{
            ...
            if (con!=null){
                ...
                for(int i=0; i<objTblMod.getRowCountTrue(); i++){
                        if (objTblMod.isChecked(i, INT_TBL_DAT_CHK)) {
                            strSQL="";
                            strSQL+="DELETE FROM tbr_vehLocPrgUsr";
                            strSQL+=" WHERE co_mnu=" + txtTipPrg.getText() + "";
                            strSQL+=" and co_usr=" + txtCodUsr.getText() + "";
                            strSQL+=" and co_veh=" + objTblMod.getValueAt(i,INT_TBL_DAT_COD_VEH);
                            strSQL+=" and co_emp=" + objParSis.getCodigoEmpresa();
                            strSQL+=" and co_loc=" + objParSis.getCodigoLocal(); 
                            System.out.println(strSQL);
                            stm.executeUpdate(strSQL);
    ...
    private boolean cargarOpcMnu()
    {
        ...
        try
        {
            ...
            if (con!=null)
            {
                ...
                //Armar la sentencia SQL.
                strSQL="";
                strSQL+=" SELECT DISTINCT a1.co_veh, a1.tx_pla, a1.tx_desLar, a1.st_reg";
                strSQL+=" from tbm_veh as a1";
                strSQL+=" INNER JOIN tbr_vehLocPrg as a2 ON (a1.co_veh=a2.co_veh)";
                strSQL+=" where a1.st_reg='A'";
            ...
            vecCodVeh = new Vector();
            vecPlaca = new Vector();
            vecDesLar = new Vector();
            int temp=0;
            while(rst.next())
            {
                vecCodVeh.add(temp,rst.getString("co_veh"));
                if(rst.getString("tx_pla")!=null)
                    vecPlaca.add(temp,rst.getString("tx_pla"));
                else
                    vecPlaca.add(temp,"");
                if(rst.getString("tx_deslar")!=null)
                    vecDesLar.add(temp,rst.getString("tx_deslar"));
                else
                    vecDesLar.add(temp,"");
                temp++;
            }
            int j=0;
            if(!vecCodVeh.isEmpty())
            {
                    while(temp>j)
                    {
                    vecReg = new Vector();
                    ...
                    vecReg.add(INT_TBL_DAT_COD_VEH,vecCodVeh.get(j).toString());
                    vecReg.add(INT_TBL_DAT_PLA_VEH,vecPlaca.get(j).toString());
                    vecReg.add(INT_TBL_DAT_DES_LAR_VEH,vecDesLar.get(j).toString());
                    vecReg.add(INT_TBL_DAT_CHK_PRD,null);
                    j++;
                    vecDat.add(vecReg);
               }
                        objTblMod.setData(vecDat);
                    ...
                    objTooBar.setMenSis("No se encontraron registros");
                }  
        ...
        try{
            ...
            if(con!=null){
                ...
                while(rst.next()){
                    ...
                    vecReg.add(INT_TBL_DAT_COD_VEH, "" + rst.getObject("co_veh")==null?"":rst.getString("co_veh"));
                    vecReg.add(INT_TBL_DAT_PLA_VEH, "" + rst.getObject("tx_pla")==null?"":    rst.getString("tx_pla"));
                    vecReg.add(INT_TBL_DAT_DES_LAR_VEH, "" + rst.getString("tx_desLar")==null?"":    rst.getString("tx_desLar"));
                ...
                if(blnRes==false)
                {
                    mostrarMsgInf("<HTML>No excisten <FONT COLOR=\"blue\">Vehículos</FONT> configurado para este programa.</HTML>");
