 ...
 * ZafRecHum79.java
 *
 * Created on Enero 23, 2014, 10:22 PM
 */

package RecursosHumanos.ZafRecHum79;
 ...
 * @author  José Marín 
 */
public class ZafRecHum79 extends javax.swing.JInternalFrame {
    ...
    /** Creates new form ZafRecHum79 */
    public ZafRecHum79(ZafParSis obj) {
        try{
            initComponents();
            //Inicializar objetos.
...
//     */
    ...
    int intCodEmp, intCodEmpGrp, intCodMnu;
        ...
        { 
            ...
            strSQL+=" INNER JOIN tbr_rubRolPagLocPrg AS a2 ON (a1.co_mnu=a2.co_mnu) ";
            strSQL+=" WHERE (a1.tx_tipMnu='C' or a1.tx_tipMnu='R') and a1.tx_nom!='' ";
            strSQL+=" AND a1.st_reg<>'E' AND a1.tx_acc IS NOT NULL ";
            strSQL+=" AND a2.st_reg in ('A','P') AND a2.co_emp=" + objParSis.getCodigoEmpresa();
    ...
    private boolean isRegInsertados(){
        ...
        try{
            ...
            if(con!=null){
                ...
                strSQL="";
                strSQL+="SELECT *";
                strSQL+=" FROM tbr_rubRolPagLocPrgUsr ";
                strSQL+=" WHERE ";
            ...
            if (con!=null){
                ...
                for(int i=0; i<objTblMod.getRowCountTrue(); i++){
                    if ((objUti.parseString(objTblMod.getValueAt(i,0)).equals("M")) ||  (objTblMod.isChecked(i, INT_TBL_DAT_CHK))) {
                        if(objTblMod.isChecked(i, INT_TBL_DAT_CHK)){
                            strSQL="";
                            strSQL+="INSERT INTO tbr_rubRolPagLocPrgUsr(";
                            strSQL+="co_emp,co_loc,co_mnu,co_usr,co_rub,st_reg)";
                            strSQL+="VALUES (";
                           ...
                           if(objTblMod.isChecked(i, INT_TBL_DAT_CHK_PRD)){
                            ...
                            strSQL="";
                            strSQL+=" DELETE FROM tbr_rubRolPagLocPrgUsr WHERE";
    ...
    private boolean consultarReg(){
        ...
        try{
            ...
            if (conCab!=null){
                ...
                strSQL+=" FROM tbr_rubRolPagLocPrgUsr a1 ";
    ...
    private boolean cargarCabReg(){
        ...
        try{
            ...
            if (con!=null){
                ...
                strSQL+=" FROM tbr_rubRolPagLocPrgUsr as a1"; 
                strSQL+=" INNER JOIN tbm_rubRolPag as a2 ON(a1.co_rub=a2.co_rub)";
                ...
                if (con!=null){
                    ...
                    if (objTooBar.getEstado()=='x' || objTooBar.getEstado()=='m'){
                       strSQL="";
                        ...
                        strSQL="";
                        strSQL+=" SELECT DISTINCT a1.co_rub, a2.tx_nom, a1.st_reg ";
                        strSQL+=" FROM tbr_rubRolPagLocPrgUsr as a1"; 
                        strSQL+=" INNER JOIN tbm_rubRolPag as a2 ON (a1.co_rub=a2.co_rub)";
                        strSQL+=" INNER JOIN tbr_rubRolPagLocPrg as a3 ON (a1.co_rub=a3.co_rub AND a1.co_emp=a3.co_emp and a1.co_loc=a3.co_loc)";
                        strSQL+=" WHERE a1.st_reg in ('A','P') and a1.co_mnu=" + rstCab.getString("co_mnu") + "";
                        strSQL+=" and a1.co_usr=" + rstCab.getString("co_usr") + "";
                        strSQL+=" AND a1.co_emp="+ objParSis.getCodigoEmpresa() + "";
                        strSQL+=" AND a1.co_loc="+ objParSis.getCodigoLocal() + "";
                        strSQL+=" ORDER BY a1.co_rub";
                    }
        ...
        try{
            ...
            if (con!=null){
                ...
                for(int i=0; i<objTblMod.getRowCountTrue(); i++){
                        if (objTblMod.isChecked(i, INT_TBL_DAT_CHK)) {
                            strSQL="";
                            strSQL+="DELETE FROM tbr_rubRolPagLocPrgUsr";
    ...
    private boolean configurarVenConUsr()
    {
        ...
        try{
            ...
            if(con!=null){
                ...
                strSQL+=" INNER JOIN tbr_rubRolPagLocPrg as a3 ON (a2.co_rub=a3.co_rub AND a2.co_emp=a3.co_emp)";
                strSQL+=" WHERE a3.st_Reg in ('A','P') and a3.co_emp=" + objParSis.getCodigoEmpresa() ;
                strSQL+=" AND a3.co_loc=" + objParSis.getCodigoLocal();
                strSQL+=" AND a3.co_mnu=" + txtTipPrg.getText();
                strSQL+=" ORDER BY a1.tx_nom";
                strSQL+=" ";
