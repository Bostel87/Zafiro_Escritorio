 ...
 */
public class ZafRecHum56_ant extends javax.swing.JInternalFrame
{
...
//    private ZafMouMotAdaMovReg objMouMotAdaMovReg;                        //ToolTipText en TableHeader.
    ...
    public ZafRecHum56_ant(ZafParSis obj)
    {
        try
        {
            initComponents();
    ...
    private boolean cargarAñoApe(){
        ...
        try{
            ...
            if(con!=null){ 
                ...
                strSQL="select max(ne_ani) as ne_ani from tbm_aniCreSis where co_emp="+objParSis.getCodigoEmpresa();
                rstLoc=stmLoc.executeQuery(strSQL);
                while(rstLoc.next()){
...
//                                String strPeriodo=intAño+" - "+ cboPerMes.getSelectedItem().toString() + " - " + strQFDS;
                                ...
                                if(objParSis.getCodigoEmpresa()==objParSis.getCodigoEmpresaGrupo()){
                                    ...
                                    strSql+=" inner join tbm_tra b on (b.co_tra=a.co_tra and a.st_reg='A')";
    ...
    private boolean procesaDatos(){
        ...
        try{
            ...
            if(con!=null){
                ...
                CalVal.set(java.util.Calendar.YEAR,Integer.parseInt(jCmbAniPro.getSelectedItem().toString()));
                ...
                for(int intFil=0; intFil<objTblMod.getRowCount();intFil++){
                    ...
                    if(objTblMod.getValueAt(intFil, INT_TBL_DAT_CHKSEL).equals(true)){
                        ...
                        strSql+=" where a.co_tra="+objTblMod.getValueAt(intFil, INT_TBL_DAT_COD_TRA);
                        strSql+=" and a.co_emp="+objTblMod.getValueAt(intFil, INT_TBL_DAT_CO_EMP);
...
//                      suma de todo
                       ...
                       double dblPorVar=Double.parseDouble(jspPorVarMen.getValue().toString());
                       
                       

                       for(int intRecValMesOrg=0;intRecValMesOrg<dblValBonMes.length;intRecValMesOrg++){
                           ...
                           if(intRecValMesOrg==0){
                               ...
                               strSql+=" where co_emp="+objTblMod.getValueAt(intFil, INT_TBL_DAT_CO_EMP).toString();
                               strSql+=" and co_tra="+objTblMod.getValueAt(intFil, INT_TBL_DAT_COD_TRA).toString();
                               strSql+=" and co_rub=6";
                               ...
                               if(!rstLoc.next()){
                                    ...
                                    strSql+= objTblMod.getValueAt(intFil, INT_TBL_DAT_CO_EMP).toString() + " , ";
                                    strSql+= objTblMod.getValueAt(intFil, INT_TBL_DAT_COD_TRA).toString() + " , ";
                                    strSql+=  " 6 , ";
                                    strSql+=  calAct.get(Calendar.YEAR)-1 + " , ";
                                    strSql+=  " 12 , ";
                                    strSql+= dblValBonMes[intRecValMesOrg] + " , ";
                                    strSql+= jspPorVarMen.getValue() + " , ";
                                    strSql+=  dblValBonMes[intRecValMesOrg] + " ) ";
                                    stmLoc.executeUpdate(strSql);
                               }else{
                                   strSql="";
                                   strSql+="update tbm_ingegrmenprgtra set nd_valrub = "+dblValBonMes[intRecValMesOrg]+ " , nd_porvar = "+jspPorVarMen.getValue()+", nd_valrubprg = "+dblValBonMes[intRecValMesOrg];
                                   strSql+=" where co_emp="+objTblMod.getValueAt(intFil, INT_TBL_DAT_CO_EMP).toString();
                                    strSql+=" and co_tra="+objTblMod.getValueAt(intFil, INT_TBL_DAT_COD_TRA).toString();
                                    strSql+=" and co_rub=6";
                                    strSql+=" and ne_ani="+(calAct.get(Calendar.YEAR)-1);
                               ...
                               if(!rstLoc.next()){
                                   ...
                                   strSql="";
                                   strSql+="update tbm_ingegrmenprgtra set nd_valrub = "+dblValMovMes[intRecValMesOrg]+ " , nd_porvar = "+jspPorVarMen.getValue()+", nd_valrubprg = "+dblValMovMes[intRecValMesOrg];
                                   strSql+=" where co_emp="+objTblMod.getValueAt(intFil, INT_TBL_DAT_CO_EMP).toString();
                                    strSql+=" and co_tra="+objTblMod.getValueAt(intFil, INT_TBL_DAT_COD_TRA).toString();
                                    strSql+=" and co_rub=7";
                                    strSql+=" and ne_ani="+(calAct.get(Calendar.YEAR)-1);
...
//                                   decimo tercer sueldo
                                   ...
                                   strSql="";
                                    ...
                                    if(!rstLoc.next()){
                                        ...
                                        strSql="";
                                        strSql+="update tbm_ingegrmenprgtra set nd_valrub = "+dblValBonMes[intRecValMesOrg]+ " , nd_porvar = "+jspPorVarMen.getValue()+", nd_valrubprg = "+dblValPrgBonMes[intRecValMesOrg];
                                        strSql+=" where co_emp="+objTblMod.getValueAt(intFil, INT_TBL_DAT_CO_EMP).toString();
                                            strSql+=" and co_tra="+objTblMod.getValueAt(intFil, INT_TBL_DAT_COD_TRA).toString();
                                            strSql+=" and co_rub=6";
                                            strSql+=" and ne_ani="+calAct.get(Calendar.YEAR);
                                   ...
                                   strSql="";
                                    ...
                                    if(!rstLoc.next()){
                                        ...
                                        strSql="";
                                        strSql+="update tbm_ingegrmenprgtra set nd_valrub = "+dblValMovMes[intRecValMesOrg]+ " , nd_porvar = "+jspPorVarMen.getValue()+", nd_valrubprg = "+dblValPrgMovMes[intRecValMesOrg];
                                        strSql+=" where co_emp="+objTblMod.getValueAt(intFil, INT_TBL_DAT_CO_EMP).toString();
                                            strSql+=" and co_tra="+objTblMod.getValueAt(intFil, INT_TBL_DAT_COD_TRA).toString();
                                            strSql+=" and co_rub=7";
                                            strSql+=" and ne_ani="+calAct.get(Calendar.YEAR);
